...
Revision ID: b1f2a72e74b2
Revises: 
Create Date: 2024-06-05 00:05:35.267403+00:00
...
def upgrade() -> None:
    ...
    sa.Column('queued', sa.TIMESTAMP(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
