...
Revision ID: dcf4a7080b5d
Revises: 
Create Date: 2024-07-19 11:00:26.337294+00:00
...
def upgrade() -> None:
    ...
    sa.Column('org_seq', sa.Integer(), nullable=False),
    sa.Column('profile_seq', sqlmodel.sql.sqltypes.GUID(), nullable=False),
