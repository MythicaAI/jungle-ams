...
function Editor(container_id, options) {
    ...
    graphcanvas.background_image = "assets/imgs/grid.png";
    ...
    //add stuff
    //this.addToolsButton("loadsession_button","Load","assets/imgs/icon-load.png", this.onLoadButton.bind(this), ".tools-left" );
    //this.addToolsButton("savesession_button","Save","assets/imgs/icon-save.png", this.onSaveButton.bind(this), ".tools-left" );
    if (!options.skip_counters) {
        this.addLoadCounter();
    }
    if (!options.skip_playmode) {
        this.addToolsButton(
            "playnode_button",
            "Play",
            "assets/imgs/icon-play.png",
...
Editor.prototype.onPlayButton = function() {
    ...
    if (graph.status == LGraph.STATUS_STOPPED) {
        button.innerHTML = "<img src='assets/imgs/icon-stop.png'/> Stop";
        graph.start();
    } else {
        button.innerHTML = "<img src='assets/imgs/icon-play.png'/> Play";
        graph.stop();
    }
};
...
Editor.prototype.onLiveButton = function() {
    ...
    var url = this.graphcanvas.live_mode
        ? "assets/imgs/gauss_bg_medium.jpg"
        : "assets/imgs/gauss_bg.jpg";
    var button = this.root.querySelector("#livemode_button");
    button.innerHTML = !is_live_mode
        ? "<img src='assets/imgs/icon-record.png'/> Live"
        : "<img src='assets/imgs/icon-gear.png'/> Edit";
};
