...
export default function (hou) {
    class _hnt_VOP_mtlxdeterminant extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxdeterminant';
        static category = '/VOP';
        static houdiniType = 'mtlxdeterminant';
        static title = 'MtlX Determinant';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxdeterminant.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxdeterminant',_hnt_VOP_mtlxdeterminant)
    return _hnt_VOP_mtlxdeterminant
}
