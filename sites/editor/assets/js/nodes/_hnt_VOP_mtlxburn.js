...
export default function (hou) {
    class _hnt_VOP_mtlxburn extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxburn';
        static category = '/VOP';
        static houdiniType = 'mtlxburn';
        static title = 'MtlX Burn';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxburn.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxburn',_hnt_VOP_mtlxburn)
    return _hnt_VOP_mtlxburn
}
