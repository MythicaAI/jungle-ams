...
export default function (hou) {
    class _hnt_CHOP_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'CHOP/Other/dopnet';
        static category = '/CHOP';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Other/dopnet',_hnt_CHOP_dopnet)
    return _hnt_CHOP_dopnet
}
