...
export default function (hou) {
    class _hnt_VOP_mtlxgeneralized_schlick_bsdf extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Pbr/mtlxgeneralized_schlick_bsdf';
        static category = '/VOP';
        static houdiniType = 'mtlxgeneralized_schlick_bsdf';
        static title = 'MtlX Generalized Schlick Bsdf';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxgeneralized_schlick_bsdf.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FloatParmTemplate({name: "color0", label: "Color 0", num_components: 3, default_value: [1, 1, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.ColorSquare, naming_scheme: hou.parmNamingScheme.RGBA});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Pbr/mtlxgeneralized_schlick_bsdf',_hnt_VOP_mtlxgeneralized_schlick_bsdf)
    return _hnt_VOP_mtlxgeneralized_schlick_bsdf
}
