...
export default function (hou) {
    class _hnt_COP2_vopcop2filter extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'COP2/Other/vopcop2filter';
        static category = '/COP2';
        static houdiniType = 'vopcop2filter';
        static title = 'VOP COP2 Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_vopcop2filter.svg';
        constructor() {
            super();
    ...
    hou.registerType('COP2/Other/vopcop2filter',_hnt_COP2_vopcop2filter)
    return _hnt_COP2_vopcop2filter
}
