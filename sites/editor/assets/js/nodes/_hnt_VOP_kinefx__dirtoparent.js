...
export default function (hou) {
    class _hnt_VOP_kinefx__dirtoparent extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/KineFX/kinefx::dirtoparent';
        static category = '/VOP/kinefx';
        static houdiniType = 'kinefx::dirtoparent';
        static title = 'Direction To Parent';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kinefx__dirtoparent.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/KineFX/kinefx::dirtoparent',_hnt_VOP_kinefx__dirtoparent)
    return _hnt_VOP_kinefx__dirtoparent
}
