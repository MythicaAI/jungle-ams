...
export default function (hou) {
    class _hnt_VOP_mtlxexp extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxexp';
        static category = '/VOP';
        static houdiniType = 'mtlxexp';
        static title = 'MtlX Exp';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxexp.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxexp',_hnt_VOP_mtlxexp)
    return _hnt_VOP_mtlxexp
}
