...
export default function (hou) {
    class _hnt_SOP_kinefx__motionclipsequence extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Animation/MotionClip/kinefx::motionclipsequence';
        static category = '/SOP/kinefx';
        static houdiniType = 'kinefx::motionclipsequence';
        static title = 'MotionClip Sequence';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_kinefx__motionclipsequence.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "locomotion_folder_1", label: "Blend", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "setinc", label: "Label", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
    ...
    hou.registerType('SOP/Animation/MotionClip/kinefx::motionclipsequence',_hnt_SOP_kinefx__motionclipsequence)
    return _hnt_SOP_kinefx__motionclipsequence
}
