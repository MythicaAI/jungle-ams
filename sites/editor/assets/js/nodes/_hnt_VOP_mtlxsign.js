...
export default function (hou) {
    class _hnt_VOP_mtlxsign extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxsign';
        static category = '/VOP';
        static houdiniType = 'mtlxsign';
        static title = 'MtlX Sign';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxsign.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxsign',_hnt_VOP_mtlxsign)
    return _hnt_VOP_mtlxsign
}
