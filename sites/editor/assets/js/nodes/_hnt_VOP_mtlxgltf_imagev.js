...
export default function (hou) {
    class _hnt_VOP_mtlxgltf_imagev extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Texture2D/mtlxgltf_imagev';
        static category = '/VOP';
        static houdiniType = 'mtlxgltf_imagev';
        static title = 'MtlX Gltf Image (vector)';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxgltf_imagev.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "default", label: "Default", num_components: 3, default_value: [0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Texture2D/mtlxgltf_imagev',_hnt_VOP_mtlxgltf_imagev)
    return _hnt_VOP_mtlxgltf_imagev
}
