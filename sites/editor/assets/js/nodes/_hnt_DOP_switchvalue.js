...
export default function (hou) {
    class _hnt_DOP_switchvalue extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/switchvalue';
        static category = '/DOP';
        static houdiniType = 'switchvalue';
        static title = 'Switch Value';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_switchvalue.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "dataname", label: "Data Name", num_components: 1, default_value: ["SolverParms/SwitchValue"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/switchvalue',_hnt_DOP_switchvalue)
    return _hnt_DOP_switchvalue
}
