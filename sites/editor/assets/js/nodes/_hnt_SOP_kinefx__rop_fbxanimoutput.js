...
export default function (hou) {
    class _hnt_SOP_kinefx__rop_fbxanimoutput extends hou._HoudiniBase {
        static is_root = true;
        static id = 'SOP/Other/kinefx::rop_fbxanimoutput';
        static category = '/SOP/kinefx';
        static houdiniType = 'kinefx::rop_fbxanimoutput';
        static title = 'ROP FBX Animation Output';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_kinefx__rop_fbxanimoutput.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "outputfilepath", label: "Output FBX File", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			...
			hou_parm_template2.setScriptCallback("import fbxexportpreset; fbxexportpreset.fbxAnimOutput_ExportPresetSelected(kwargs);");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback": "import fbxexportpreset; fbxexportpreset.fbxAnimOutput_ExportPresetSelected(kwargs);", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Other/kinefx::rop_fbxanimoutput',_hnt_SOP_kinefx__rop_fbxanimoutput)
    return _hnt_SOP_kinefx__rop_fbxanimoutput
}
