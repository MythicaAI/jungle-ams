...
export default function (hou) {
    class _hnt_VOP_volumesamplefile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumesamplefile';
        static category = '/VOP';
        static houdiniType = 'volumesamplefile';
    ...
    hou.registerType('VOP/Other/volumesamplefile',_hnt_VOP_volumesamplefile)
    return _hnt_VOP_volumesamplefile
}
