...
export default function (hou) {
    class _hnt_VOP_mtlxscreen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxscreen';
        static category = '/VOP';
        static houdiniType = 'mtlxscreen';
        static title = 'MtlX Screen';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxscreen.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxscreen',_hnt_VOP_mtlxscreen)
    return _hnt_VOP_mtlxscreen
}
