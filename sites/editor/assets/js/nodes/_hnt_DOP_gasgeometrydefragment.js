...
export default function (hou) {
    class _hnt_DOP_gasgeometrydefragment extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasgeometrydefragment';
        static category = '/DOP';
        static houdiniType = 'gasgeometrydefragment';
        static title = 'Gas Geometry Defragment';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasgeometrydefragment.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/gasgeometrydefragment',_hnt_DOP_gasgeometrydefragment)
    return _hnt_DOP_gasgeometrydefragment
}
