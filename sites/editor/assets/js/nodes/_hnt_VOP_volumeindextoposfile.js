...
export default function (hou) {
    class _hnt_VOP_volumeindextoposfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumeindextoposfile';
        static category = '/VOP';
        static houdiniType = 'volumeindextoposfile';
    ...
    hou.registerType('VOP/Other/volumeindextoposfile',_hnt_VOP_volumeindextoposfile)
    return _hnt_VOP_volumeindextoposfile
}
