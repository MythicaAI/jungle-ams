...
export default function (hou) {
    class _hnt_SHOP_vopshadow extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopshadow';
        static category = '/SHOP';
        static houdiniType = 'vopshadow';
        static title = 'Shadow Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopshadow.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopshadow',_hnt_SHOP_vopshadow)
    return _hnt_SHOP_vopshadow
}
