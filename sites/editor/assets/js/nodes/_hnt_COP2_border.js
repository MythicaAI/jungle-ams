...
export default function (hou) {
    class _hnt_COP2_border extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/border';
        static category = '/COP2';
        static houdiniType = 'border';
        static title = 'Border';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_border.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Border", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "borderh", label: "Border Left/Right", num_components: 2, default_value: [0, 0], min: 0, max: 10, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "borderv", label: "Border Top/Bottom", num_components: 2, default_value: [0, 0], min: 0, max: 10, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "color", label: "Border Color", num_components: 4, default_value: [0, 0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.ColorSquare, naming_scheme: hou.parmNamingScheme.RGBA});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "increaseres", label: "Increase the Resolution by Borders", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/border',_hnt_COP2_border)
    return _hnt_COP2_border
}
