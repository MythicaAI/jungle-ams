...
export default function (hou) {
    class _hnt_SOP_labs__av_structure_from_motion extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_structure_from_motion';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_structure_from_motion';
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_structure_from_motion',_hnt_SOP_labs__av_structure_from_motion)
    return _hnt_SOP_labs__av_structure_from_motion
}
