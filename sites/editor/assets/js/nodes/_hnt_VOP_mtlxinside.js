...
export default function (hou) {
    class _hnt_VOP_mtlxinside extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxinside';
        static category = '/VOP';
        static houdiniType = 'mtlxinside';
        static title = 'MtlX Inside';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxinside.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"sidefx::shader_parmname": "in"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "mask", label: "Mask", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxinside',_hnt_VOP_mtlxinside)
    return _hnt_VOP_mtlxinside
}
