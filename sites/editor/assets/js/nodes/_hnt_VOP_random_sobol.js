...
export default function (hou) {
    class _hnt_VOP_random_sobol extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/random_sobol';
        static category = '/VOP';
        static houdiniType = 'random_sobol';
        static title = 'Random Sobol';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_random_sobol.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/random_sobol',_hnt_VOP_random_sobol)
    return _hnt_VOP_random_sobol
}
