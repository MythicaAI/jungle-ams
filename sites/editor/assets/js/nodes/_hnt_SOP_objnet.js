...
export default function (hou) {
    class _hnt_SOP_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'SOP/Other/objnet';
        static category = '/SOP';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/objnet',_hnt_SOP_objnet)
    return _hnt_SOP_objnet
}
