...
export default function (hou) {
    class _hnt_DOP_gasparticlecount extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasparticlecount';
        static category = '/DOP';
        static houdiniType = 'gasparticlecount';
        static title = 'Gas Particle Count';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasparticlecount.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/gasparticlecount',_hnt_DOP_gasparticlecount)
    return _hnt_DOP_gasparticlecount
}
