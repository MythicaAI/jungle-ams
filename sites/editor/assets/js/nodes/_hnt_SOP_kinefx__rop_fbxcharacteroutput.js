...
export default function (hou) {
    class _hnt_SOP_kinefx__rop_fbxcharacteroutput extends hou._HoudiniBase {
        static is_root = true;
        static id = 'SOP/Other/kinefx::rop_fbxcharacteroutput';
        static category = '/SOP/kinefx';
        static houdiniType = 'kinefx::rop_fbxcharacteroutput';
        static title = 'ROP FBX Character Output';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_kinefx__rop_fbxcharacteroutput.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/kinefx::rop_fbxcharacteroutput',_hnt_SOP_kinefx__rop_fbxcharacteroutput)
    return _hnt_SOP_kinefx__rop_fbxcharacteroutput
}
