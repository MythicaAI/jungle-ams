...
export default function (hou) {
    class _hnt_TOP_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'TOP/Other/objnet';
        static category = '/TOP';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('TOP/Other/objnet',_hnt_TOP_objnet)
    return _hnt_TOP_objnet
}
