...
export default function (hou) {
    class _hnt_LOP_editproperties extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Other/editproperties';
        static category = '/LOP';
        static houdiniType = 'editproperties';
        static title = 'Edit Properties';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_editproperties.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.ButtonParmTemplate({name: "editinterface", label: "Edit Properties"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('LOP/Other/editproperties',_hnt_LOP_editproperties)
    return _hnt_LOP_editproperties
}
