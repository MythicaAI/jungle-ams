...
export default function (hou) {
    class _hnt_LOP_createxform extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Primitive/createxform';
        static category = '/LOP';
        static houdiniType = 'createxform';
        static title = 'Xform';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_createxform.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ xn__xformOptransform_control_6fb == block } { xn__xformOptransform_control_6fb == none }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "pivotxform", label: "Pivot Transform", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ xn__xformOptransform_control_6fb == block } { xn__xformOptransform_control_6fb == none }");
			hou_parm_template.setTags({"group_type": "collapsible"});
    ...
    hou.registerType('LOP/Primitive/createxform',_hnt_LOP_createxform)
    return _hnt_LOP_createxform
}
