...
export default function (hou) {
    class _hnt_VOP_enginecurvegen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/enginecurvegen';
        static category = '/VOP';
        static houdiniType = 'enginecurvegen';
        static title = 'Houdini Engine Procedural: Curve Generate';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/enginecurvegen',_hnt_VOP_enginecurvegen)
    return _hnt_VOP_enginecurvegen
}
