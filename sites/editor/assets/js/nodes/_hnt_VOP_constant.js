...
export default function (hou) {
    class _hnt_VOP_constant extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/constant';
        static category = '/VOP';
        static houdiniType = 'constant';
        static title = 'Constant';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_constant.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "constname", label: "Constant Name", num_components: 1, default_value: ["Value"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "constlabel", label: "Constant Label", num_components: 1, default_value: ["Constant"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('VOP/Other/constant',_hnt_VOP_constant)
    return _hnt_VOP_constant
}
