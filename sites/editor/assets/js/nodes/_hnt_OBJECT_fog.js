...
export default function (hou) {
    class _hnt_OBJECT_fog extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/fog';
        static category = '/OBJECT';
        static houdiniType = 'fog';
        static title = 'Atmosphere';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_fog.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher_1", label: "Material", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher_2", label: "Render", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher_3", label: "Misc", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('OBJECT/Other/fog',_hnt_OBJECT_fog)
    return _hnt_OBJECT_fog
}
