...
export default function (hou) {
    class _hnt_CHOP_constraintgetparentspace extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintgetparentspace';
        static category = '/CHOP';
        static houdiniType = 'constraintgetparentspace';
        static title = 'Get Parent Space';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintgetparentspace.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Get Parent Space", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "parent_bone", label: "Parent Bone", menu_items: ["0", "1"], menu_labels: ["Root", "Tip"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Constraints/constraintgetparentspace',_hnt_CHOP_constraintgetparentspace)
    return _hnt_CHOP_constraintgetparentspace
}
