...
export default function (hou) {
    class _hnt_VOP_mtlxtexcoord extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Geometric/mtlxtexcoord';
        static category = '/VOP';
        static houdiniType = 'mtlxtexcoord';
        static title = 'MtlX Texture Coordinates';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxtexcoord.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Geometric/mtlxtexcoord',_hnt_VOP_mtlxtexcoord)
    return _hnt_VOP_mtlxtexcoord
}
