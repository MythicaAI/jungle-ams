...
export default function (hou) {
    class _hnt_VOP_usduvtexture extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/usduvtexture';
        static category = '/VOP';
        static houdiniType = 'usduvtexture';
        static title = 'USD UV Texture';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_usduvtexture.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/usduvtexture',_hnt_VOP_usduvtexture)
    return _hnt_VOP_usduvtexture
}
