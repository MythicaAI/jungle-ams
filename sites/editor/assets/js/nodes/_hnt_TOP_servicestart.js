...
export default function (hou) {
    class _hnt_TOP_servicestart extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'TOP/Services/servicestart';
        static category = '/TOP';
        static houdiniType = 'servicestart';
        static title = 'Service Start';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_servicestart.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "servicedata", label: "Service Start", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('TOP/Services/servicestart',_hnt_TOP_servicestart)
    return _hnt_TOP_servicestart
}
