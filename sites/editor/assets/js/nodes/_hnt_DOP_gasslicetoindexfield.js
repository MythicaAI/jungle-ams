...
export default function (hou) {
    class _hnt_DOP_gasslicetoindexfield extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasslicetoindexfield';
        static category = '/DOP';
        static houdiniType = 'gasslicetoindexfield';
        static title = 'Gas Slice To Index Field';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasslicetoindexfield.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.MenuParmTemplate({name: "parmop_index", label: "Index Field", menu_items: ["initial", "always", "never", "default"], menu_labels: ["![BUTTONS_set_initial]Set Initial", "![BUTTONS_set_or_create]Set Always", "![BUTTONS_set_block]Set Never", "![BUTTONS_set_nothing]Use Default"], default_value: 3, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.ControlNextParameter, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.setTags({"sidefx::look": "icon"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "index", label: "Index Field", num_components: 1, default_value: ["sliceindex"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/gasslicetoindexfield',_hnt_DOP_gasslicetoindexfield)
    return _hnt_DOP_gasslicetoindexfield
}
