...
export default function (hou) {
    class _hnt_CHOP_extractbonetransforms extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/extractbonetransforms';
        static category = '/CHOP';
        static houdiniType = 'extractbonetransforms';
        static title = 'Extract Bone Transforms';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_extractbonetransforms.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "worldtransforms", label: "World Space Bone Transforms", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "absolutepaths", label: "Absolute Channel Paths", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/extractbonetransforms',_hnt_CHOP_extractbonetransforms)
    return _hnt_CHOP_extractbonetransforms
}
