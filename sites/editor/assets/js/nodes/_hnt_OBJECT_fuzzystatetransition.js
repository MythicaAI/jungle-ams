...
export default function (hou) {
    class _hnt_OBJECT_fuzzystatetransition extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Digital Assets/fuzzystatetransition';
        static category = '/OBJECT';
        static houdiniType = 'fuzzystatetransition';
        static title = 'Fuzzy State Transition';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_fuzzystatetransition.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Digital Assets/fuzzystatetransition',_hnt_OBJECT_fuzzystatetransition)
    return _hnt_OBJECT_fuzzystatetransition
}
