...
export default function (hou) {
    class _hnt_DRIVER_dop extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Other/dop';
        static category = '/DRIVER';
        static houdiniType = 'dop';
        static title = 'Dynamics';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_dop.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/dop',_hnt_DRIVER_dop)
    return _hnt_DRIVER_dop
}
