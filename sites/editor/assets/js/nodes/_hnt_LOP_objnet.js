...
export default function (hou) {
    class _hnt_LOP_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'LOP/Other/objnet';
        static category = '/LOP';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('LOP/Other/objnet',_hnt_LOP_objnet)
    return _hnt_LOP_objnet
}
