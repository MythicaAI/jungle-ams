...
export default function (hou) {
    class _hnt_VOP_nearpoint extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/nearpoint';
        static category = '/VOP';
        static houdiniType = 'nearpoint';
        static title = 'Near Point';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/nearpoint',_hnt_VOP_nearpoint)
    return _hnt_VOP_nearpoint
}
