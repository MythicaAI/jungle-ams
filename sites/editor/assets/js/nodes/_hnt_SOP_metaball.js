...
export default function (hou) {
    class _hnt_SOP_metaball extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/metaball';
        static category = '/SOP';
        static houdiniType = 'metaball';
        static title = 'Metaball';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_metaball.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.MenuParmTemplate({name: "mode", label: "Mode", menu_items: ["field", "threshold"], menu_labels: ["Field Radius", "Threshold Radius"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "metaweight", label: "Weight", num_components: 1, default_value: [2], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/metaball',_hnt_SOP_metaball)
    return _hnt_SOP_metaball
}
