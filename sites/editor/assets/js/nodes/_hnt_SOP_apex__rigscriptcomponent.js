...
export default function (hou) {
    class _hnt_SOP_apex__rigscriptcomponent extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Animation/APEX/apex::rigscriptcomponent';
        static category = '/SOP/apex';
        static houdiniType = 'apex::rigscriptcomponent';
        static title = 'APEX Rigscript Component';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_apex__rigscriptcomponent.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FolderParmTemplate({name: "folder5", label: "Component", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "collapsible", "sidefx::header_parm": "componentsource", "sidefx::switcher": "folder0"});
			...
			hou_parm_template3.setTags({"export_disable": "1", "script_callback": "hou.phm().setComponentFile(kwargs)", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "componentname", label: "Component Name", num_components: 1, default_value: ["`$OS"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "componentfile", label: "Component File", num_components: 1, default_value: ["$HIP/apexcomponents/$OS.bgeo"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l -a rop_geometry1 sopoutput", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringReplace});
			...
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "filechooser_mode": "read_and_write", "script_callback": "hou.phm().parms_from_graph(kwargs)"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FolderParmTemplate({name: "componentfolder2", label: "Component", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ componentsource != __INPUT__ }");
			hou_parm_template3.setTags({"group_default": "0", "group_type": "simple", "sidefx::header_parm": "componentsourceii", "sidefx::look": "blank", "sidefx::switcher": "componentfolder"});
			...
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FolderParmTemplate({name: "rigfolder2", label: "Rig", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ rigsource == 1 }");
			hou_parm_template3.setTags({"group_default": "0", "group_type": "simple", "sidefx::header_parm": "rigsourceii", "sidefx::look": "blank", "sidefx::switcher": "rigfolder"});
			...
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FolderParmTemplate({name: "parmfolder2", label: "Parm ", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ parmsource == 0 }");
			hou_parm_template3.setTags({"group_type": "simple", "sidefx::header_parm": "parmsourceii", "sidefx::look": "blank", "sidefx::switcher": "parmfolder"});
			hou_parm_template4 = new hou.StringParmTemplate({name: "parmsourcenode", label: "Path", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template3.addParmTemplate(hou_parm_template4);
			hou_parm_template4 = new hou.StringParmTemplate({name: "parmsourceattrib", label: "Attribute Name", num_components: 1, default_value: ["parms"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template4.setConditional(hou.parmCondType.DisableWhen, "{ parmsource == 0 }");
			hou_parm_template4.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.DataParmTemplate({name: "guide_parms_stash", label: "Guide_stash", num_components: 1, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			...
			hou_parm_template2.setTags({"group_default": "1", "group_type": "simple", "sidefx::look": "blank", "sidefx::switcher": "parameters2"});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder0_3", label: "Promote Component Parameters", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "collapsible", "sidefx::switcher": "folder0_2"});
			hou_parm_template3 = new hou.SeparatorParmTemplate({name: "sepparm10"});
			hou_parm_template3.setTags({"sidefx::layout_height": "small", "sidefx::look": "blank"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FolderParmTemplate({name: "promoted", label: "Promoted Parms", folder_type: hou.folderType.MultiparmBlock, default_value: 0, ends_tab_group: false});
			hou_parm_template3.setTags({"group_default": "0"});
			hou_parm_template4 = new hou.StringParmTemplate({name: "parm#", label: "Parm", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template4.setJoinWithNext(true);
			hou_parm_template4.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template4.setTags({"script_callback_language": "python"});
			hou_parm_template3.addParmTemplate(hou_parm_template4);
			hou_parm_template4 = new hou.StringParmTemplate({name: "alias#", label: "Alias", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template4.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template4.setTags({"script_callback_language": "python"});
			hou_parm_template3.addParmTemplate(hou_parm_template4);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "riglayer_type", label: "Type", menu_items: ["0", "1"], menu_labels: ["Rig", "RigLayer"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ riglayer_mode != 2 }");
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder4", label: "Test Animation", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "simple", "sidefx::look": "blank", "sidefx::switcher": "folder3"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Animation/APEX/apex::rigscriptcomponent',_hnt_SOP_apex__rigscriptcomponent)
    return _hnt_SOP_apex__rigscriptcomponent
}
