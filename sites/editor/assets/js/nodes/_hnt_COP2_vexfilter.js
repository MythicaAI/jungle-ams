...
export default function (hou) {
    class _hnt_COP2_vexfilter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/vexfilter';
        static category = '/COP2';
        static houdiniType = 'vexfilter';
        static title = 'VEX Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_vexfilter.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "VEX Filter", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/vexfilter',_hnt_COP2_vexfilter)
    return _hnt_COP2_vexfilter
}
