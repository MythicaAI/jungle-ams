...
export default function (hou) {
    class _hnt_CHOP_merge extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Other/merge';
        static category = '/CHOP';
        static houdiniType = 'merge';
        static title = 'Merge';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_merge.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Other/merge',_hnt_CHOP_merge)
    return _hnt_CHOP_merge
}
