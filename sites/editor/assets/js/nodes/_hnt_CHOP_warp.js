...
export default function (hou) {
    class _hnt_CHOP_warp extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/warp';
        static category = '/CHOP';
        static houdiniType = 'warp';
        static title = 'Warp';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_warp.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "method", label: "Method", menu_items: ["rate", "index"], menu_labels: ["Rate Control", "Index Control"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "scaleindex", label: "Stretch Indices To Channel Length", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/warp',_hnt_CHOP_warp)
    return _hnt_CHOP_warp
}
