...
export default function (hou) {
    class _hnt_SOP_hairgen__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Character FX/Hair and Fur/hairgen::2.0';
        static category = '/SOP';
        static houdiniType = 'hairgen::2.0';
        static title = 'Hair Generate';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_hairgen__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "forcecount", label: "Force Count", default_value: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "randomizeorder", label: "Randomize Point Order", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "prunethicken", label: "Thicken Remaining Hairs", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ prune == 0 }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "prunestable", label: "Stable Pruning", default_value: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ prune == 0 limittobbox == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "useinterpmesh", label: "Use Interpolation Mesh", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 0 }");
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "skinguidemode", label: "Skin Guide Mode", menu_items: ["matchbyguideid", "weightarrays"], menu_labels: ["Match by Guide Id", "Weight Array Pair (guides & weights)"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "influenceradiusoverride", label: "Influence Radius Override", menu_items: ["none", "skinattrib", "texture", "textureprim"], menu_labels: ["No Override", "Skin Attribute", "Texture", "Texture Primitive"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "influenceradiusoptions", label: "Influence Radius Options", menu_items: ["fit"], menu_labels: ["Fit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "influenceradiusinrange", label: "In Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { influenceradiusoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ influenceradiusoptions != 1 influenceradiusoptions != 3 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "influenceradiusoutrange", label: "Out Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { influenceradiusoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ influenceradiusoptions != 1 influenceradiusoptions != 3 }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "influenceradiustextureprim", label: "Influence Radius Texture", num_components: 1, default_value: ["influenceradiusscale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import terraintoolutils\n\nreturn terraintoolutils.buildNameMenu(kwargs['node'], input_num=3)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ influenceradiusoverride != textureprim }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=3)", "script_action_help": "Paint Influence Radius Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "influencedecayoverride", label: "Influence Decay Override", menu_items: ["none", "skinattrib", "texture", "textureprim"], menu_labels: ["No Override", "Skin Attribute", "Texture", "Texture Primitive"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "influencedecayoptions", label: "Influence Decay Options", menu_items: ["fit"], menu_labels: ["Fit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "influencedecayinrange", label: "In Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { influencedecayoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ influencedecayoptions != 1 influencedecayoptions != 3 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "influencedecayoutrange", label: "Out Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { influencedecayoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ influencedecayoptions != 1 influencedecayoptions != 3 }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "influencedecaytextureprim", label: "Influence Decay Texture", num_components: 1, default_value: ["influencedecayscale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import terraintoolutils\n\nreturn terraintoolutils.buildNameMenu(kwargs['node'], input_num=3)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ influencedecayoverride != textureprim }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=3)", "script_action_help": "Paint Influence Decay Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "maxguidecountoverride", label: "Maximum Guide Count Override", menu_items: ["none", "skinattrib", "texture", "textureprim"], menu_labels: ["No Override", "Skin Attribute", "Texture", "Texture Primitive"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "maxguidecountoptions", label: "Maximum Guide Count Options", menu_items: ["fit"], menu_labels: ["Fit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "maxguidecountinrange", label: "In Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { maxguidecountoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ maxguidecountoptions != 1 maxguidecountoptions != 3 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "maxguidecountoutrange", label: "Out Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { maxguidecountoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ maxguidecountoptions != 1 maxguidecountoptions != 3 }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "maxguidecounttextureprim", label: "Maximum Guide Count Texture", num_components: 1, default_value: ["maxguidecountscale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import terraintoolutils\n\nreturn terraintoolutils.buildNameMenu(kwargs['node'], input_num=3)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ maxguidecountoverride != textureprim }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=3)", "script_action_help": "Paint Maximum Guide Count Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "maxguideangleoverride", label: "Max Guide Angle Override", menu_items: ["none", "skinattrib", "texture", "textureprim"], menu_labels: ["No Override", "Skin Attribute", "Texture", "Texture Primitive"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "maxguideangleoptions", label: "Max Guide Angle Options", menu_items: ["fit"], menu_labels: ["Fit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "maxguideangleinrange", label: "In Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { maxguideangleoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ maxguideangleoptions != 1 maxguideangleoptions != 3 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "maxguideangleoutrange", label: "Out Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 } { maxguideangleoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ maxguideangleoptions != 1 maxguideangleoptions != 3 }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "maxguideangletextureprim", label: "Max Guide Angle Texture", num_components: 1, default_value: ["maxguideanglescale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import terraintoolutils\n\nreturn terraintoolutils.buildNameMenu(kwargs['node'], input_num=3)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 1 }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ maxguideangleoverride != textureprim }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=3)", "script_action_help": "Paint Max Guide Angle Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "clumpcrossoveroverride", label: "Clump Crossover Override", menu_items: ["none", "skinattrib", "texture", "textureprim"], menu_labels: ["No Override", "Skin Attribute", "Texture", "Texture Primitive"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "clumpcrossoveroptions", label: "Clump Crossover Options", menu_items: ["fit"], menu_labels: ["Fit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "clumpcrossoverinrange", label: "In Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { clumpcrossoveroverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ clumpcrossoveroptions != 1 clumpcrossoveroptions != 3 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "clumpcrossoveroutrange", label: "Out Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { clumpcrossoveroverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ clumpcrossoveroptions != 1 clumpcrossoveroptions != 3 }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "clumpcrossovertextureprim", label: "Clump Crossover Texture", num_components: 1, default_value: ["clumpcrossoverscale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import terraintoolutils\n\nreturn terraintoolutils.buildNameMenu(kwargs['node'], input_num=3)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ clumpcrossoveroverride != textureprim }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=3)", "script_action_help": "Paint Clump Crossover Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "clumpidattrib", label: "Clump Id Attribute", num_components: 1, default_value: ["clumpid"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('GUIDES')\ngeo = node.geometry()\n\nattribs = geo.primAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() != hou.attribData.Int:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "unguidedlengthoverride", label: "Length Override", menu_items: ["none", "skinattrib", "texture", "textureprim"], menu_labels: ["No Override", "Skin Attribute", "Texture", "Texture Primitive"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 1 growunguided == 0 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "unguidedlength"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "unguidedlengthoptions", label: "Length Options", menu_items: ["fit"], menu_labels: ["Fit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 1 growunguided == 0 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "unguidedlength"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "unguidedlengthinrange", label: "In Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 1 growunguided == 0 } { unguidedlengthoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ unguidedlengthoptions != 1 unguidedlengthoptions != 3 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "unguidedlength"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "unguidedlengthoutrange", label: "Out Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 1 growunguided == 0 } { unguidedlengthoverride == none }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ unguidedlengthoptions != 1 unguidedlengthoptions != 3 }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "unguidedlength"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "unguidedlength"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "unguidedlengthtextureprim", label: "Length Texture", num_components: 1, default_value: ["unguidedlengthscale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import terraintoolutils\n\nreturn terraintoolutils.buildNameMenu(kwargs['node'], input_num=3)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 1 growunguided == 0 }");
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ unguidedlengthoverride != textureprim }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "unguidedlength", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=3)", "script_action_help": "Paint Length Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "thickness", label: "Thickness", num_components: 1, default_value: [0.001], min: 0, max: 0.01, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ outputthicknessattrib == 0 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "thicknessoverride", label: "Thickness Override", menu_items: ["none", "skinattrib", "texture"], menu_labels: ["No Override", "Skin Attribute", "Texture"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ outputthicknessattrib == 0 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setTags({"parmoverride_mainparm": "thickness"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "thicknessskinattrib", label: "Thickness Attrib", num_components: 1, default_value: ["thicknessscale"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import furtoolutils\n\ntry:\n    return furtoolutils.buildSkinPaintAttribMenu(\n            kwargs['node'], skininput=0, skinparmname=None,\n            attribSize=1)\nexcept:\n    return []", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ outputthicknessattrib == 0 } { thicknessoverride != skinattrib }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "thickness", "script_action": "import furtoolutils\n\nfurtoolutils.paintSkinAttrib(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, 0,\n    skinparmname=None)", "script_action_help": "Paint Thickness Attrib", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "thicknesstexture", label: "Thickness Texture", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Image, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ outputthicknessattrib == 0 } { thicknessoverride != texture }");
			hou_parm_template3.setTags({"parmoverride_mainparm": "thickness"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template2.setTags({"group_type": "simple"});
			hou_parm_template3 = new hou.StringParmTemplate({name: "pointattribs", label: "Point Attributes", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('SKIN')\ngeo = node.geometry()\n\nattribs = geo.pointAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() == hou.attribData.String:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "sop_input": "1"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "vertattribs", label: "Vertex Attributes", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('SKIN')\ngeo = node.geometry()\n\nattribs = geo.vertexAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() == hou.attribData.String:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ mode != surface }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "sop_input": "1"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "primattribs", label: "Primitive Attributes", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('SKIN')\ngeo = node.geometry()\n\nattribs = geo.primAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() == hou.attribData.String:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ mode != surface }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "sop_input": "1"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "detailattribs", label: "Detail Attributes", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('SKIN')\ngeo = node.geometry()\n\nattribs = geo.globalAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() == hou.attribData.String:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "sop_input": "1"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"group_type": "simple"});
			hou_parm_template3 = new hou.StringParmTemplate({name: "guidepointattribs", label: "Point Attributes", num_components: 1, default_value: ["barborient"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('GUIDES')\ngeo = node.geometry()\n\nattribs = geo.pointAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() == hou.attribData.String:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "guideprimattribs", label: "Primitive Attributes", num_components: 1, default_value: ["side"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "node = hou.node('GUIDES')\ngeo = node.geometry()\n\nattribs = geo.primAttribs()\n\nres = []\nfor attrib in attribs:\n    if attrib.dataType() == hou.attribData.String:\n        continue\n    res.append(attrib.name())\n    res.append(attrib.name())\n\nreturn res", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FolderParmTemplate({name: "folder_weightarraypairs", label: "Weight Array Pairs", folder_type: hou.folderType.MultiparmBlock, default_value: 1, ends_tab_group: false});
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "multistartoffset": "0"});
			let hou_parm_template4 = new hou.StringParmTemplate({name: "guideindexattrib#", label: "Index Attribute", num_components: 1, default_value: ["templatenames"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template4.hideLabel(true);
			hou_parm_template4.setJoinWithNext(true);
			hou_parm_template3.addParmTemplate(hou_parm_template4);
			hou_parm_template4 = new hou.StringParmTemplate({name: "guideweightattrib#", label: "Weight Attribute", num_components: 1, default_value: ["templateweights"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template4.hideLabel(true);
			hou_parm_template3.addParmTemplate(hou_parm_template4);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Character FX/Hair and Fur/hairgen::2.0',_hnt_SOP_hairgen__2_0)
    return _hnt_SOP_hairgen__2_0
}
