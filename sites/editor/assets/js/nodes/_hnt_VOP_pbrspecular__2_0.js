...
export default function (hou) {
    class _hnt_VOP_pbrspecular__2_0 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Shading/pbrspecular::2.0';
        static category = '/VOP';
        static houdiniType = 'pbrspecular::2.0';
    ...
    hou.registerType('VOP/Shading/pbrspecular::2.0',_hnt_VOP_pbrspecular__2_0)
    return _hnt_VOP_pbrspecular__2_0
}
