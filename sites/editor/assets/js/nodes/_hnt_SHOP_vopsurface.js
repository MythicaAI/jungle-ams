...
export default function (hou) {
    class _hnt_SHOP_vopsurface extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopsurface';
        static category = '/SHOP';
        static houdiniType = 'vopsurface';
        static title = 'Surface Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopsurface.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopsurface',_hnt_SHOP_vopsurface)
    return _hnt_SHOP_vopsurface
}
