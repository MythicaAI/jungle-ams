...
export default function (hou) {
    class _hnt_OBJECT_pxrramplightfilter extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Render/pxrramplightfilter';
        static category = '/OBJECT';
        static houdiniType = 'pxrramplightfilter';
        static title = 'Pxr Ramp Light Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_pxrramplightfilter.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.FolderParmTemplate({name: "ramp_direction", label: "Ramp Direction", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template3 = new hou.MenuParmTemplate({name: "rampType", label: "Ramp Type", menu_items: ["0", "1", "2", "3"], menu_labels: ["distToLight", "linear", "spherical", "radial"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setHelp("rampType: In which direction the ramp is applied.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "int"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "beginDist", label: "Begin Distance", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setHelp("beginDist: Distance where the ramp starts.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "endDist", label: "End Distance", num_components: 1, default_value: [10], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setHelp("endDist: Distance where the ramp ends.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "rampbasis_var": "ramp_Interpolation", "rampbasisdefault": "linear", "rampcolortype": "rgb", "rampfloatdefault": "1pos ( 0 ) 1value ( 0 ) 1interp ( linear ) 2pos ( 0.33333333333333331 ) 2value ( 0.33333333333333331 ) 2interp ( linear ) 3pos ( 0.66666666666666663 ) 3value ( 0.66666666666666663 ) 3interp ( linear ) 4pos ( 1 ) 4value ( 1 ) 4interp ( linear )", "rampkeys_var": "ramp_Knots", "rampvalues_var": "ramp_Floats"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template3.setHelp("invert: If the multipliers should be inverted");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "int"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('OBJECT/Render/pxrramplightfilter',_hnt_OBJECT_pxrramplightfilter)
    return _hnt_OBJECT_pxrramplightfilter
}
