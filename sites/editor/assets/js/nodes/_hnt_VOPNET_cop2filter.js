...
export default function (hou) {
    class _hnt_VOPNET_cop2filter extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'VOPNET/Other/cop2filter';
        static category = '/VOPNET';
        static houdiniType = 'cop2filter';
        static title = 'COP2 Filter Type';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOPNET_cop2filter.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOPNET/Other/cop2filter',_hnt_VOPNET_cop2filter)
    return _hnt_VOPNET_cop2filter
}
