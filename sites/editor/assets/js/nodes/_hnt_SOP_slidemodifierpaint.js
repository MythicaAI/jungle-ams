...
export default function (hou) {
    class _hnt_SOP_slidemodifierpaint extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/slidemodifierpaint';
        static category = '/SOP';
        static houdiniType = 'slidemodifierpaint';
        static title = 'Slide Modifier Paint';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_slidemodifierpaint.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "paintattrib", label: "Attribute to Paint", menu_items: ["slidemod", "inflatemod"], menu_labels: ["Surface Sliding Modifier", "Surface Inflation Modifier"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "mergemode", label: "Merge Mode", menu_items: ["set", "add", "sub", "mult", "screen"], menu_labels: ["Replace", "Add", "Subtract", "Multiply", "Screen"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation for All", menu_items: ["paint", "smoothattrib", "erase"], menu_labels: ["Paint", "Smooth", "Erase Changes"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "opacity", label: "Opacity", num_components: 1, default_value: [0.1], min: 0, max: 1, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Other/slidemodifierpaint',_hnt_SOP_slidemodifierpaint)
    return _hnt_SOP_slidemodifierpaint
}
