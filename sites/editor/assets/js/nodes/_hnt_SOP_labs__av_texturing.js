...
export default function (hou) {
    class _hnt_SOP_labs__av_texturing extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_texturing';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_texturing';
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_texturing',_hnt_SOP_labs__av_texturing)
    return _hnt_SOP_labs__av_texturing
}
