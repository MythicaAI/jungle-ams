...
export default function (hou) {
    class _hnt_LOP_usd_rop extends hou._HoudiniBase {
        static is_root = true;
        static id = 'LOP/Other/usd_rop';
        static category = '/LOP';
        static houdiniType = 'usd_rop';
        static title = 'USD ROP';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_usd_rop.svg';
        constructor() {
            super();
    ...
    hou.registerType('LOP/Other/usd_rop',_hnt_LOP_usd_rop)
    return _hnt_LOP_usd_rop
}
