...
export default function (hou) {
    class _hnt_SHOP_vopphoton extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopphoton';
        static category = '/SHOP';
        static houdiniType = 'vopphoton';
        static title = 'Photon Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopphoton.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopphoton',_hnt_SHOP_vopphoton)
    return _hnt_SHOP_vopphoton
}
