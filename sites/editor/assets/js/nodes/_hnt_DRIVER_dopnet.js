...
export default function (hou) {
    class _hnt_DRIVER_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'DRIVER/Other/dopnet';
        static category = '/DRIVER';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/dopnet',_hnt_DRIVER_dopnet)
    return _hnt_DRIVER_dopnet
}
