...
export default function (hou) {
    class _hnt_CHOP_output extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/output';
        static category = '/CHOP';
        static houdiniType = 'output';
        static title = 'Output';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_output.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Common", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Other/output',_hnt_CHOP_output)
    return _hnt_CHOP_output
}
