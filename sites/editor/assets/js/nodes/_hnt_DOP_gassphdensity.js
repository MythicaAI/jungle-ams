...
export default function (hou) {
    class _hnt_DOP_gassphdensity extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gassphdensity';
        static category = '/DOP';
        static houdiniType = 'gassphdensity';
        static title = 'Gas SPH Density';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gassphdensity.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/gassphdensity',_hnt_DOP_gassphdensity)
    return _hnt_DOP_gassphdensity
}
