...
export default function (hou) {
    class _hnt_DOP_gasadjustparticlecoordinates extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasadjustparticlecoordinates';
        static category = '/DOP';
        static houdiniType = 'gasadjustparticlecoordinates';
        static title = 'Gas Adjust Particle Coordinates';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasadjustparticlecoordinates.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/gasadjustparticlecoordinates',_hnt_DOP_gasadjustparticlecoordinates)
    return _hnt_DOP_gasadjustparticlecoordinates
}
