...
export default function (hou) {
    class _hnt_CHOP_shuffle extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/shuffle';
        static category = '/CHOP';
        static houdiniType = 'shuffle';
        static title = 'Shuffle';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_shuffle.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Shuffle", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "method", label: "Method", menu_items: ["off", "swap", "seqname", "seqall", "seqn", "seqeveryn", "splitall", "splitn", "spliteveryn"], menu_labels: ["Off", "Swap Channels and Samples", "Sequence Channels by Name", "Sequence All Channels", "Sequence N Channels", "Sequence Every Nth Channel", "Split All Samples", "Split N Samples", "Split Every Nth Sample"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "nval", label: "N Value", num_components: 1, default_value: [3], min: 1, max: 12, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/shuffle',_hnt_CHOP_shuffle)
    return _hnt_CHOP_shuffle
}
