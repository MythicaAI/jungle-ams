...
export default function (hou) {
    class _hnt_SOP_wire extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/wire';
        static category = '/SOP';
        static houdiniType = 'wire';
        static title = 'Wireframe';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_wire.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "corners", label: "Round Corners", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "caps", label: "End Caps", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "remove", label: "Remove Polygons", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/wire',_hnt_SOP_wire)
    return _hnt_SOP_wire
}
