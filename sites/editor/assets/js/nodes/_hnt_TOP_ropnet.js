...
export default function (hou) {
    class _hnt_TOP_ropnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'TOP/Other/ropnet';
        static category = '/TOP';
        static houdiniType = 'ropnet';
        static title = 'ROP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_ropnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('TOP/Other/ropnet',_hnt_TOP_ropnet)
    return _hnt_TOP_ropnet
}
