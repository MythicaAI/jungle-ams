...
export default function (hou) {
    class _hnt_SHOP_vopfog extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopfog';
        static category = '/SHOP';
        static houdiniType = 'vopfog';
        static title = 'Fog Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopfog.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopfog',_hnt_SHOP_vopfog)
    return _hnt_SHOP_vopfog
}
