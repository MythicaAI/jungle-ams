...
export default function (hou) {
    class _hnt_VOP_contour__2_0 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Utility/contour::2.0';
        static category = '/VOP';
        static houdiniType = 'contour::2.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FloatParmTemplate({name: "width", label: "Width", num_components: 1, default_value: [0.01], min: 0, max: 0.1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ active == 0 }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "sharp", label: "Sharpness", num_components: 1, default_value: [4], min: 0, max: 10, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ active == 0 }");
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Utility/contour::2.0',_hnt_VOP_contour__2_0)
    return _hnt_VOP_contour__2_0
}
