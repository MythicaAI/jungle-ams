...
export default function (hou) {
    class _hnt_SOP_labs__av_depth_map__4_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_depth_map::4.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_depth_map::4.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.IntParmTemplate({name: "sNumCam", label: "SGM: Num Neighbor Cameras", num_components: 1, default_value: [10], min: 1, max: 100, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_1", label: "Depth Map Filter", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: true});
			hou_parm_template2 = new hou.IntParmTemplate({name: "minCon", label: "Min Consistent Cameras", num_components: 1, default_value: [3], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template2.setHelp("Minimum number of consistent cameras to consider the pixel.");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "minConBad", label: "Min Consistent Cameras Bad Similarity", num_components: 1, default_value: [4], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_depth_map::4.0',_hnt_SOP_labs__av_depth_map__4_0)
    return _hnt_SOP_labs__av_depth_map__4_0
}
