...
export default function (hou) {
    class _hnt_VOPNET_surface extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'VOPNET/Other/surface';
        static category = '/VOPNET';
        static houdiniType = 'surface';
        static title = 'VEX Surface SHOP Type';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOPNET_surface.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOPNET/Other/surface',_hnt_VOPNET_surface)
    return _hnt_VOPNET_surface
}
