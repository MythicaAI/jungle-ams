...
export default function (hou) {
    class _hnt_SOP_labs__av_initialize__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_initialize::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_initialize::3.0';
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_initialize::3.0',_hnt_SOP_labs__av_initialize__3_0)
    return _hnt_SOP_labs__av_initialize__3_0
}
