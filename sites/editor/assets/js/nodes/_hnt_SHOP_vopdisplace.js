...
export default function (hou) {
    class _hnt_SHOP_vopdisplace extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopdisplace';
        static category = '/SHOP';
        static houdiniType = 'vopdisplace';
        static title = 'Displacement Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopdisplace.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopdisplace',_hnt_SHOP_vopdisplace)
    return _hnt_SHOP_vopdisplace
}
