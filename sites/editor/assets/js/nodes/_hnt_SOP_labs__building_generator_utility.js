...
export default function (hou) {
    class _hnt_SOP_labs__building_generator_utility extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/World Building/Architecture/labs::building_generator_utility';
        static category = '/SOP/labs';
        static houdiniType = 'labs::building_generator_utility';
        static title = 'Labs Building Generator Utility';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__building_generator_utility.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_1", label: "Handplaced Override", folder_type: hou.folderType.RadioButtons, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_2", label: "Volumetric Override", folder_type: hou.folderType.RadioButtons, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Labs/World Building/Architecture/labs::building_generator_utility',_hnt_SOP_labs__building_generator_utility)
    return _hnt_SOP_labs__building_generator_utility
}
