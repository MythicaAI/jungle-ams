...
export default function (hou) {
    class _hnt_SOP_labs__av_depth_map__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_depth_map::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_depth_map::3.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template3.setHelp("Maximum angle between two views");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "computeNormalMaps", label: "Compute normal maps per depth map", default_value: false});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_depth_map::3.0',_hnt_SOP_labs__av_depth_map__3_0)
    return _hnt_SOP_labs__av_depth_map__3_0
}
