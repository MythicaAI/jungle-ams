...
export default function (hou) {
    class _hnt_VOP_mtlxdisney_brdf_2012 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Pbr/mtlxdisney_brdf_2012';
        static category = '/VOP';
        static houdiniType = 'mtlxdisney_brdf_2012';
        static title = 'MtlX Disney Brdf 2012';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxdisney_brdf_2012.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"ogl_spec_intensity": "1"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Pbr/mtlxdisney_brdf_2012',_hnt_VOP_mtlxdisney_brdf_2012)
    return _hnt_VOP_mtlxdisney_brdf_2012
}
