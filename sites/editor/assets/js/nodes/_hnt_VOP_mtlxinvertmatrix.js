...
export default function (hou) {
    class _hnt_VOP_mtlxinvertmatrix extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxinvertmatrix';
        static category = '/VOP';
        static houdiniType = 'mtlxinvertmatrix';
        static title = 'MtlX Invert Matrix';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxinvertmatrix.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FloatParmTemplate({name: "in", label: "Input", num_components: 9, default_value: [1, 0, 0, 0, 1, 0, 0, 0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxinvertmatrix',_hnt_VOP_mtlxinvertmatrix)
    return _hnt_VOP_mtlxinvertmatrix
}
