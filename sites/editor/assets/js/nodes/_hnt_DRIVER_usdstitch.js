...
export default function (hou) {
    class _hnt_DRIVER_usdstitch extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin, hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Scene/usdstitch';
        static category = '/DRIVER';
        static houdiniType = 'usdstitch';
        static title = 'USD Stitch';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_usdstitch.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stitchfiles", label: "Stitch Files", folder_type: hou.folderType.MultiparmBlock, default_value: 1, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "pdg_logoutput", label: "Report Output Files", default_value: false});
    ...
    hou.registerType('DRIVER/Scene/usdstitch',_hnt_DRIVER_usdstitch)
    return _hnt_DRIVER_usdstitch
}
