...
export default function (hou) {
    class _hnt_VOP_mtlxceil extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxceil';
        static category = '/VOP';
        static houdiniType = 'mtlxceil';
        static title = 'MtlX Ceil';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxceil.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxceil',_hnt_VOP_mtlxceil)
    return _hnt_VOP_mtlxceil
}
