...
export default function (hou) {
    class _hnt_LOP_cube extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Primitive/cube';
        static category = '/LOP';
        static houdiniType = 'cube';
        static title = 'Cube';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_cube.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "primtype", label: "Primitive Type", num_components: 1, default_value: ["UsdGeomCube"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createSchemaTypesMenu(True)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "computeextents", label: "Compute Extent Attribute", default_value: false, default_expression: "if(!strcmp(chs(\"size_control\"), \"none\"), 0, 1)", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template.hide(true);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "size_control", label: "Size", num_components: 1, default_value: ["set"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createEditPropertiesControlMenu(kwargs, 'double')", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.ControlNextParameter});
			hou_parm_template.setTags({"sidefx::look": "icon"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "size", label: "Size", num_components: 1, default_value: [2], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ size_control == block } { size_control == none }");
    ...
    hou.registerType('LOP/Primitive/cube',_hnt_LOP_cube)
    return _hnt_LOP_cube
}
