...
export default function (hou) {
    class _hnt_DOP_crowdstate extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Crowds/crowdstate';
        static category = '/DOP';
        static houdiniType = 'crowdstate';
        static title = 'Crowd State';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_crowdstate.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "streamname", label: "State Name", num_components: 1, default_value: ["$OS"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('DOP/Crowds/crowdstate',_hnt_DOP_crowdstate)
    return _hnt_DOP_crowdstate
}
