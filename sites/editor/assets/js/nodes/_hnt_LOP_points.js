...
export default function (hou) {
    class _hnt_LOP_points extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Primitive/points';
        static category = '/LOP';
        static houdiniType = 'points';
        static title = 'Points';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_points.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "primtype", label: "Primitive Type", num_components: 1, default_value: ["UsdGeomPoints"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createSchemaTypesMenu(True)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('LOP/Primitive/points',_hnt_LOP_points)
    return _hnt_LOP_points
}
