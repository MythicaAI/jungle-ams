...
export default function (hou) {
    class _hnt_COP2_invert extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/invert';
        static category = '/COP2';
        static houdiniType = 'invert';
        static title = 'Invert';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_invert.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Invert", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.ButtonParmTemplate({name: "showcurves", label: "Show Color Curves"});
    ...
    hou.registerType('COP2/Other/invert',_hnt_COP2_invert)
    return _hnt_COP2_invert
}
