...
export default function (hou) {
    class _hnt_COP2_tima extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/tima';
        static category = '/COP2';
        static houdiniType = 'tima';
        static title = 'Time Machine';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_tima.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Time Machine", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "blackframes", label: "Black Pixel Frame", num_components: 1, default_value: [0], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "whiteframes", label: "White Pixel Frame", num_components: 1, default_value: [10], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "relative", label: "Relative to Current Frame", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "mixframes", label: "Blend Frames", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/tima',_hnt_COP2_tima)
    return _hnt_COP2_tima
}
