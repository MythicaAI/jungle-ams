...
export default function (hou) {
    class _hnt_VOP_relpointbbox extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/relpointbbox';
        static category = '/VOP';
        static houdiniType = 'relpointbbox';
        static title = 'Relative to Point Bounding Box';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/relpointbbox',_hnt_VOP_relpointbbox)
    return _hnt_VOP_relpointbbox
}
