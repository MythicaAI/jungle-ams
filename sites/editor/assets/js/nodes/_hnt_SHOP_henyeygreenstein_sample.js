...
export default function (hou) {
    class _hnt_SHOP_henyeygreenstein_sample extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/henyeygreenstein_sample';
        static category = '/SHOP';
        static houdiniType = 'henyeygreenstein_sample';
        static title = 'henyeygreenstein_sample';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_henyeygreenstein_sample.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/henyeygreenstein_sample',_hnt_SHOP_henyeygreenstein_sample)
    return _hnt_SHOP_henyeygreenstein_sample
}
