...
export default function (hou) {
    class _hnt_VOP_pxrintmultlightfilter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrintmultlightfilter';
        static category = '/VOP';
        static houdiniType = 'pxrintmultlightfilter';
        static title = 'Pxr Intensity Mult Light Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrintmultlightfilter.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "multiplier", label: "Multiplier", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.setHelp("intensity: Multiplier for the light intensity.");
			...
			hou_parm_template2.setHelp("exposure: Exposure control for the multiplier.");
			hou_parm_template2.setTags({"script_ritype": "float"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "invert", label: "Invert", default_value: false});
			hou_parm_template2.setHelp("invert: When this is on, invert the multiplier. For instance, if we set the light filter's intensity to 2, the final light's intensity will be divided by (instead of multiplied by) the light filter's intensity.");
			...
			hou_parm_template2.setHelp("Saturation of the light before hitting the surface (0=greyscale,1=normal,>1=boosted colors).");
			hou_parm_template2.setTags({"script_ritype": "float"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('VOP/Other/pxrintmultlightfilter',_hnt_VOP_pxrintmultlightfilter)
    return _hnt_VOP_pxrintmultlightfilter
}
