...
export default function (hou) {
    class _hnt_VOP_mtlxsheen_bsdf extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Pbr/mtlxsheen_bsdf';
        static category = '/VOP';
        static houdiniType = 'mtlxsheen_bsdf';
        static title = 'MtlX Sheen Bsdf';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxsheen_bsdf.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Pbr/mtlxsheen_bsdf',_hnt_VOP_mtlxsheen_bsdf)
    return _hnt_VOP_mtlxsheen_bsdf
}
