...
export default function (hou) {
    class _hnt_CHOP_constraintgetworldspace extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintgetworldspace';
        static category = '/CHOP';
        static houdiniType = 'constraintgetworldspace';
        static title = 'Get World Space';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintgetworldspace.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Get World Space", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Constraints/constraintgetworldspace',_hnt_CHOP_constraintgetworldspace)
    return _hnt_CHOP_constraintgetworldspace
}
