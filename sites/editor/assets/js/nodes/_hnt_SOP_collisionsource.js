...
export default function (hou) {
    class _hnt_SOP_collisionsource extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Fluid/collisionsource';
        static category = '/SOP';
        static houdiniType = 'collisionsource';
        static title = 'Collision Source';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_collisionsource.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.ToggleParmTemplate({name: "geo", label: "Output Geometry", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "displaygeo", label: "Display Geometry", default_value: true});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ geo == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "geoname", label: "Geometry Name", num_components: 1, default_value: ["collisiongeo"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ geo == 0 }");
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "script_callback": ""});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder5", label: "Interpolation", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ geo == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "displaypoints", label: "Display Points", default_value: true});
			...
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "volume", label: "Output Volume", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "displayvolume", label: "Display Volume", default_value: true});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ volume == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ volume == 0 }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback": ""});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('SOP/Fluid/collisionsource',_hnt_SOP_collisionsource)
    return _hnt_SOP_collisionsource
}
