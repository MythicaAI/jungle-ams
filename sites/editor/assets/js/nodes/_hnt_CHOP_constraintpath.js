...
export default function (hou) {
    class _hnt_CHOP_constraintpath extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintpath';
        static category = '/CHOP';
        static houdiniType = 'constraintpath';
        static title = 'Follow Path';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintpath.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Constraint Path", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "uparmtype", label: "Parametrization", menu_items: ["0", "1", "2", "3", "4"], menu_labels: ["Normalized Distance", "Normalized Spline", "Distance from Start", "Distance from End", "Distance Point Attribute"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "lookatmode", label: "Look At Mode", menu_items: ["0", "1", "2"], menu_labels: ["None", "Along Path", "Direction Attribute from Path"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ hasinput(1) == 1 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "lookupmode", label: "Look Up Mode", menu_items: ["0", "1", "2"], menu_labels: ["Up Vector", "Up Vector Attribute from Path", "Along Path"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ lookatmode != 2 } { hasinput(1) == 1 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ lookatmode == 0 hasinput(1) == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "tolerance", label: "Tolerance", num_components: 1, default_value: [0.0001], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Constraints/constraintpath',_hnt_CHOP_constraintpath)
    return _hnt_CHOP_constraintpath
}
