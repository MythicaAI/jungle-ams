...
export default function (hou) {
    class _hnt_DOP_matrixfieldvisualization extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/matrixfieldvisualization';
        static category = '/DOP';
        static houdiniType = 'matrixfieldvisualization';
        static title = 'Matrix Field Visualization';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_matrixfieldvisualization.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ guideusesmoke == 1 } { guideuseplane == 0 }");
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ guideusesmoke == 1 } { guideuseplane == 0 }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "guideiso", label: "Iso Offset", num_components: 1, default_value: [0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ guideusesmoke == 1 } { guideuseplane == 1 }");
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/matrixfieldvisualization',_hnt_DOP_matrixfieldvisualization)
    return _hnt_DOP_matrixfieldvisualization
}
