...
export default function (hou) {
    class _hnt_COP2_vopcop2gen extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'COP2/Other/vopcop2gen';
        static category = '/COP2';
        static houdiniType = 'vopcop2gen';
        static title = 'VOP COP2 Generator';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_vopcop2gen.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.StringParmTemplate({name: "vop_compiler", label: "Compiler", num_components: 1, default_value: ["vcc -q $VOP_INCLUDEPATH -o $VOP_OBJECTFILE -e $VOP_ERRORFILE $VOP_SOURCEFILE"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('COP2/Other/vopcop2gen',_hnt_COP2_vopcop2gen)
    return _hnt_COP2_vopcop2gen
}
