...
export default function (hou) {
    class _hnt_TOP_labs__ropkarma__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'TOP/Labs/Rendering/Render/labs::ropkarma::2.0';
        static category = '/TOP/labs';
        static houdiniType = 'labs::ropkarma::2.0';
        static title = 'Labs Karma Render';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_labs__ropkarma__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FolderParmTemplate({name: "fd_karma", label: "Karma", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_default": "1", "group_type": "collapsible", "sidefx::header_parm": "pdg_cachemode"});
			let hou_parm_template3 = new hou.StringParmTemplate({name: "loppath", label: "LOP Path", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template5 = new hou.MenuParmTemplate({name: "wedgetype#", label: "Wedge Type", menu_items: ["auto", "range", "rand", "batch", "periodic", "list", "attrib"], menu_labels: ["Automatic", "Custom Range", "Random Sample", "Batched Sequence", "Periodic Sequence", "List of Values", "Attribute Values"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ timedependent == 0 }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template2.setTags({"group_type": "collapsible"});
			hou_parm_template3 = new hou.FloatParmTemplate({name: "frame", label: "Frame", num_components: 1, default_value: [0], default_expression: ["$FF"], default_expression_language: [hou.scriptLanguage.Hscript], min: 1, max: 240, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "picture", label: "Output File", num_components: 1, default_value: ["ifs(ch('filemethod'),chs('file'),chs('cachedir') + '/' + chs('cachename'))"], default_expression: ["ifs(ch('filemethod'),chs('file'),chs('cachedir') + '/' + chs('cachename'))"], default_expression_language: [hou.scriptLanguage.Hscript], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('TOP/Labs/Rendering/Render/labs::ropkarma::2.0',_hnt_TOP_labs__ropkarma__2_0)
    return _hnt_TOP_labs__ropkarma__2_0
}
