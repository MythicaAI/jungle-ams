...
export default function (hou) {
    class _hnt_VOP_mtlxremap extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Adjustment/mtlxremap';
        static category = '/VOP';
        static houdiniType = 'mtlxremap';
        static title = 'MtlX Remap';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxremap.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Adjustment/mtlxremap',_hnt_VOP_mtlxremap)
    return _hnt_VOP_mtlxremap
}
