...
export default function (hou) {
    class _hnt_VOP_mtlxminus extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxminus';
        static category = '/VOP';
        static houdiniType = 'mtlxminus';
        static title = 'MtlX Minus';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxminus.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxminus',_hnt_VOP_mtlxminus)
    return _hnt_VOP_mtlxminus
}
