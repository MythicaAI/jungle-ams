...
export default function (hou) {
    class _hnt_VOP_pyroBlackbody extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Pyro/pyroBlackbody';
        static category = '/VOP';
        static houdiniType = 'pyroBlackbody';
        static title = 'Pyro Blackbody';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pyroBlackbody.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "temp0", label: "Temperature at 0 (K)", num_components: 1, default_value: [0], min: 0, max: 1000, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "temp", label: "Temperature at 1 (K)", num_components: 1, default_value: [5000], min: 350, max: 15000, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "doplanck", label: "Integrate Blackbody Curve", default_value: false});
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "dotm", label: "Tone Mapping:", default_value: true});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ doplanck == 1 }");
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.LabelParmTemplate({name: "spacer", label: "Spacer", column_labels: [""]});
			hou_parm_template2.hideLabel(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "tm_adapt", label: "Adaptation", num_components: 1, default_value: [0.18], min: 0, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ dotm == 0 } { doplanck == 1 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "tm_burn", label: "Burn", num_components: 1, default_value: [0], min: null, max: 2, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ dotm == 0 } { doplanck == 1 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Pyro/pyroBlackbody',_hnt_VOP_pyroBlackbody)
    return _hnt_VOP_pyroBlackbody
}
