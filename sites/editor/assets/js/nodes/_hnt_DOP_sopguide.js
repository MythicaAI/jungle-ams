...
export default function (hou) {
    class _hnt_DOP_sopguide extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Other/sopguide';
        static category = '/DOP';
        static houdiniType = 'sopguide';
        static title = 'SOP Guide';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_sopguide.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "wireframe", label: "Draw Wireframe", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/sopguide',_hnt_DOP_sopguide)
    return _hnt_DOP_sopguide
}
