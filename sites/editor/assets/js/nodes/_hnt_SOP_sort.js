...
export default function (hou) {
    class _hnt_SOP_sort extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/sort';
        static category = '/SOP';
        static houdiniType = 'sort';
        static title = 'Sort';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_sort.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "pointsfolder", label: "Points", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2 = new hou.MenuParmTemplate({name: "ptsort", label: "Point Sort", menu_items: ["none", "vtxord", "byx", "byy", "byz", "rev", "seed", "shif", "prox", "vector", "expression", "spatial", "attribute", "primindex"], menu_labels: ["No Change", "By Vertex Order", "By X", "By Y", "By Z", "Reverse", "Random", "Shift", "Proximity to Point", "Along Vector", "By Expression", "Spatial Locality", "By Attribute", "By Primitive Index"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ ptsort != shif }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ ptsort != vector }");
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ ptsort != attribute }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "pointreverse", label: "Reverse Point Sort", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "primitivesfolder", label: "Primitives", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template.setTags({"group_type": "simple"});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "primsort", label: "Primitive Sort", menu_items: ["none", "byx", "byy", "byz", "rev", "seed", "shif", "prox", "vector", "expression", "spatial", "attribute"], menu_labels: ["No change", "By X", "By Y", "By Z", "Reverse", "Random", "Shift", "Proximity to Point", "Along Vector", "By Expression", "Spatial Locality", "By Attribute"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ primsort != shif }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ primsort != vector }");
			hou_parm_template2.setTags({"opfilter": "!!OBJ!!", "oprelative": "."});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ primsort != attribute }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "primreverse", label: "Reverse Primitive Sort", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "vertexprimorder", label: "Optimize Internal Vertex Order", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/sort',_hnt_SOP_sort)
    return _hnt_SOP_sort
}
