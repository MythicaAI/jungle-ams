...
export default function (hou) {
    class _hnt_CHOP_invert extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/invert';
        static category = '/CHOP';
        static houdiniType = 'invert';
        static title = 'Invert';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_invert.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Constraints/invert',_hnt_CHOP_invert)
    return _hnt_CHOP_invert
}
