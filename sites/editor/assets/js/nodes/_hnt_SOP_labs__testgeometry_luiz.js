...
export default function (hou) {
    class _hnt_SOP_labs__testgeometry_luiz extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Geometry/Mesh/Create/labs::testgeometry_luiz';
        static category = '/SOP/labs';
        static houdiniType = 'labs::testgeometry_luiz';
    ...
    hou.registerType('SOP/Labs/Geometry/Mesh/Create/labs::testgeometry_luiz',_hnt_SOP_labs__testgeometry_luiz)
    return _hnt_SOP_labs__testgeometry_luiz
}
