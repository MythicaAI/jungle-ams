...
export default function (hou) {
    class _hnt_DOP_fetchdata extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/fetchdata';
        static category = '/DOP';
        static houdiniType = 'fetchdata';
        static title = 'Fetch Data';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_fetchdata.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/fetchdata',_hnt_DOP_fetchdata)
    return _hnt_DOP_fetchdata
}
