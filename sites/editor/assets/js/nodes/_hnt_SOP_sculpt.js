...
export default function (hou) {
    class _hnt_SOP_sculpt extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/sculpt';
        static category = '/SOP';
        static houdiniType = 'sculpt';
        static title = 'Sculpt';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_sculpt.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "axis", label: "Axis", menu_items: ["xaxis", "yaxis", "zaxis", "normal", "userdef"], menu_labels: ["X", "Y", "Z", "Normal", "User Defined:"], default_value: 3, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "vector", label: "Vector", num_components: 3, default_value: [0, 0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "resetnormal", label: "Update Displacement Normals"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "flood", label: "Apply To All"});
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation for All", menu_items: ["deform", "smooth", "smoothdeform", "erase"], menu_labels: ["Deform Points", "Smooth Points", "Deform and Smooth", "Erase Changes"], default_value: 2, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "clearall", label: "Reset All Changes"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "color", label: "", menu_items: ["off", "on"], menu_labels: ["off", "on"], default_value: 1, default_expression: "LMB Displacement", default_expression_language: hou.scriptLanguage.Hscript, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "fd", label: "FD", num_components: 1, default_value: [0.1], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "bd", label: "BD", num_components: 1, default_value: [null], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Other/sculpt',_hnt_SOP_sculpt)
    return _hnt_SOP_sculpt
}
