...
export default function (hou) {
    class _hnt_VOP_integrate3d extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/integrate3d';
        static category = '/VOP';
        static houdiniType = 'integrate3d';
        static title = 'Integrate 3D';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_integrate3d.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/integrate3d',_hnt_VOP_integrate3d)
    return _hnt_VOP_integrate3d
}
