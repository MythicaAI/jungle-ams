...
export default function (hou) {
    class _hnt_VOP_gradient3d extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/gradient3d';
        static category = '/VOP';
        static houdiniType = 'gradient3d';
        static title = 'Gradient 3D';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_gradient3d.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "pos", label: "Position", num_components: 3, default_value: [0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/gradient3d',_hnt_VOP_gradient3d)
    return _hnt_VOP_gradient3d
}
