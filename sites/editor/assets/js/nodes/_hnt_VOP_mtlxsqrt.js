...
export default function (hou) {
    class _hnt_VOP_mtlxsqrt extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxsqrt';
        static category = '/VOP';
        static houdiniType = 'mtlxsqrt';
        static title = 'MtlX Sqrt';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxsqrt.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxsqrt',_hnt_VOP_mtlxsqrt)
    return _hnt_VOP_mtlxsqrt
}
