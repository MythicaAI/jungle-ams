...
export default function (hou) {
    class _hnt_COP2_average extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/average';
        static category = '/COP2';
        static houdiniType = 'average';
        static title = 'Average';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_average.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Average", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/average',_hnt_COP2_average)
    return _hnt_COP2_average
}
