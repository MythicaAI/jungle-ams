...
export default function (hou) {
    class _hnt_SOP_attribswap extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/attribswap';
        static category = '/SOP';
        static houdiniType = 'attribswap';
        static title = 'Attribute Swap';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_attribswap.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "numswaps", label: "Number of Swaps", folder_type: hou.folderType.MultiparmBlock, default_value: 1, ends_tab_group: false});
    ...
    hou.registerType('SOP/Other/attribswap',_hnt_SOP_attribswap)
    return _hnt_SOP_attribswap
}
