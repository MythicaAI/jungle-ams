...
export default function (hou) {
    class _hnt_OBJECT_labs__impostor_camera_rig extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Labs/Rendering/Camera/labs::impostor_camera_rig';
        static category = '/OBJECT/labs';
        static houdiniType = 'labs::impostor_camera_rig';
        static title = 'Labs Impostor Camera Rig';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_labs__impostor_camera_rig.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "impostor_rop", label: "Impostor ROP", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setTags({"oprelative": "."});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher3", label: "Transform", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "impostor_rop_full_path", label: "Impostor ROP Full Path", num_components: 1, default_value: ["opfullpath(chs(\"impostor_rop\"))"], default_expression: ["opfullpath(chs(\"impostor_rop\"))"], default_expression_language: [hou.scriptLanguage.Hscript], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.hide(true);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('OBJECT/Labs/Rendering/Camera/labs::impostor_camera_rig',_hnt_OBJECT_labs__impostor_camera_rig)
    return _hnt_OBJECT_labs__impostor_camera_rig
}
