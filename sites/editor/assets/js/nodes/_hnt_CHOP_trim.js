...
export default function (hou) {
    class _hnt_CHOP_trim extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/trim';
        static category = '/CHOP';
        static houdiniType = 'trim';
        static title = 'Trim';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_trim.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Trim", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "relative", label: "Unit Values", menu_items: ["abs", "rel", "cur", "slice"], menu_labels: ["Absolute", "Relative to Start/End", "Relative to Current Frame", "Current Time Slice"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "discard", label: "Discard", menu_items: ["trimExt", "trimInt"], menu_labels: ["Exterior", "Interior"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/trim',_hnt_CHOP_trim)
    return _hnt_CHOP_trim
}
