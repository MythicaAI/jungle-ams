...
export default function (hou) {
    class _hnt_DOP_volumecollider extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/volumecollider';
        static category = '/DOP';
        static houdiniType = 'volumecollider';
        static title = 'Volume/Volume Collider';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_volumecollider.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/volumecollider',_hnt_DOP_volumecollider)
    return _hnt_DOP_volumecollider
}
