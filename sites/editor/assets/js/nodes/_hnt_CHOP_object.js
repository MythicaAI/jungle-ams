...
export default function (hou) {
    class _hnt_CHOP_object extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/object';
        static category = '/CHOP';
        static houdiniType = 'object';
        static title = 'Object';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_object.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Object", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "targetpath", label: "Target Object", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template2.setTags({"opfilter": "!!OBJ!!", "oprelative": "."});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "usereflength", label: "Use Reference Bone Length", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "compute", label: "Compute", menu_items: ["translate", "rotate", "bearing", "singlebear", "distance", "invsqr", "transrot", "fullxform"], menu_labels: ["Position", "Rotation", "Bearing", "Single Bearing Angle", "Distance", "Inverse Square Distance", "Position and Rotation", "Full Transform"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "bearingref", label: "Bearing Reference", menu_items: ["x", "y", "z", "vector"], menu_labels: ["X Axis", "Y Axis", "Z Axis", "Bearing Vector"], default_value: 2, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "bearing", label: "Bearing Vector", num_components: 3, default_value: [0, 0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "tscope", label: "Point scope (XYZ)", num_components: 3, default_value: ["tx", "ty", "tz"], naming_scheme: hou.parmNamingScheme.XYZW, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2 = new hou.MenuParmTemplate({name: "nameformat", label: "Channel Names", menu_items: ["channel", "target", "reference"], menu_labels: ["Channel Name", "Target and Channel Names", "Reference and Channel Names"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "samplerate", label: "Sample Rate", num_components: 1, default_value: [24], min: 0, max: 100, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "range", label: "Channel Range", menu_items: ["full", "frame", "user"], menu_labels: ["Use Full Animation Range", "Use Current Frame", "Use Start/End"], default_value: 2, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/object',_hnt_CHOP_object)
    return _hnt_CHOP_object
}
