...
export default function (hou) {
    class _hnt_DOP_femtargetconstraint extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Other/femtargetconstraint';
        static category = '/DOP';
        static houdiniType = 'femtargetconstraint';
        static title = 'FEM Target Constraint';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_femtargetconstraint.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "type", label: "Type", menu_items: ["0", "1"], menu_labels: ["Hard", "Soft"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
    ...
    hou.registerType('DOP/Other/femtargetconstraint',_hnt_DOP_femtargetconstraint)
    return _hnt_DOP_femtargetconstraint
}
