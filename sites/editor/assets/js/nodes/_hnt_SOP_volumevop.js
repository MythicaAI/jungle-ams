...
export default function (hou) {
    class _hnt_SOP_volumevop extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Other/volumevop';
        static category = '/SOP';
        static houdiniType = 'volumevop';
        static title = 'Volume VOP';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_volumevop.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/volumevop',_hnt_SOP_volumevop)
    return _hnt_SOP_volumevop
}
