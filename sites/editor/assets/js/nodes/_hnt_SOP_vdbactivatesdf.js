...
export default function (hou) {
    class _hnt_SOP_vdbactivatesdf extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/vdbactivatesdf';
        static category = '/SOP';
        static houdiniType = 'vdbactivatesdf';
        static title = 'VDB Activate SDF';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_vdbactivatesdf.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/vdbactivatesdf',_hnt_SOP_vdbactivatesdf)
    return _hnt_SOP_vdbactivatesdf
}
