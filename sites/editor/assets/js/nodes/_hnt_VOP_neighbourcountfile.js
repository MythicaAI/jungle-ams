...
export default function (hou) {
    class _hnt_VOP_neighbourcountfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/neighbourcountfile';
        static category = '/VOP';
        static houdiniType = 'neighbourcountfile';
    ...
    hou.registerType('VOP/Other/neighbourcountfile',_hnt_VOP_neighbourcountfile)
    return _hnt_VOP_neighbourcountfile
}
