...
export default function (hou) {
    class _hnt_SOP_timeblend__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Animation/timeblend::2.0';
        static category = '/SOP';
        static houdiniType = 'timeblend::2.0';
        static title = 'Time Blend';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_timeblend__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "voxelblend", label: "Voxel Blend", menu_items: ["none", "bygridindex"], menu_labels: ["None", "By Grid Index"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "doslerp", label: "Smoothly Interpolate Normals, Quaternions, and Transforms", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "usevforpinterp", label: "Use Velocity When Interpolating Position", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Animation/timeblend::2.0',_hnt_SOP_timeblend__2_0)
    return _hnt_SOP_timeblend__2_0
}
