...
export default function (hou) {
    class _hnt_SOP_labs__av_meshing__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_meshing::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_meshing::3.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "estimateSpaceFromSfM", label: "Estimate Space From SfM", default_value: true});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.IntParmTemplate({name: "estimateSpaceMinObservationAngle", label: "Min Observations Angle For SfM Space Estimation", num_components: 1, default_value: [10], min: 0, max: 120, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template3.setHelp("Minimum angle between two observations for SfM space estimation");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_meshing::3.0',_hnt_SOP_labs__av_meshing__3_0)
    return _hnt_SOP_labs__av_meshing__3_0
}
