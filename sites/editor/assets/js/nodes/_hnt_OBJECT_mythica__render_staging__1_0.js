...
export default function (hou) {
    class _hnt_OBJECT_mythica__render_staging__1_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Digital Assets/mythica::render_staging::1.0';
        static category = '/OBJECT/mythica';
        static houdiniType = 'mythica::render_staging::1.0';
        static title = 'render_staging';
        static icon = 'None';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "resx", label: "Resolution X", num_components: 1, default_value: [512], min: 8, max: 4096, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "resy", label: "Resolution Y", num_components: 1, default_value: [512], min: 8, max: 4096, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "camera_node", label: "Camera Node", num_components: 1, default_value: ["./render_camera"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"autoscope": "0000000000000000", "autoselect": "0000000000000000", "oprelative": ".", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('OBJECT/Digital Assets/mythica::render_staging::1.0',_hnt_OBJECT_mythica__render_staging__1_0)
    return _hnt_OBJECT_mythica__render_staging__1_0
}
