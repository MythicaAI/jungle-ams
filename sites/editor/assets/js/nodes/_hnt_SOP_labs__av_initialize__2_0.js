...
export default function (hou) {
    class _hnt_SOP_labs__av_initialize__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_initialize::2.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_initialize::2.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "alice_dir", label: "Alice Vision Directory", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Directory, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template_group.append(hou_parm_template);
			...
			let hou_parm_template2 = new hou.ButtonParmTemplate({name: "add_img", label: "Add Images"});
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_initialize::2.0',_hnt_SOP_labs__av_initialize__2_0)
    return _hnt_SOP_labs__av_initialize__2_0
}
