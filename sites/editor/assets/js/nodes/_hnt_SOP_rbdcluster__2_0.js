...
export default function (hou) {
    class _hnt_SOP_rbdcluster__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Dynamics/RBD/rbdcluster::2.0';
        static category = '/SOP';
        static houdiniType = 'rbdcluster::2.0';
        static title = 'RBD Cluster';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_rbdcluster__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "group", label: "Group", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "# If the constraint input isn\'t being used, allow selecting from the extract\n# centroid points.\nnode = hou.pwd().node(\"CLUSTER_GROUP\")\nreturn node.generateInputGroupMenu(0, hou.geometryType.Points, include_selection=False, parm=kwargs[\'parm\'])", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			...
			hou_parm_template = new hou.MenuParmTemplate({name: "clustertype", label: "Cluster Type", menu_items: ["combinepieces", "groupconstraints"], menu_labels: ["Combine Pieces", "Group Constraints"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Dynamics/RBD/rbdcluster::2.0',_hnt_SOP_rbdcluster__2_0)
    return _hnt_SOP_rbdcluster__2_0
}
