...
export default function (hou) {
    class _hnt_OBJECT_alembicarchive extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/File IO/Import/alembicarchive';
        static category = '/OBJECT';
        static houdiniType = 'alembicarchive';
        static title = 'Alembic Archive';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_alembicarchive.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher3_2", label: "Alembic Loading Parameters", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "buildHierarchy", label: "Build or Update Hierarchy"});
			hou_parm_template2.setScriptCallback("kwargs['node'].hdaModule().BuildHierarchyRoot(kwargs['node'])");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"export_disable": "1", "script_callback": "kwargs['node'].hdaModule().BuildHierarchyRoot(kwargs['node'])", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "buildSubnet", label: "Build Hierarchy Using Subnetworks", default_value: true});
			hou_parm_template2.setHelp("If turned off, object inheritance will be used instead of subnetworks.  This can result in better performance in some cases, though it may result in very large networks for large scenes.");
			hou_parm_template2.setTags({"export_disable": "1"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "channelRef", label: "Build Hierarchy With Channel References", default_value: false});
			hou_parm_template2.setHelp("If enabled, child objects will have channel references to the main archive.");
			hou_parm_template2.setTags({"export_disable": "1"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "buildSingleGeoNode", label: "Load Hierarchy As One Single Geometry Node", default_value: false});
			hou_parm_template2.setHelp("If enabled, the hierarchical geometries from an Alembic scene archive will be loaded as a single geometry node. However, the hierarchy for the camera will be preserved.");
			hou_parm_template2.setTags({"export_disable": "1"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "flattenVisibility", label: "Flatten Visibilty Evaluation", default_value: true});
			hou_parm_template2.setHelp("For correct visibility computations, Houdini needs to evaluate visibility in the innermost geometry nodes since children of a subnet inherit visibility (which isn't always true in Alembic).  You should turn this off if you need to export Alembic maintaining the original visibility.");
			hou_parm_template2.setTags({"export_disable": "1"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "pushChannels", label: "Push Parameters to Children"});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ channelRef == on }");
			hou_parm_template2.setScriptCallback("kwargs['node'].hdaModule().PushParametersToChildren(kwargs['node'])");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"export_disable": "1", "script_callback": "kwargs['node'].hdaModule().PushParametersToChildren(kwargs['node'])", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "reloadGeometry", label: "Reload Geometry"});
			hou_parm_template2.setScriptCallback("kwargs['node'].hdaModule().ReloadGeometry(kwargs['node'])");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"export_disable": "1", "script_callback": "kwargs['node'].hdaModule().ReloadGeometry(kwargs['node'])", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "numlayers", label: "Number of Layers", folder_type: hou.folderType.MultiparmBlock, default_value: 0, ends_tab_group: false});
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "enablelayer#", label: "enablelayer#", default_value: true});
			hou_parm_template2.hideLabel(true);
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "layer#", label: "Layer #", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ enablelayer# == off }");
			hou_parm_template2.setTags({"filechooser_mode": "read", "filechooser_pattern": "*.abc"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "fileName", label: "File Name", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "fps", label: "Frames per Second", num_components: 1, default_value: [0], default_expression: ["$FPS"], default_expression_language: [hou.scriptLanguage.Hscript], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "loadmode", label: "Load As", menu_items: ["alembic", "houdini", "hpoints", "hboxes"], menu_labels: ["Alembic Delayed Load Primitives", "Load Houdini Geometry", "Houdini Point Cloud", "Houdini Boxes"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "loadUserProps", label: "User Properties", menu_items: ["none", "data", "both"], menu_labels: ["Do Not Load", "Load Values Only", "Load Values and Metadata"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "remapAttributes", label: "Remap Attributes", folder_type: hou.folderType.MultiparmBlock, default_value: 0, ends_tab_group: false});
			hou_parm_template2 = new hou.StringParmTemplate({name: "abcName#", label: "Alembic Name #", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "hName#", label: "Houdini Name #", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('OBJECT/File IO/Import/alembicarchive',_hnt_OBJECT_alembicarchive)
    return _hnt_OBJECT_alembicarchive
}
