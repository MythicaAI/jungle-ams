...
export default function (hou) {
    class _hnt_VOP_mtlxabsval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxabsval';
        static category = '/VOP';
        static houdiniType = 'mtlxabsval';
        static title = 'MtlX Absval';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxabsval.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxabsval',_hnt_VOP_mtlxabsval)
    return _hnt_VOP_mtlxabsval
}
