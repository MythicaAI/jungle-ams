...
export default function (hou) {
    class _hnt_DRIVER_rib extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Other/rib';
        static category = '/DRIVER';
        static houdiniType = 'rib';
        static title = 'RenderMan';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_rib.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/rib',_hnt_DRIVER_rib)
    return _hnt_DRIVER_rib
}
