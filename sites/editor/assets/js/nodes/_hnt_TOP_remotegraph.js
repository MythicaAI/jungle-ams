...
export default function (hou) {
    class _hnt_TOP_remotegraph extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'TOP/Other/remotegraph';
        static category = '/TOP';
        static houdiniType = 'remotegraph';
        static title = 'Remote Graph';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_remotegraph.svg';
        constructor() {
            super();
    ...
    hou.registerType('TOP/Other/remotegraph',_hnt_TOP_remotegraph)
    return _hnt_TOP_remotegraph
}
