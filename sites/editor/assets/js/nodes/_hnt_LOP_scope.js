...
export default function (hou) {
    class _hnt_LOP_scope extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Primitive/scope';
        static category = '/LOP';
        static houdiniType = 'scope';
        static title = 'Scope';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_scope.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "primtype", label: "Primitive Type", num_components: 1, default_value: ["UsdGeomScope"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createSchemaTypesMenu(True)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('LOP/Primitive/scope',_hnt_LOP_scope)
    return _hnt_LOP_scope
}
