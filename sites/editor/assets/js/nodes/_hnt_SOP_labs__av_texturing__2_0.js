...
export default function (hou) {
    class _hnt_SOP_labs__av_texturing__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_texturing::2.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_texturing::2.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template3 = new hou.IntParmTemplate({name: "maxImg", label: "Max Num of Images for Fusion", num_components: 1, default_value: [3], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template3.setHelp("Max number of images to combine to create final texture.");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_texturing::2.0',_hnt_SOP_labs__av_texturing__2_0)
    return _hnt_SOP_labs__av_texturing__2_0
}
