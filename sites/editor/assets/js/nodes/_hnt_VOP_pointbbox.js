...
export default function (hou) {
    class _hnt_VOP_pointbbox extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pointbbox';
        static category = '/VOP';
        static houdiniType = 'pointbbox';
        static title = 'Point Bounding Box';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/pointbbox',_hnt_VOP_pointbbox)
    return _hnt_VOP_pointbbox
}
