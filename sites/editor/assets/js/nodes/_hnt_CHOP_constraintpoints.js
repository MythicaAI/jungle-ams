...
export default function (hou) {
    class _hnt_CHOP_constraintpoints extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintpoints';
        static category = '/CHOP';
        static houdiniType = 'constraintpoints';
        static title = 'Points';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintpoints.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Constraint Points", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "mode", label: "Mode", menu_items: ["0", "1"], menu_labels: ["Point Group", "Primitive Group"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"script_action": "import objecttoolutils\nobjecttoolutils.constraintpointsSelect(kwargs['node'])\n", "script_action_icon": "BUTTONS_reselect"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "weights", label: "Weights", num_components: 3, default_value: [0, 0, 0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ hasinput(3) == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ hasinput(3) == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "lookatmode", label: "Look At Mode", menu_items: ["0", "1", "2", "3"], menu_labels: ["None", "Direction Attribute from Points", "Direction Vector from P0 to P1", "Normal Vector of P0,P1,P2 Plane"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ hasinput(1) == 1 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "lookupmode", label: "Look Up Mode", menu_items: ["0", "1", "2", "3"], menu_labels: ["Up Vector", "Up Vector Attribute from Points", "Direction Vector from P0 to P1", "Normal Vector of P0,P1,P2 Plane"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
    ...
    hou.registerType('CHOP/Constraints/constraintpoints',_hnt_CHOP_constraintpoints)
    return _hnt_CHOP_constraintpoints
}
