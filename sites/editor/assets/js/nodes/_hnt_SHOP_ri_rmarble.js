...
export default function (hou) {
    class _hnt_SHOP_ri_rmarble extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/ri_rmarble';
        static category = '/SHOP';
        static houdiniType = 'ri_rmarble';
        static title = 'RSL Red Marble';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_ri_rmarble.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/ri_rmarble',_hnt_SHOP_ri_rmarble)
    return _hnt_SHOP_ri_rmarble
}
