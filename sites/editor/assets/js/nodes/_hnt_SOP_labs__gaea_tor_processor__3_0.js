...
export default function (hou) {
    class _hnt_SOP_labs__gaea_tor_processor__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Pipeline/Integration/Gaea/labs::gaea_tor_processor::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::gaea_tor_processor::3.0';
        static title = 'Labs Gaea Tor Processor';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__gaea_tor_processor__3_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "bCustomExport", label: "Custom", default_value: false});
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "sFilePath", label: "Export Path", num_components: 1, default_value: ["$HIP/render/${HIPNAME}_$(EXTRADATA)_$(CHANNEL).tif"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Image, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ bCustomExport == 0 }");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Labs/Pipeline/Integration/Gaea/labs::gaea_tor_processor::3.0',_hnt_SOP_labs__gaea_tor_processor__3_0)
    return _hnt_SOP_labs__gaea_tor_processor__3_0
}
