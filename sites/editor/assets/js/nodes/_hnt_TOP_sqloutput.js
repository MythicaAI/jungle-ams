...
export default function (hou) {
    class _hnt_TOP_sqloutput extends hou._HoudiniBase {
        static is_root = false;
        static id = 'TOP/Data/sqloutput';
        static category = '/TOP';
        static houdiniType = 'sqloutput';
        static title = 'SQL Output';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_sqloutput.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0", label: "Output", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "resultdatatag", label: "File Tag", num_components: 1, default_value: ["sql/database"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import pdg\nreturn pdg.resultTagMenu('file')", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "queryparamsfolder", label: "", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template3.setTags({"multistartoffset": "1", "script_callback": "", "script_callback_language": "python"});
			...
			hou_parm_template4 = new hou.StringParmTemplate({name: "datatag#", label: "Data Tag", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.addParmTemplate(hou_parm_template4);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_1", label: "Custom Query", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback": "", "script_callback_language": "python"});
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "overridequeryenabled", label: "Override Query", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "querystring", label: "Query String", num_components: 1, default_value: ["-- This query needs to have as many parameter markers\n-- as there are columns specified in the Output tab."], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('TOP/Data/sqloutput',_hnt_TOP_sqloutput)
    return _hnt_TOP_sqloutput
}
