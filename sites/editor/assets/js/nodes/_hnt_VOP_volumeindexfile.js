...
export default function (hou) {
    class _hnt_VOP_volumeindexfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumeindexfile';
        static category = '/VOP';
        static houdiniType = 'volumeindexfile';
    ...
    hou.registerType('VOP/Other/volumeindexfile',_hnt_VOP_volumeindexfile)
    return _hnt_VOP_volumeindexfile
}
