...
export default function (hou) {
    class _hnt_OBJECT_formationcrowdsexample extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/formationcrowdsexample';
        static category = '/OBJECT';
        static houdiniType = 'formationcrowdsexample';
        static title = 'Formation Crowds Example';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_formationcrowdsexample.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/formationcrowdsexample',_hnt_OBJECT_formationcrowdsexample)
    return _hnt_OBJECT_formationcrowdsexample
}
