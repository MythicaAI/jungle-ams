...
export default function (hou) {
    class _hnt_VOP_mtlxdisplacement extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Pbr/mtlxdisplacement';
        static category = '/VOP';
        static houdiniType = 'mtlxdisplacement';
        static title = 'MtlX Displacement';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxdisplacement.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "displacement_vector3", label: "Displacement", num_components: 3, default_value: [0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.setTags({"sidefx::shader_parmname": "displacement"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Pbr/mtlxdisplacement',_hnt_VOP_mtlxdisplacement)
    return _hnt_VOP_mtlxdisplacement
}
