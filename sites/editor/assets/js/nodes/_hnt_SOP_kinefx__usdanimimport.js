...
export default function (hou) {
    class _hnt_SOP_kinefx__usdanimimport extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/kinefx::usdanimimport';
        static category = '/SOP/kinefx';
        static houdiniType = 'kinefx::usdanimimport';
        static title = 'USD Animation Import';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_kinefx__usdanimimport.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setTags({"opfilter": "!!LOP!!", "oprelative": "."});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "output", label: "Output", menu_items: ["animation", "bind", "rest"], menu_labels: ["Animation", "Bind Pose", "Rest Pose"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != bytime }");
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != bytime } { useanimationstarttime == 0 }");
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ timeshiftmethod != bytime }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != bytime } { useanimationendtime == 0 }");
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ timeshiftmethod != bytime }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != bytime } { useplaybackstarttime == 0 }");
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ timeshiftmethod != bytime }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != byframe }");
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != byframe } { useanimationstartframe == 0 }");
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ timeshiftmethod != byframe }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != byframe } { useanimationendframe == 0 }");
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ timeshiftmethod != byframe }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ output == bind } { timeshiftmethod != byframe } { useplaybackstartframe == 0 }");
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ timeshiftmethod != byframe }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Other/kinefx::usdanimimport',_hnt_SOP_kinefx__usdanimimport)
    return _hnt_SOP_kinefx__usdanimimport
}
