...
export default function (hou) {
    class _hnt_SOP_output extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/output';
        static category = '/SOP';
        static houdiniType = 'output';
        static title = 'Output';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_output.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/output',_hnt_SOP_output)
    return _hnt_SOP_output
}
