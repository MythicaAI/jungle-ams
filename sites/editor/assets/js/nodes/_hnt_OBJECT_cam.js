...
export default function (hou) {
    class _hnt_OBJECT_cam extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/cam';
        static category = '/OBJECT';
        static houdiniType = 'cam';
        static title = 'Camera';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_cam.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/cam',_hnt_OBJECT_cam)
    return _hnt_OBJECT_cam
}
