...
export default function (hou) {
    class _hnt_DOP_gasfieldwrangle extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Micro Solvers/gasfieldwrangle';
        static category = '/DOP';
        static houdiniType = 'gasfieldwrangle';
        static title = 'Gas Field Wrangle';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasfieldwrangle.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.StringParmTemplate({name: "snippet", label: "VEXpression", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import vexpressionmenu\n\nreturn vexpressionmenu.buildSnippetMenu('gasfieldwrangle/snippet')", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			...
			hou_parm_template2 = new hou.StringParmTemplate({name: "exportlist", label: "Fields to Write to", num_components: 1, default_value: ["*"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "usetimestep", label: "Use Timestep", default_value: true, default_expression: "on", default_expression_language: hou.scriptLanguage.Hscript});
    ...
    hou.registerType('DOP/Micro Solvers/gasfieldwrangle',_hnt_DOP_gasfieldwrangle)
    return _hnt_DOP_gasfieldwrangle
}
