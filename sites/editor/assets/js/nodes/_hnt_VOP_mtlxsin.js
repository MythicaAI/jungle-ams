...
export default function (hou) {
    class _hnt_VOP_mtlxsin extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxsin';
        static category = '/VOP';
        static houdiniType = 'mtlxsin';
        static title = 'MtlX Sin';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxsin.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxsin',_hnt_VOP_mtlxsin)
    return _hnt_VOP_mtlxsin
}
