...
export default function (hou) {
    class _hnt_VOP_mtlxtranspose extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxtranspose';
        static category = '/VOP';
        static houdiniType = 'mtlxtranspose';
        static title = 'MtlX Transpose';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxtranspose.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxtranspose',_hnt_VOP_mtlxtranspose)
    return _hnt_VOP_mtlxtranspose
}
