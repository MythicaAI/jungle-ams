...
export default function (hou) {
    class _hnt_COP2_skycube extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/skycube';
        static category = '/COP2';
        static houdiniType = 'skycube';
        static title = 'Sky Cube';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_skycube.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Sky Cube", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "ground_normal", label: "Ground Normal", num_components: 3, default_value: [0, 1, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.RampParmTemplate({name: "sky_ramp", label: "Sky Color", ramp_parm_type: hou.rampParmType.Color, default_value: 3, default_basis: null, color_type: null});
			hou_parm_template2.setTags({"rampbasis_var": "sky_ramp_basis", "rampbasisdefault": "catmull-rom", "rampcolordefault": "1pos ( 0 ) 1interp ( linear ) 1c ( 0.17 0.16 0.66 ) 2pos ( 0.95 ) 2interp ( linear ) 2c ( 0.43 0.72 0.9 ) 3pos ( 1 ) 3interp ( linear ) 3c ( 0.96 0.91 0.23 )", "rampkeys_var": "sky_ramp_keys", "rampvalues_var": "sky_ramp_vals"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "ground_color", label: "Ground Color", num_components: 3, default_value: [0.6, 0.4, 0.3], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.ColorSquare, naming_scheme: hou.parmNamingScheme.RGBA});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/skycube',_hnt_COP2_skycube)
    return _hnt_COP2_skycube
}
