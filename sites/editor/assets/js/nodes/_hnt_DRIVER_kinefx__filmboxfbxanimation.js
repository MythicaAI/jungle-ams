...
export default function (hou) {
    class _hnt_DRIVER_kinefx__filmboxfbxanimation extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Other/kinefx::filmboxfbxanimation';
        static category = '/DRIVER/kinefx';
        static houdiniType = 'kinefx::filmboxfbxanimation';
        static title = 'Filmbox FBX Animation';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_kinefx__filmboxfbxanimation.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/kinefx::filmboxfbxanimation',_hnt_DRIVER_kinefx__filmboxfbxanimation)
    return _hnt_DRIVER_kinefx__filmboxfbxanimation
}
