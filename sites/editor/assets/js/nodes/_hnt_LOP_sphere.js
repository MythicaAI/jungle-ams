...
export default function (hou) {
    class _hnt_LOP_sphere extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Primitive/sphere';
        static category = '/LOP';
        static houdiniType = 'sphere';
        static title = 'Sphere';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_sphere.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "primtype", label: "Primitive Type", num_components: 1, default_value: ["UsdGeomSphere"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createSchemaTypesMenu(True)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "computeextents", label: "Compute Extent Attribute", default_value: false, default_expression: "if(!strcmp(chs(\"radius_control\"), \"none\"), 0, 1)", default_expression_language: hou.scriptLanguage.Hscript});
    ...
    hou.registerType('LOP/Primitive/sphere',_hnt_LOP_sphere)
    return _hnt_LOP_sphere
}
