...
export default function (hou) {
    class _hnt_VOP_mtlxmin extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxmin';
        static category = '/VOP';
        static houdiniType = 'mtlxmin';
        static title = 'MtlX Min';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxmin.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxmin',_hnt_VOP_mtlxmin)
    return _hnt_VOP_mtlxmin
}
