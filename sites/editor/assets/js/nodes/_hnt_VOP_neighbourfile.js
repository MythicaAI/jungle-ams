...
export default function (hou) {
    class _hnt_VOP_neighbourfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/neighbourfile';
        static category = '/VOP';
        static houdiniType = 'neighbourfile';
    ...
    hou.registerType('VOP/Other/neighbourfile',_hnt_VOP_neighbourfile)
    return _hnt_VOP_neighbourfile
}
