...
export default function (hou) {
    class _hnt_VOP_volumepostoindexfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumepostoindexfile';
        static category = '/VOP';
        static houdiniType = 'volumepostoindexfile';
    ...
    hou.registerType('VOP/Other/volumepostoindexfile',_hnt_VOP_volumepostoindexfile)
    return _hnt_VOP_volumepostoindexfile
}
