...
export default function (hou) {
    class _hnt_COP2_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'COP2/Other/dopnet';
        static category = '/COP2';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('COP2/Other/dopnet',_hnt_COP2_dopnet)
    return _hnt_COP2_dopnet
}
