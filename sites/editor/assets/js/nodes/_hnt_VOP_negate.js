...
export default function (hou) {
    class _hnt_VOP_negate extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/negate';
        static category = '/VOP';
        static houdiniType = 'negate';
        static title = 'Negate';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_negate.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/negate',_hnt_VOP_negate)
    return _hnt_VOP_negate
}
