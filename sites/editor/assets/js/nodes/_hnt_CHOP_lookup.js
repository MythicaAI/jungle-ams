...
export default function (hou) {
    class _hnt_CHOP_lookup extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/lookup';
        static category = '/CHOP';
        static houdiniType = 'lookup';
        static title = 'Lookup';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_lookup.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "index", label: "Index Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "chanmatch", label: "Per Index Channel", menu_items: ["onetoone", "onetomany"], menu_labels: ["One Lookup Table Channel", "All Lookup Table Channels"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/lookup',_hnt_CHOP_lookup)
    return _hnt_CHOP_lookup
}
