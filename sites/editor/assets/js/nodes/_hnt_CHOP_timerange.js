...
export default function (hou) {
    class _hnt_CHOP_timerange extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/timerange';
        static category = '/CHOP';
        static houdiniType = 'timerange';
        static title = 'Time Range';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_timerange.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Time Range", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "rate", label: "Sample Rate", num_components: 1, default_value: [24], min: 0, max: 120, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "cachetimerange", label: "Cache Time Range", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "clearcache", label: "Clear Cache"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/timerange',_hnt_CHOP_timerange)
    return _hnt_CHOP_timerange
}
