...
export default function (hou) {
    class _hnt_SOP_labs__random_selection__1_1 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Geometry/Group/labs::random_selection::1.1';
        static category = '/SOP/labs';
        static houdiniType = 'labs::random_selection::1.1';
        static title = 'Labs Random Selection';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__random_selection__1_1.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "basegroup", label: "Group", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "#node.parm(\'biomeprofile\').eval()\n#return kwargs[\'node\'].generateInputGroupMenu(0)\nnode = kwargs[\"node\"]\n#parent = hou.node(\"..\")\n#parent = node.inputNode()\nparent = node.inputs()[0].geometry()\nelemType = node.parm(\"class\").eval()\nif elemType == 0:\n    return parent.generateGroupMenu(hou.geometryType.Primitives, include_selection=False, include_name_attrib=False, case_sensitive=True, pattern=\"*\", decode_tokens=False) \nelse:\n    return parent.generateGroupMenu(hou.geometryType.Points, include_selection=False, include_name_attrib=False, case_sensitive=True, pattern=\"*\", decode_tokens=False) ", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			...
			hou_parm_template = new hou.MenuParmTemplate({name: "class", label: "Elements", menu_items: ["0", "1", "2"], menu_labels: ["Primitives", "Points", "Pieces"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ class != 2 }");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			...
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "intattribfromselected", label: "Integer Attribute from Selected", default_value: false});
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ deleteselected == 1 }");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "attribname", label: "Attribute Name", num_components: 1, default_value: ["selected"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ intattribfromselected == 0 }");
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ deleteselected == 1 }");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/Geometry/Group/labs::random_selection::1.1',_hnt_SOP_labs__random_selection__1_1)
    return _hnt_SOP_labs__random_selection__1_1
}
