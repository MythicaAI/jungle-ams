...
export default function (hou) {
    class _hnt_VOP_mtlxhsvtorgb extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Adjustment/mtlxhsvtorgb';
        static category = '/VOP';
        static houdiniType = 'mtlxhsvtorgb';
        static title = 'MtlX HSV to RGB';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxhsvtorgb.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Adjustment/mtlxhsvtorgb',_hnt_VOP_mtlxhsvtorgb)
    return _hnt_VOP_mtlxhsvtorgb
}
