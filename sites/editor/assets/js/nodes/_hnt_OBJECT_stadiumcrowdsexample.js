...
export default function (hou) {
    class _hnt_OBJECT_stadiumcrowdsexample extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/stadiumcrowdsexample';
        static category = '/OBJECT';
        static houdiniType = 'stadiumcrowdsexample';
        static title = 'Stadium Crowds Example';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_stadiumcrowdsexample.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/stadiumcrowdsexample',_hnt_OBJECT_stadiumcrowdsexample)
    return _hnt_OBJECT_stadiumcrowdsexample
}
