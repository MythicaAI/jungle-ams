...
export default function (hou) {
    class _hnt_DOP_gasnetfieldborderexchange extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasnetfieldborderexchange';
        static category = '/DOP';
        static houdiniType = 'gasnetfieldborderexchange';
        static title = 'Gas Net Field Border Exchange';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasnetfieldborderexchange.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/gasnetfieldborderexchange',_hnt_DOP_gasnetfieldborderexchange)
    return _hnt_DOP_gasnetfieldborderexchange
}
