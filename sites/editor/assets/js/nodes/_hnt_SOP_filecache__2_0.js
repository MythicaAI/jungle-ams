...
export default function (hou) {
    class _hnt_SOP_filecache__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/File IO/filecache::2.0';
        static category = '/SOP';
        static houdiniType = 'filecache::2.0';
        static title = 'File Cache';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_filecache__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"script_callback": ""});
			...
			let hou_parm_template2 = new hou.FolderParmTemplate({name: "folder3", label: "Cache", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder2", label: "Sequence", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_default": "1", "group_type": "collapsible"});
			...
			hou_parm_template2 = new hou.StringParmTemplate({name: "deleteattributes", label: "Delete Attributes", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "r = []\nnode = hou.pwd()\ninputs = node.inputs()\nif inputs and inputs[0]:\n    geo = inputs[0].geometry()\n    if geo:\n        attrs = []        \n        for a in geo.pointAttribs():\n            r.extend([a.name(), a.name()])    \n        for a in geo.vertexAttribs():\n            r.extend([a.name(), a.name()])    \n        for a in geo.primAttribs():\n            r.extend([a.name(), a.name()])    \n        for a in geo.globalAttribs():\n            r.extend([a.name(), a.name()])                 \nreturn r", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "deletegroups", label: "Delete Groups", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "r = []\nnode = hou.pwd()\ninputs = node.inputs()\nif inputs and inputs[0]:\n    geo = inputs[0].geometry()\n    if geo:\n        attrs = []        \n        for g in geo.pointGroups():\n            r.extend([g.name(), g.name()])    \n        for g in geo.vertexGroups():\n            r.extend([g.name(), g.name()])    \n        for g in geo.primGroups():\n            r.extend([g.name(), g.name()])    \n        for g in geo.edgeGroups():\n            r.extend([g.name(), g.name()])                 \nreturn r", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template3 = new hou.StringParmTemplate({name: "class#", label: "Class", num_components: 1, default_value: ["point"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["point", "vertex", "primitive", "detail"], menu_labels: ["Point", "Vertex", "Primitive", "Detail"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "loadfromdiskonsave", label: "Enable Load from Disk on Save", default_value: true});
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "hardenbasename", label: "Harden Base Name on Save", default_value: true});
    ...
    hou.registerType('SOP/File IO/filecache::2.0',_hnt_SOP_filecache__2_0)
    return _hnt_SOP_filecache__2_0
}
