...
export default function (hou) {
    class _hnt_SOP_labs__lot_subdivision__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/World Building/Prop/labs::lot_subdivision::2.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::lot_subdivision::2.0';
        static title = 'Labs Lot Subdivision';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__lot_subdivision__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "min_lot_size", label: "Minimum Lot Size", num_components: 1, default_value: [0.1], min: 0.001, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			...
			hou_parm_template = new hou.FolderParmTemplate({name: "fd_shapesettings", label: "Shape Settings", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template.setTags({"group_type": "simple"});
			hou_parm_template2 = new hou.FloatParmTemplate({name: "irregularity", label: "Irregularity", num_components: 1, default_value: [1], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('SOP/Labs/World Building/Prop/labs::lot_subdivision::2.0',_hnt_SOP_labs__lot_subdivision__2_0)
    return _hnt_SOP_labs__lot_subdivision__2_0
}
