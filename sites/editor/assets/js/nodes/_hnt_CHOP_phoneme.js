...
export default function (hou) {
    class _hnt_CHOP_phoneme extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/phoneme';
        static category = '/CHOP';
        static houdiniType = 'phoneme';
        static title = 'Phoneme';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_phoneme.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Phoneme", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "text", label: "Text", num_components: 1, default_value: ["hello"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "numbers", label: "Numbers", menu_items: ["ignore", "expand"], menu_labels: ["Ignore", "Expand"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "money", label: "Money", menu_items: ["ignore", "expand"], menu_labels: ["Ignore", "Expand"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "punc", label: "Punctuation", menu_items: ["ignore", "expand"], menu_labels: ["Ignore", "Expand"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "calc", label: "Calculate Phonemes"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher_1", label: "Edit", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			hou_parm_template2 = new hou.MenuParmTemplate({name: "phoneme", label: "Phoneme", menu_items: ["sil", "iy", "ih", "ey", "eh", "ae", "aa", "ao", "ow", "uh", "uw", "er", "ax", "ah", "ay", "aw", "oy", "p", "b", "t", "d", "k", "g", "f", "v", "th", "dh", "s", "z", "sh", "zh", "h", "m", "n", "ng", "l", "w", "y", "r", "ch", "j", "wh"], menu_labels: ["sil", "iy", "ih", "ey", "eh", "ae", "aa", "ao", "ow", "uh", "uw", "er", "ax", "ah", "ay", "aw", "oy", "p", "b", "t", "d", "k", "g", "f", "v", "th", "dh", "s", "z", "sh", "zh", "h", "m", "n", "ng", "l", "w", "y", "r", "ch", "j", "wh"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "remove", label: "Remove"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "add", label: "Add"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "replace", label: "Replace"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "relative", label: "Unit Values", menu_items: ["abs", "rel"], menu_labels: ["Absolute", "Relative to Start/End"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/phoneme',_hnt_CHOP_phoneme)
    return _hnt_CHOP_phoneme
}
