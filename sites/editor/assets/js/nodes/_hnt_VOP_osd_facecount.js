...
export default function (hou) {
    class _hnt_VOP_osd_facecount extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/osd_facecount';
        static category = '/VOP';
        static houdiniType = 'osd_facecount';
        static title = 'OpenSubdiv Face Count';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/osd_facecount',_hnt_VOP_osd_facecount)
    return _hnt_VOP_osd_facecount
}
