...
export default function (hou) {
    class _hnt_OBJECT_pxrdisklight extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Render/pxrdisklight';
        static category = '/OBJECT';
        static houdiniType = 'pxrdisklight';
        static title = 'Pxr Disk Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_pxrdisklight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.StringParmTemplate({name: "ri_lighttype", label: "Light Type", num_components: 1, default_value: ["disk"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.hide(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ light_enable == 0 }");
			hou_parm_template3.setHelp("lightColor: The color of the emitted light.");
			...
			hou_parm_template3 = new hou.StringParmTemplate({name: "shop_lightpath", label: "Light Shader", num_components: 1, default_value: ["lightSHOP/light_risnet/pxrdisklight"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('OBJECT/Render/pxrdisklight',_hnt_OBJECT_pxrdisklight)
    return _hnt_OBJECT_pxrdisklight
}
