...
export default function (hou) {
    class _hnt_VOP_kinefx__jointangle extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/KineFX/kinefx::jointangle';
        static category = '/VOP/kinefx';
        static houdiniType = 'kinefx::jointangle';
        static title = 'Joint Angle';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kinefx__jointangle.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/KineFX/kinefx::jointangle',_hnt_VOP_kinefx__jointangle)
    return _hnt_VOP_kinefx__jointangle
}
