...
export default function (hou) {
    class _hnt_DOP_gasfieldtoparticle extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasfieldtoparticle';
        static category = '/DOP';
        static houdiniType = 'gasfieldtoparticle';
        static title = 'Gas Field to Particle';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasfieldtoparticle.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/gasfieldtoparticle',_hnt_DOP_gasfieldtoparticle)
    return _hnt_DOP_gasfieldtoparticle
}
