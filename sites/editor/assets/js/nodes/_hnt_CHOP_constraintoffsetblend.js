...
export default function (hou) {
    class _hnt_CHOP_constraintoffsetblend extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintoffsetblend';
        static category = '/CHOP';
        static houdiniType = 'constraintoffsetblend';
        static title = 'Offset Blend';
        static icon = 'None';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Constraint Offset Blend", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Constraints/constraintoffsetblend',_hnt_CHOP_constraintoffsetblend)
    return _hnt_CHOP_constraintoffsetblend
}
