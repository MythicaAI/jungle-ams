...
export default function (hou) {
    class _hnt_DOP_popvop extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin, hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/popvop';
        static category = '/DOP';
        static houdiniType = 'popvop';
        static title = 'POP VOP';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popvop.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/popvop',_hnt_DOP_popvop)
    return _hnt_DOP_popvop
}
