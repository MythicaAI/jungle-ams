...
export default function (hou) {
    class _hnt_CHOP_vopchop extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin, hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Other/vopchop';
        static category = '/CHOP';
        static houdiniType = 'vopchop';
        static title = 'Channel VOP';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_vopchop.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Compiler", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "vex_name", label: "Channel Name", num_components: 1, default_value: ["chan0"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "vex_iterate", label: "Iterate", menu_items: ["over_all_samples", "over_all_channels", "every_nth_channels", "over_trs", "over_clip", "over_channels", "over_samples"], menu_labels: ["Over Channels and Samples", "Over Samples and Channels", "Over Samples and Every Nth Channels", "Over Samples and Every Translate/Rotate/Scale", "Over Clip", "Over Channels", "Over Sample"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "vex_iterate_step", label: "Iterate step", num_components: 1, default_value: [3], min: 1, max: 9, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "vex_iterate_names", label: "Iterate Names", num_components: 1, default_value: ["px py pz"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/vopchop',_hnt_CHOP_vopchop)
    return _hnt_CHOP_vopchop
}
