...
export default function (hou) {
    class _hnt_VOP_pxrimageplanefilter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrimageplanefilter';
        static category = '/VOP';
        static houdiniType = 'pxrimageplanefilter';
        static title = 'Pxr Image Plane Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrimageplanefilter.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/pxrimageplanefilter',_hnt_VOP_pxrimageplanefilter)
    return _hnt_VOP_pxrimageplanefilter
}
