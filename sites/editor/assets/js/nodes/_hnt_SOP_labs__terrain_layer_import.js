...
export default function (hou) {
    class _hnt_SOP_labs__terrain_layer_import extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Pipeline/Real-Time Engine/labs::terrain_layer_import';
        static category = '/SOP/labs';
        static houdiniType = 'labs::terrain_layer_import';
        static title = 'Labs Terrain Layer Import';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__terrain_layer_import.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Labs/Pipeline/Real-Time Engine/labs::terrain_layer_import',_hnt_SOP_labs__terrain_layer_import)
    return _hnt_SOP_labs__terrain_layer_import
}
