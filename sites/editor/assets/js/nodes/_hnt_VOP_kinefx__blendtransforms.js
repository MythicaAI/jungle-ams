...
export default function (hou) {
    class _hnt_VOP_kinefx__blendtransforms extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/KineFX/kinefx::blendtransforms';
        static category = '/VOP/kinefx';
        static houdiniType = 'kinefx::blendtransforms';
        static title = 'Blend Transforms';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kinefx__blendtransforms.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/KineFX/kinefx::blendtransforms',_hnt_VOP_kinefx__blendtransforms)
    return _hnt_VOP_kinefx__blendtransforms
}
