...
export default function (hou) {
    class _hnt_SOP_labs__edgegroup_to_curve extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Misc/labs::edgegroup_to_curve';
        static category = '/SOP/labs';
        static houdiniType = 'labs::edgegroup_to_curve';
        static title = 'Labs Edge Group To Curve';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__edgegroup_to_curve.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0", label: "Thickness", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template.setTags({"group_type": "simple"});
			let hou_parm_template2 = new hou.ToggleParmTemplate({name: "add_polywire", label: "Enable", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "thickness_mode", label: "Mode", menu_items: ["0", "1"], menu_labels: ["Sweep", "PolyWire"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ add_polywire == 0 }");
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ add_polywire == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "poly_wire_thickness", label: "Thickness", num_components: 1, default_value: [0.1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ add_polywire == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/Misc/labs::edgegroup_to_curve',_hnt_SOP_labs__edgegroup_to_curve)
    return _hnt_SOP_labs__edgegroup_to_curve
}
