...
export default function (hou) {
    class _hnt_SOP_subnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Other/subnet';
        static category = '/SOP';
        static houdiniType = 'subnet';
        static title = 'Subnetwork';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_subnet.svg';
        constructor() {
            super();
            this.flags['houdini_type'] = this.__proto__.constructor.houdiniType;
            
            const inputs = ['SOP', 'SOP', 'SOP', 'SOP'];
            const outputs = ['SOP', 'SOP', 'SOP', 'SOP', 'SOP', 'SOP', 'SOP', 'SOP', 'SOP', 'SOP', 'SOP'];
    ...
    hou.registerType('SOP/Other/subnet',_hnt_SOP_subnet)
    return _hnt_SOP_subnet
}
