...
export default function (hou) {
    class _hnt_SOP_testgeometry_templatehead extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Utility/Test Geometry/testgeometry_templatehead';
        static category = '/SOP';
        static houdiniType = 'testgeometry_templatehead';
        static title = 'Test Geometry: Template Head';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_testgeometry_templatehead.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Utility/Test Geometry/testgeometry_templatehead',_hnt_SOP_testgeometry_templatehead)
    return _hnt_SOP_testgeometry_templatehead
}
