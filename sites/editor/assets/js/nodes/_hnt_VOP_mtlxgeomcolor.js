...
export default function (hou) {
    class _hnt_VOP_mtlxgeomcolor extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Geometric/mtlxgeomcolor';
        static category = '/VOP';
        static houdiniType = 'mtlxgeomcolor';
        static title = 'MtlX Geometry Color';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxgeomcolor.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Geometric/mtlxgeomcolor',_hnt_VOP_mtlxgeomcolor)
    return _hnt_VOP_mtlxgeomcolor
}
