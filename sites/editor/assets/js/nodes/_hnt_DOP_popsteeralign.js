...
export default function (hou) {
    class _hnt_DOP_popsteeralign extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popsteeralign';
        static category = '/DOP';
        static houdiniType = 'popsteeralign';
        static title = 'POP Steer Align';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popsteeralign.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "forcescale", label: "Force Scale", num_components: 1, default_value: [10], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('DOP/POPs/popsteeralign',_hnt_DOP_popsteeralign)
    return _hnt_DOP_popsteeralign
}
