...
export default function (hou) {
    class _hnt_OBJECT_pythonscript extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/pythonscript';
        static category = '/OBJECT';
        static houdiniType = 'pythonscript';
        static title = 'Python Script';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_pythonscript.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Python", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "python", label: "Python Code", num_components: 1, default_value: ["node = hou.pwd()\n\n# Add code to modify contained geometries.\n# Use drop down menu to select examples.\n"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import pythonscriptmenu\n\nreturn pythonscriptmenu.buildSnippetMenu('Object/pythonscript/python')", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setTags({"editor": "1", "editorlang": "python", "editorlines": "25-50"});
    ...
    hou.registerType('OBJECT/Other/pythonscript',_hnt_OBJECT_pythonscript)
    return _hnt_OBJECT_pythonscript
}
