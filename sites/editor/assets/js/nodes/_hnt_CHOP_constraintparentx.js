...
export default function (hou) {
    class _hnt_CHOP_constraintparentx extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintparentx';
        static category = '/CHOP';
        static houdiniType = 'constraintparentx';
        static title = 'Parent';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintparentx.svg';
        constructor() {
            super();
            this.flags['houdini_type'] = this.__proto__.constructor.houdiniType;
            
            const inputs = ['CHOP', 'CHOP', 'CHOP'];
            const outputs = ['CHOP', 'CHOP'];
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "Constraint_Parent", label: "Constraint Parent", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "writemask", label: "Mask", menu_items: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], menu_labels: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], default_value: 8, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "Constraint_Parent_1", label: "Channel", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "vex_range", label: "Range", menu_items: ["full", "frame", "user"], menu_labels: ["Use Full Animation Range", "Use Current Frame", "Use Start/End"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "Constraint_Parent_2", label: "Common", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Constraints/constraintparentx',_hnt_CHOP_constraintparentx)
    return _hnt_CHOP_constraintparentx
}
