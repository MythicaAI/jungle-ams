...
export default function (hou) {
    class _hnt_VOP_rsl_random extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/rsl_random';
        static category = '/VOP';
        static houdiniType = 'rsl_random';
        static title = 'Random Value';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/rsl_random',_hnt_VOP_rsl_random)
    return _hnt_VOP_rsl_random
}
