...
export default function (hou) {
    class _hnt_COP2_bump extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/bump';
        static category = '/COP2';
        static houdiniType = 'bump';
        static title = 'Bump';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_bump.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Bump", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "bump", label: "Bump", menu_items: ["lum", "ntsclum", "max", "min", "average", "r", "g", "b", "c4"], menu_labels: ["Luminance", "NTSC Luminance", "Max Component", "Min Component", "Average", "Red", "Green", "Blue", "Fourth Component"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "simple", label: "Simple Bump Map", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "generate", label: "Generate Bump Plane", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/bump',_hnt_COP2_bump)
    return _hnt_COP2_bump
}
