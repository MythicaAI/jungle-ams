...
export default function (hou) {
    class _hnt_VOP_mtlxtransformvector extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxtransformvector';
        static category = '/VOP';
        static houdiniType = 'mtlxtransformvector';
        static title = 'MtlX Transform Vector';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxtransformvector.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxtransformvector',_hnt_VOP_mtlxtransformvector)
    return _hnt_VOP_mtlxtransformvector
}
