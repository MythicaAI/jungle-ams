...
export default function (hou) {
    class _hnt_DOP_sopsolver extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin, hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/sopsolver';
        static category = '/DOP';
        static houdiniType = 'sopsolver';
        static title = 'SOP Solver';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_sopsolver.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.ToggleParmTemplate({name: "usesoppath", label: "Use External SOP", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setTags({"sidefx::look": "icon"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "solveinitframe", label: "Solve Objects on Creation Frame", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/sopsolver',_hnt_DOP_sopsolver)
    return _hnt_DOP_sopsolver
}
