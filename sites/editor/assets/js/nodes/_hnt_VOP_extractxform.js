...
export default function (hou) {
    class _hnt_VOP_extractxform extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/extractxform';
        static category = '/VOP';
        static houdiniType = 'extractxform';
        static title = 'Extract Transform';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_extractxform.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "extract", label: "Extract", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: ["t", "r", "s"], menu_labels: ["Translation", "Rotation", "Scale"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/extractxform',_hnt_VOP_extractxform)
    return _hnt_VOP_extractxform
}
