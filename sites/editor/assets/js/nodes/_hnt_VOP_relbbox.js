...
export default function (hou) {
    class _hnt_VOP_relbbox extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/relbbox';
        static category = '/VOP';
        static houdiniType = 'relbbox';
        static title = 'Relative to Bounding Box';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_relbbox.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/relbbox',_hnt_VOP_relbbox)
    return _hnt_VOP_relbbox
}
