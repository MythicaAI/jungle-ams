...
export default function (hou) {
    class _hnt_COP2_xor extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/xor';
        static category = '/COP2';
        static houdiniType = 'xor';
        static title = 'Xor';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_xor.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Xor", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/xor',_hnt_COP2_xor)
    return _hnt_COP2_xor
}
