...
export default function (hou) {
    class _hnt_VOP_kinefx__getfullbodycom extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/KineFX/kinefx::getfullbodycom';
        static category = '/VOP/kinefx';
        static houdiniType = 'kinefx::getfullbodycom';
        static title = 'Get Full Body COM';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kinefx__getfullbodycom.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/KineFX/kinefx::getfullbodycom',_hnt_VOP_kinefx__getfullbodycom)
    return _hnt_VOP_kinefx__getfullbodycom
}
