...
export default function (hou) {
    class _hnt_SOP_Object_riggedmuscle__musclestrokebuilder extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Other/Object/riggedmuscle::musclestrokebuilder';
        static category = '/SOP';
        static houdiniType = 'Object/riggedmuscle::musclestrokebuilder';
        static title = 'Muscle Stroke Builder';
        static icon = 'None';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"autoscope": "0000000000000000", "script_callback": "import muscletoolutils;muscletoolutils.exportStrokeToMuscle(hou.pwd(), exit_stroke_state=False)", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.RampParmTemplate({name: "strokeprofile", label: "Stroke Profile", ramp_parm_type: hou.rampParmType.Float, default_value: 3, default_basis: null, color_type: null});
			hou_parm_template.setScriptCallback("import muscletoolutils;muscletoolutils.exportStrokeToMuscle(hou.pwd(), exit_stroke_state=False)");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"rampfloatdefault": "1pos ( 0 ) 1value ( 0 ) 1interp ( catmull-rom ) 2pos ( 0.43224930763244629 ) 2value ( 1 ) 2interp ( catmull-rom ) 3pos ( 1 ) 3value ( 0 ) 3interp ( catmull-rom )", "script_callback": "import muscletoolutils;muscletoolutils.exportStrokeToMuscle(hou.pwd(), exit_stroke_state=False)", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/Object/riggedmuscle::musclestrokebuilder',_hnt_SOP_Object_riggedmuscle__musclestrokebuilder)
    return _hnt_SOP_Object_riggedmuscle__musclestrokebuilder
}
