...
export default function (hou) {
    class _hnt_DRIVER_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'DRIVER/Other/objnet';
        static category = '/DRIVER';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/objnet',_hnt_DRIVER_objnet)
    return _hnt_DRIVER_objnet
}
