...
export default function (hou) {
    class _hnt_SOP_vdbrenormalizesdf extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/vdbrenormalizesdf';
        static category = '/SOP';
        static houdiniType = 'vdbrenormalizesdf';
        static title = 'VDB Renormalize SDF';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_vdbrenormalizesdf.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/vdbrenormalizesdf',_hnt_SOP_vdbrenormalizesdf)
    return _hnt_SOP_vdbrenormalizesdf
}
