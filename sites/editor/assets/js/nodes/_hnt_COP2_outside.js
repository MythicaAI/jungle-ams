...
export default function (hou) {
    class _hnt_COP2_outside extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/outside';
        static category = '/COP2';
        static houdiniType = 'outside';
        static title = 'Outside';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_outside.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Outside", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/outside',_hnt_COP2_outside)
    return _hnt_COP2_outside
}
