...
export default function (hou) {
    class _hnt_VOP_kma_hextiled_triplanar extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Houdini/kma_hextiled_triplanar';
        static category = '/VOP';
        static houdiniType = 'kma_hextiled_triplanar';
        static title = 'Karma Hex-Tiled Triplanar';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kma_hextiled_triplanar.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "blend", label: "Triplanar Blend", num_components: 1, default_value: [0.02], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "position", label: "Position", num_components: 3, default_value: [0, 0, 0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Vector, naming_scheme: hou.parmNamingScheme.XYZW});
    ...
    hou.registerType('VOP/MaterialX/Houdini/kma_hextiled_triplanar',_hnt_VOP_kma_hextiled_triplanar)
    return _hnt_VOP_kma_hextiled_triplanar
}
