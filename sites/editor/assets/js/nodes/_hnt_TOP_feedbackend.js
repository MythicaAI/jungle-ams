...
export default function (hou) {
    class _hnt_TOP_feedbackend extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'TOP/Utility/feedbackend';
        static category = '/TOP';
        static houdiniType = 'feedbackend';
        static title = 'Block End Feedback ';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_feedbackend.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "pdg_feedbackbegin", label: "Begin Block Path", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('TOP/Utility/feedbackend',_hnt_TOP_feedbackend)
    return _hnt_TOP_feedbackend
}
