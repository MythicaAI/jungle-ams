...
export default function (hou) {
    class _hnt_SOP_labs__av_photogrammetry__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_photogrammetry::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_photogrammetry::3.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "useUDIM", label: "Use UDIM UVs", default_value: true, default_expression: "on", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_photogrammetry::3.0',_hnt_SOP_labs__av_photogrammetry__3_0)
    return _hnt_SOP_labs__av_photogrammetry__3_0
}
