...
export default function (hou) {
    class _hnt_SOP_comb extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/comb';
        static category = '/SOP';
        static houdiniType = 'comb';
        static title = 'Comb';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_comb.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "lift", label: "Comb Lift", num_components: 1, default_value: [0], min: null, max: 1, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "preservenml", label: "Keep Normal Length", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "ovrnml", label: "Override Normal", default_value: false});
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "nmlname", label: "Normal Name", num_components: 1, default_value: ["N"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.hideLabel(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "clearall", label: "Reset All Changes"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation for All", menu_items: ["comb", "smoothnml", "erase", "lift", "rotate"], menu_labels: ["Comb Normals", "Smooth Normals", "Erase Changes", "Lift Normals", "Rotate Normals"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/comb',_hnt_SOP_comb)
    return _hnt_SOP_comb
}
