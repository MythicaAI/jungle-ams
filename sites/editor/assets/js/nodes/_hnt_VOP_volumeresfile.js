...
export default function (hou) {
    class _hnt_VOP_volumeresfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumeresfile';
        static category = '/VOP';
        static houdiniType = 'volumeresfile';
    ...
    hou.registerType('VOP/Other/volumeresfile',_hnt_VOP_volumeresfile)
    return _hnt_VOP_volumeresfile
}
