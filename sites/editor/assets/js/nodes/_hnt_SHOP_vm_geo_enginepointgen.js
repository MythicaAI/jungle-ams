...
export default function (hou) {
    class _hnt_SHOP_vm_geo_enginepointgen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/vm_geo_enginepointgen';
        static category = '/SHOP';
        static houdiniType = 'vm_geo_enginepointgen';
        static title = 'Houdini Engine: Point Generation';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vm_geo_enginepointgen.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vm_geo_enginepointgen',_hnt_SHOP_vm_geo_enginepointgen)
    return _hnt_SHOP_vm_geo_enginepointgen
}
