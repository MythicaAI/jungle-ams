...
export default function (hou) {
    class _hnt_COP2_screen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/screen';
        static category = '/COP2';
        static houdiniType = 'screen';
        static title = 'Screen';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_screen.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Screen", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/screen',_hnt_COP2_screen)
    return _hnt_COP2_screen
}
