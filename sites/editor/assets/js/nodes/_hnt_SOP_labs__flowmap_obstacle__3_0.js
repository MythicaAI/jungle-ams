...
export default function (hou) {
    class _hnt_SOP_labs__flowmap_obstacle__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/FX/Fluid/labs::flowmap_obstacle::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::flowmap_obstacle::3.0';
        static title = 'Labs Flowmap Obstacle';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__flowmap_obstacle__3_0.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Labs/FX/Fluid/labs::flowmap_obstacle::3.0',_hnt_SOP_labs__flowmap_obstacle__3_0)
    return _hnt_SOP_labs__flowmap_obstacle__3_0
}
