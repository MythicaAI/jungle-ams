...
export default function (hou) {
    class _hnt_OBJECT_pxrrectlight extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Render/pxrrectlight';
        static category = '/OBJECT';
        static houdiniType = 'pxrrectlight';
        static title = 'Pxr Rect Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_pxrrectlight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.StringParmTemplate({name: "ri_lighttype", label: "Light Type", num_components: 1, default_value: ["rect"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.hide(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "light_enable", label: "Enable", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "ogl_lightenable", label: "Enable in Viewport", default_value: true});
			...
			hou_parm_template3.setHelp("intensity: Scales the contribution of this light linearly. The light intensity is computed using physical units.");
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "lightColorMap", label: "Color Map", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l light_SHOP/light_risnet/pxrrectlight lightColorMap", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ light_enable == 0 }");
			hou_parm_template3.setHelp("lightColorMap: Filename of a texture for light color. If the lightColor parameter is specified, it will tint the color of the map.");
			...
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ enableShadows != 1 } { traceLightPaths != 0 }");
			hou_parm_template3.setHelp("shadowDistance: The maximum distance of the shadow starting from the position of the point being shaded. You may use this control to artificially reduce the distance shadows are cast. This may also increase render speed by not calculating shadows outside this distance.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setHelp("fixedSampleCount: Specifies an override of the number of light samples to be taken for this light source. If set to something other than zero, it will override the sampling performed by the integrator and can result in a performance impact. For scenes that have lots of lights, resulting in some lights that are under-sampled, you may want to set it to non-zero.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "int"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3 = new hou.StringParmTemplate({name: "shop_lightpath", label: "Light Shader", num_components: 1, default_value: ["lightSHOP/light_risnet/pxrrectlight"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('OBJECT/Render/pxrrectlight',_hnt_OBJECT_pxrrectlight)
    return _hnt_OBJECT_pxrrectlight
}
