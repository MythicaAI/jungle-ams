...
export default function (hou) {
    class _hnt_VOP_mtlxcos extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxcos';
        static category = '/VOP';
        static houdiniType = 'mtlxcos';
        static title = 'MtlX Cos';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxcos.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxcos',_hnt_VOP_mtlxcos)
    return _hnt_VOP_mtlxcos
}
