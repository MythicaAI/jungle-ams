...
export default function (hou) {
    class _hnt_SOP_heightfield_drawmask extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Environments/Terrain/heightfield_drawmask';
        static category = '/SOP';
        static houdiniType = 'heightfield_drawmask';
        static title = 'HeightField Draw Mask';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_heightfield_drawmask.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "combine", label: "Combine with Existing", menu_items: ["replace", "add", "subtract", "diff", "multiply", "max", "min", "blend", "edit"], menu_labels: ["Replace", "Add", "Subtract", "Difference", "Multiply", "Maximum", "Minimum", "Blend", "Edit"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "stroke_projtype", label: "Drawing Plane", menu_items: ["xy", "yz", "zx", "screen", "geometry"], menu_labels: ["XY Plane", "YZ Plane", "ZX Plane", "Screen Plane", "Geometry"], default_value: 4, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "stroke_tool", label: "Operation", menu_items: ["add", "sub"], menu_labels: ["Add", "Subtract"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ combine == direct }");
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_2", label: "Layer Bindings", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Environments/Terrain/heightfield_drawmask',_hnt_SOP_heightfield_drawmask)
    return _hnt_SOP_heightfield_drawmask
}
