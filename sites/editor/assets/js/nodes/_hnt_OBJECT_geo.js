...
export default function (hou) {
    class _hnt_OBJECT_geo extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/geo';
        static category = '/OBJECT';
        static houdiniType = 'geo';
        static title = 'Geometry';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_geo.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/geo',_hnt_OBJECT_geo)
    return _hnt_OBJECT_geo
}
