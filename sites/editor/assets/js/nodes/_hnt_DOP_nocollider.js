...
export default function (hou) {
    class _hnt_DOP_nocollider extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/nocollider';
        static category = '/DOP';
        static houdiniType = 'nocollider';
        static title = 'No Collider';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_nocollider.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "dataname", label: "Data Name", num_components: 1, default_value: ["None"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/nocollider',_hnt_DOP_nocollider)
    return _hnt_DOP_nocollider
}
