...
export default function (hou) {
    class _hnt_CHOP_null extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/null';
        static category = '/CHOP';
        static houdiniType = 'null';
        static title = 'Null';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_null.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Other/null',_hnt_CHOP_null)
    return _hnt_CHOP_null
}
