...
export default function (hou) {
    class _hnt_OBJECT_mocap_rig_biped_spine_3pc extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/mocap_rig_biped_spine_3pc';
        static category = '/OBJECT';
        static houdiniType = 'mocap_rig_biped_spine_3pc';
        static title = 'Mocap Rig Biped Spine 3pc';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_mocap_rig_biped_spine_3pc.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "opfilter": "!!OBJ!!", "oprelative": "."});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "chest_targetpath", label: "Chest Target Object", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "opfilter": "!!OBJ!!", "oprelative": "."});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "chest_bone_length", label: "Chest Bone Length", num_components: 1, default_value: [1], min: 0.001, max: 2, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('OBJECT/Other/mocap_rig_biped_spine_3pc',_hnt_OBJECT_mocap_rig_biped_spine_3pc)
    return _hnt_OBJECT_mocap_rig_biped_spine_3pc
}
