...
export default function (hou) {
    class _hnt_CHOP_constraintoffset extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintoffset';
        static category = '/CHOP';
        static houdiniType = 'constraintoffset';
        static title = 'Offset';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintoffset.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "Constraint_Offset", label: "Constraint Offset", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "blend", label: "Blend", num_components: 1, default_value: [1], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "writemask", label: "Blend Mask", menu_items: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], menu_labels: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], default_value: 8, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "mask", label: "Offset Mask", menu_items: ["1", "2", "4", "8", "16", "32", "64", "128", "256"], menu_labels: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], default_value: 8, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "update", label: "Update Offset"});
			hou_parm_template2.setScriptCallback("import choptoolutils; choptoolutils.updatePose(kwargs['node'].node('bindpose_before'));  choptoolutils.updatePose(kwargs['node'].node('bindpose_after'))");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback": "import choptoolutils; choptoolutils.updatePose(kwargs['node'].node('bindpose_before'));  choptoolutils.updatePose(kwargs['node'].node('bindpose_after'))", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "clear", label: "Clear Offset"});
			hou_parm_template2.setScriptCallback("import choptoolutils; choptoolutils.clearPose(kwargs['node'].node('bindpose_before'));  choptoolutils.clearPose(kwargs['node'].node('bindpose_after'))");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback": "import choptoolutils; choptoolutils.clearPose(kwargs['node'].node('bindpose_before'));  choptoolutils.clearPose(kwargs['node'].node('bindpose_after'))", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "Constraint_Offset_1", label: "Channel", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "Constraint_Offset_2", label: "Common", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Constraints/constraintoffset',_hnt_CHOP_constraintoffset)
    return _hnt_CHOP_constraintoffset
}
