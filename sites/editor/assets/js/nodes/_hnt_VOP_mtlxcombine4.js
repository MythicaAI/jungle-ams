...
export default function (hou) {
    class _hnt_VOP_mtlxcombine4 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Channel/mtlxcombine4';
        static category = '/VOP';
        static houdiniType = 'mtlxcombine4';
        static title = 'MtlX Combine4';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxcombine4.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Channel/mtlxcombine4',_hnt_VOP_mtlxcombine4)
    return _hnt_VOP_mtlxcombine4
}
