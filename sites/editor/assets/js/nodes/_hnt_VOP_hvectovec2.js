...
export default function (hou) {
    class _hnt_VOP_hvectovec2 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/hvectovec2';
        static category = '/VOP';
        static houdiniType = 'hvectovec2';
        static title = 'Vector4 to Vector2';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/hvectovec2',_hnt_VOP_hvectovec2)
    return _hnt_VOP_hvectovec2
}
