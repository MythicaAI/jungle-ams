...
export default function (hou) {
    class _hnt_OBJECT_subnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/subnet';
        static category = '/OBJECT';
        static houdiniType = 'subnet';
        static title = 'Subnetwork';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_subnet.svg';
        constructor() {
            super();
            this.flags['houdini_type'] = this.__proto__.constructor.houdiniType;
            
            const inputs = ['OBJECT', 'OBJECT', 'OBJECT', 'OBJECT'];
    ...
    hou.registerType('OBJECT/Other/subnet',_hnt_OBJECT_subnet)
    return _hnt_OBJECT_subnet
}
