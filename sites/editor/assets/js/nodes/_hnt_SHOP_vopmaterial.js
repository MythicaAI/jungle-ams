...
export default function (hou) {
    class _hnt_SHOP_vopmaterial extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopmaterial';
        static category = '/SHOP';
        static houdiniType = 'vopmaterial';
        static title = 'Material Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopmaterial.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopmaterial',_hnt_SHOP_vopmaterial)
    return _hnt_SHOP_vopmaterial
}
