...
export default function (hou) {
    class _hnt_VOP_chattr extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/chattr';
        static category = '/VOP';
        static houdiniType = 'chattr';
        static title = 'Get Channel Attribute';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/chattr',_hnt_VOP_chattr)
    return _hnt_VOP_chattr
}
