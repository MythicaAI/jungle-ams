...
export default function (hou) {
    class _hnt_COP2_subtract extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/subtract';
        static category = '/COP2';
        static houdiniType = 'subtract';
        static title = 'Subtract';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_subtract.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Subtract", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/subtract',_hnt_COP2_subtract)
    return _hnt_COP2_subtract
}
