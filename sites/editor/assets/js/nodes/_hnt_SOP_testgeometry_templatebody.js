...
export default function (hou) {
    class _hnt_SOP_testgeometry_templatebody extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Utility/Test Geometry/testgeometry_templatebody';
        static category = '/SOP';
        static houdiniType = 'testgeometry_templatebody';
        static title = 'Test Geometry: Template Body';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_testgeometry_templatebody.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setHelp("Position of the center.");
			...
			hou_parm_template.setHelp("Rotation of the geometry about its center.");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setHelp("Uniform scaling.");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Utility/Test Geometry/testgeometry_templatebody',_hnt_SOP_testgeometry_templatebody)
    return _hnt_SOP_testgeometry_templatebody
}
