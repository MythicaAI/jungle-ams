...
export default function (hou) {
    class _hnt_VOP_mtlxasin extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxasin';
        static category = '/VOP';
        static houdiniType = 'mtlxasin';
        static title = 'MtlX Asin';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxasin.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxasin',_hnt_VOP_mtlxasin)
    return _hnt_VOP_mtlxasin
}
