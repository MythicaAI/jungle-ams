...
export default function (hou) {
    class _hnt_DOP_gasresetinactive extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasresetinactive';
        static category = '/DOP';
        static houdiniType = 'gasresetinactive';
        static title = 'Gas Reset Inactive';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasresetinactive.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.MenuParmTemplate({name: "parmop_resetfields", label: "Fields to Reset", menu_items: ["initial", "always", "never", "default"], menu_labels: ["![BUTTONS_set_initial]Set Initial", "![BUTTONS_set_or_create]Set Always", "![BUTTONS_set_block]Set Never", "![BUTTONS_set_nothing]Use Default"], default_value: 3, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.ControlNextParameter, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
    ...
    hou.registerType('DOP/Other/gasresetinactive',_hnt_DOP_gasresetinactive)
    return _hnt_DOP_gasresetinactive
}
