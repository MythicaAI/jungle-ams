...
export default function (hou) {
    class _hnt_OBJECT_ragdollrunexample extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/ragdollrunexample';
        static category = '/OBJECT';
        static houdiniType = 'ragdollrunexample';
        static title = 'Ragdoll Run Example';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_ragdollrunexample.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/ragdollrunexample',_hnt_OBJECT_ragdollrunexample)
    return _hnt_OBJECT_ragdollrunexample
}
