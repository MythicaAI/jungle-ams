...
export default function (hou) {
    class _hnt_DRIVER_channel extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Other/channel';
        static category = '/DRIVER';
        static houdiniType = 'channel';
        static title = 'Channel';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_channel.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/channel',_hnt_DRIVER_channel)
    return _hnt_DRIVER_channel
}
