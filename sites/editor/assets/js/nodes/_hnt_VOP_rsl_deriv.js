...
export default function (hou) {
    class _hnt_VOP_rsl_deriv extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/rsl_deriv';
        static category = '/VOP';
        static houdiniType = 'rsl_deriv';
        static title = 'Deriv';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/rsl_deriv',_hnt_VOP_rsl_deriv)
    return _hnt_VOP_rsl_deriv
}
