...
export default function (hou) {
    class _hnt_VOP_mtlxclamp extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxclamp';
        static category = '/VOP';
        static houdiniType = 'mtlxclamp';
        static title = 'MtlX Clamp';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxclamp.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxclamp',_hnt_VOP_mtlxclamp)
    return _hnt_VOP_mtlxclamp
}
