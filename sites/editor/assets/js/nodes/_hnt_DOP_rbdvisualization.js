...
export default function (hou) {
    class _hnt_DOP_rbdvisualization extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/rbdvisualization';
        static category = '/DOP';
        static houdiniType = 'rbdvisualization';
        static title = 'RBD Visualization';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_rbdvisualization.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.ToggleParmTemplate({name: "impacts", label: "Impacts", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "impactsscale", label: "Impacts Scale", num_components: 1, default_value: [0.001], min: 1e-06, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setTags({"units": "m1"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "impactscolor", label: "Impacts Color", num_components: 3, default_value: [1, 0, 0], min: 0, max: 1, min_is_strict: true, max_is_strict: true, look: hou.parmLook.ColorSquare, naming_scheme: hou.parmNamingScheme.RGBA});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/rbdvisualization',_hnt_DOP_rbdvisualization)
    return _hnt_DOP_rbdvisualization
}
