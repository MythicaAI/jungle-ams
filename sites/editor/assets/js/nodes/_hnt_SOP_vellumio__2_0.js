...
export default function (hou) {
    class _hnt_SOP_vellumio__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Dynamics/Vellum/vellumio::2.0';
        static category = '/SOP';
        static houdiniType = 'vellumio::2.0';
        static title = 'Vellum I/O';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_vellumio__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder10", label: "Sequence", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_default": "1", "group_type": "collapsible"});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder4_2", label: "Save Filter", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder7", label: "Save", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder8", label: "Load", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "collapsible"});
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ cachesize == 0 }");
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder6", label: "Scripts", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "collapsible"});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder9", label: "Path", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Dynamics/Vellum/vellumio::2.0',_hnt_SOP_vellumio__2_0)
    return _hnt_SOP_vellumio__2_0
}
