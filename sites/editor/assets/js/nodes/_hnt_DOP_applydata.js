...
export default function (hou) {
    class _hnt_DOP_applydata extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/applydata';
        static category = '/DOP';
        static houdiniType = 'applydata';
        static title = 'Apply Data';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_applydata.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/applydata',_hnt_DOP_applydata)
    return _hnt_DOP_applydata
}
