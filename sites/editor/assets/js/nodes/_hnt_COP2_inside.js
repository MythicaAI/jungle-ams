...
export default function (hou) {
    class _hnt_COP2_inside extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/inside';
        static category = '/COP2';
        static houdiniType = 'inside';
        static title = 'Inside';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_inside.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Inside", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/inside',_hnt_COP2_inside)
    return _hnt_COP2_inside
}
