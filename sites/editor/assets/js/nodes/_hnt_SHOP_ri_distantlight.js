...
export default function (hou) {
    class _hnt_SHOP_ri_distantlight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/ri_distantlight';
        static category = '/SHOP';
        static houdiniType = 'ri_distantlight';
        static title = 'RSL Distant Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_ri_distantlight.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/ri_distantlight',_hnt_SHOP_ri_distantlight)
    return _hnt_SHOP_ri_distantlight
}
