...
export default function (hou) {
    class _hnt_VOP_mtlxhsvadjust extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Color Correction/mtlxhsvadjust';
        static category = '/VOP';
        static houdiniType = 'mtlxhsvadjust';
        static title = 'MtlX Adjust as HSV';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxhsvadjust.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "amount", label: "Amount", num_components: 3, default_value: [0, 1, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Color Correction/mtlxhsvadjust',_hnt_VOP_mtlxhsvadjust)
    return _hnt_VOP_mtlxhsvadjust
}
