...
export default function (hou) {
    class _hnt_DRIVER_labs__rbd_to_fbx extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DRIVER/Labs/labs::rbd_to_fbx';
        static category = '/DRIVER/labs';
        static houdiniType = 'labs::rbd_to_fbx';
        static title = 'Labs RBD to FBX';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_labs__rbd_to_fbx.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "group", label: "Isolate Group", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l objnet1/FBX_EXPORT/piece0/delete1 group", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringToggle});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DRIVER/Labs/labs::rbd_to_fbx',_hnt_DRIVER_labs__rbd_to_fbx)
    return _hnt_DRIVER_labs__rbd_to_fbx
}
