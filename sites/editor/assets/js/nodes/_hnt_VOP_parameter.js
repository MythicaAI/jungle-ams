...
export default function (hou) {
    class _hnt_VOP_parameter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/parameter';
        static category = '/VOP';
        static houdiniType = 'parameter';
        static title = 'Parameter';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_parameter.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "showlabel", label: "Show Label", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "rangeflt", label: "Float Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "rangeint", label: "Integer Range", num_components: 2, default_value: [0, 10], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "stringtype", label: "String Qualifier", num_components: 1, default_value: ["off"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["off", "oplist"], menu_labels: ["Just A String", "A List Of Objects"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "opfilter", label: " Operator Filter", num_components: 1, default_value: ["!!OBJ/LIGHT!!"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["!!OBJ!!", "!!SOP!!", "!!DOP!!", "!!POP!!", "!!CHOP!!", "!!COP2!!", "!!VOP!!", "!!LOP!!", "!!TOP!!", "!!ROP!!", "!!OBJ/GEOMETRY!!", "!!OBJ/NULL!!", "!!OBJ/LIGHT!!", "!!OBJ/CAMERA!!", "!!OBJ/FOG!!", "!!OBJ/BONE!!", "!!OBJ/NULL!!", "!!OBJ/MUSCLE!!", "!!CUSTOM/MATERIAL!!", "!!SHOP/SURFACE!!", "!!SHOP/DISPLACEMENT!!", "!!SHOP/LIGHT!!", "!!SHOP/LIGHT_SHADOW!!", "!!SHOP/ATMOSPHERE!!", "!!SHOP/PHOTON!!", "!!SHOP/IMAGE3D!!", "!!TOP/SCHEDULER!!", "!!TOP/PROCESSOR!!", "!!TOP/PARTITIONER!!", "!!TOP/MAPPER!!"], menu_labels: ["Any Object", "Any SOP", "Any DOP", "Any POP", "Any CHOP", "Any COP", "Any VOP", "Any LOP", "Any TOP", "Any ROP", "Object: Geometry Only", "Object: Null Only", "Object: Light Only", "Object: Camera Only", "Object: Fog Only", "Object: Bone Only", "Object: Null Only", "Object: Muscle Only", "Any Material", "SHOP: Surface Only", "SHOP: Displacement Only", "SHOP: Light Only", "SHOP: Shadow Only", "SHOP: Fog Only", "SHOP: Photon Only", "SHOP: Image3D Only", "TOP: Schedulers Only", "TOP: Processors Only", "TOP: Partitioners Only", "TOP: Mappers Only"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "parmcomment", label: "Comment", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "usebound", label: "Use Input Value If Parameter Not Bound", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "hasconnector", label: "Has Corresponding Connector", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "providemenu", label: "Provide Menu", menu_items: ["off", "on", "menuscript"], menu_labels: ["No Menu", "Menu from Items", "Menu from Script"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "menuchoices", label: "Menu Items", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "menuscript", label: "Menu Script", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "menuscriptlanguage", label: "Menu Script Language", menu_items: ["hscript", "python"], menu_labels: ["HScript", "Python"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.SeparatorParmTemplate({name: "separator2"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "invisible", label: "Invisible", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "joinnext", label: "Horizontally Join to Next Parameter", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.DataParmTemplate({name: "tags", label: "Tags", num_components: 1, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setTags({"sidefx::key_value_dict_chooser_callback": "hou.ui.selectParmTag()", "sidefx::key_value_dict_chooser_label": "Built-in Tags...", "sidefx::key_value_dict_key_label": "Tag Name", "sidefx::key_value_dict_use_chooser": "1", "sidefx::key_value_dict_value_label": "Tag Value"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/parameter',_hnt_VOP_parameter)
    return _hnt_VOP_parameter
}
