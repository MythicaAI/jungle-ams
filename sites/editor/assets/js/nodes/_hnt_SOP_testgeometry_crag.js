...
export default function (hou) {
    class _hnt_SOP_testgeometry_crag extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Utility/Test Geometry/testgeometry_crag';
        static category = '/SOP';
        static houdiniType = 'testgeometry_crag';
        static title = 'Test Geometry: Crag';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_testgeometry_crag.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "hammer", label: "Include Hammer", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "restpose", label: "Rest Pose", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "frame", label: "Animation Frame", num_components: 1, default_value: [0], default_expression: ["$FF"], default_expression_language: [hou.scriptLanguage.Hscript], min: 1, max: 500, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ restpose == 1 }");
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Utility/Test Geometry/testgeometry_crag',_hnt_SOP_testgeometry_crag)
    return _hnt_SOP_testgeometry_crag
}
