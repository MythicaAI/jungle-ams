...
export default function (hou) {
    class _hnt_VOP_tangent extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/tangent';
        static category = '/VOP';
        static houdiniType = 'tangent';
        static title = 'Tangent';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_tangent.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/tangent',_hnt_VOP_tangent)
    return _hnt_VOP_tangent
}
