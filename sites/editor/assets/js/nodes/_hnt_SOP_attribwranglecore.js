...
export default function (hou) {
    class _hnt_SOP_attribwranglecore extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/attribwranglecore';
        static category = '/SOP';
        static houdiniType = 'attribwranglecore';
        static title = 'Attribute Wrangle Core';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/attribwranglecore',_hnt_SOP_attribwranglecore)
    return _hnt_SOP_attribwranglecore
}
