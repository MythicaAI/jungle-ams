...
export default function (hou) {
    class _hnt_COP2_mono extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/mono';
        static category = '/COP2';
        static houdiniType = 'mono';
        static title = 'Mono';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_mono.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Mono", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation", menu_items: ["lum", "ntsclum", "average", "max", "min", "magnitude", "hue", "saturation", "red", "green", "blue", "comp4"], menu_labels: ["Luminance", "NTSC Luminance", "Average", "Maximum Component", "Minimum Component", "Magnitude", "Hue", "Saturation", "Red", "Green", "Blue", "Component 4"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "keepasvec", label: "Keep Vector Planes as Vectors", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/mono',_hnt_COP2_mono)
    return _hnt_COP2_mono
}
