...
export default function (hou) {
    class _hnt_COP2_cryptomatte extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/cryptomatte';
        static category = '/COP2';
        static houdiniType = 'cryptomatte';
        static title = 'Cryptomatte';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_cryptomatte.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Cryptomatte", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "channelname", label: "Channel Name", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "selection", label: "Matte Selection", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.setTags({"editor": "1", "editorlines": "8-40"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "invert", label: "Invert Selection", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.LabelParmTemplate({name: "label", label: "", column_labels: ["Left click (in Composite View) to select matte.\nShift+Left click to add or remove selection."]});
    ...
    hou.registerType('COP2/Other/cryptomatte',_hnt_COP2_cryptomatte)
    return _hnt_COP2_cryptomatte
}
