...
export default function (hou) {
    class _hnt_SOP_labs__testgeometry_paul extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Geometry/Mesh/Create/labs::testgeometry_paul';
        static category = '/SOP/labs';
        static houdiniType = 'labs::testgeometry_paul';
    ...
    hou.registerType('SOP/Labs/Geometry/Mesh/Create/labs::testgeometry_paul',_hnt_SOP_labs__testgeometry_paul)
    return _hnt_SOP_labs__testgeometry_paul
}
