...
export default function (hou) {
    class _hnt_CHOP_identity extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/identity';
        static category = '/CHOP';
        static houdiniType = 'identity';
        static title = 'Identity';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_identity.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Constraints/identity',_hnt_CHOP_identity)
    return _hnt_CHOP_identity
}
