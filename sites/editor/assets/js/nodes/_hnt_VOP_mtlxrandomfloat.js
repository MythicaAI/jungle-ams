...
export default function (hou) {
    class _hnt_VOP_mtlxrandomfloat extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Procedural/mtlxrandomfloat';
        static category = '/VOP';
        static houdiniType = 'mtlxrandomfloat';
        static title = 'MtlX Random Float';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxrandomfloat.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "min", label: "Minimum", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "max", label: "Maximum", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Procedural/mtlxrandomfloat',_hnt_VOP_mtlxrandomfloat)
    return _hnt_VOP_mtlxrandomfloat
}
