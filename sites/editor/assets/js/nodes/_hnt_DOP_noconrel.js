...
export default function (hou) {
    class _hnt_DOP_noconrel extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/noconrel';
        static category = '/DOP';
        static houdiniType = 'noconrel';
        static title = 'No Constraint Relationship';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_noconrel.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FloatParmTemplate({name: "rad", label: "Radius", num_components: 1, default_value: [0.1], min: 0, max: 10, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "showobjectlink", label: "Show Object Link", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "dataname", label: "Data Name", num_components: 1, default_value: ["ConRelNone"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/noconrel',_hnt_DOP_noconrel)
    return _hnt_DOP_noconrel
}
