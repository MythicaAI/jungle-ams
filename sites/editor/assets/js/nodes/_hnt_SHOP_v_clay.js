...
export default function (hou) {
    class _hnt_SHOP_v_clay extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/v_clay';
        static category = '/SHOP';
        static houdiniType = 'v_clay';
        static title = 'Clay';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/v_clay',_hnt_SHOP_v_clay)
    return _hnt_SHOP_v_clay
}
