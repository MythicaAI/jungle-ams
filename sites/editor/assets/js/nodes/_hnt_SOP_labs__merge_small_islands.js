...
export default function (hou) {
    class _hnt_SOP_labs__merge_small_islands extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/UV/labs::merge_small_islands';
        static category = '/SOP/labs';
        static houdiniType = 'labs::merge_small_islands';
        static title = 'Labs Merge Small Islands';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__merge_small_islands.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FloatParmTemplate({name: "fFuseDist", label: "Initial Fuse Dist", num_components: 1, default_value: [1e-05], min: 1e-06, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "cutoff", label: "Cutoff", num_components: 1, default_value: [0.0001], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('SOP/Labs/UV/labs::merge_small_islands',_hnt_SOP_labs__merge_small_islands)
    return _hnt_SOP_labs__merge_small_islands
}
