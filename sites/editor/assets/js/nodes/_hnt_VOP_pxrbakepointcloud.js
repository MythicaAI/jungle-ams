...
export default function (hou) {
    class _hnt_VOP_pxrbakepointcloud extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrbakepointcloud';
        static category = '/VOP';
        static houdiniType = 'pxrbakepointcloud';
        static title = 'Pxr Bake Point Cloud';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrbakepointcloud.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setHelp("Input/output point cloud filename.");
			...
			hou_parm_template2.setHelp("Enable or disable point cloud baking.");
			hou_parm_template2.setTags({"script_ritype": "int"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "display", label: "File Type", num_components: 1, default_value: ["pointcloud"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["pointcloud"], menu_labels: ["PTC (.ptc)"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.setHelp("Output file type display driver.");
			hou_parm_template2.setTags({"script_ritype": "string"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "density", label: "Density", num_components: 1, default_value: [10], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setHelp("Density of baking points per unit in world space. Larger values create more points.");
			hou_parm_template2.setTags({"script_ritype": "float"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "coordsys", label: "Coordinate System", num_components: 1, default_value: ["object"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["world", "object", "camera", "ptex"], menu_labels: ["world", "object", "camera", "ptex"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.setHelp("Output coordinate space. Ptex requires that the geometry have a '__faceindex' primvar.");
			hou_parm_template2.setTags({"script_ritype": "string"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/pxrbakepointcloud',_hnt_VOP_pxrbakepointcloud)
    return _hnt_VOP_pxrbakepointcloud
}
