...
export default function (hou) {
    class _hnt_VOP_mtlxdifference extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxdifference';
        static category = '/VOP';
        static houdiniType = 'mtlxdifference';
        static title = 'MtlX Difference';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxdifference.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxdifference',_hnt_VOP_mtlxdifference)
    return _hnt_VOP_mtlxdifference
}
