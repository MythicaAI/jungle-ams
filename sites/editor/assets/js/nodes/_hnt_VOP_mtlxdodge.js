...
export default function (hou) {
    class _hnt_VOP_mtlxdodge extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxdodge';
        static category = '/VOP';
        static houdiniType = 'mtlxdodge';
        static title = 'MtlX Dodge';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxdodge.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxdodge',_hnt_VOP_mtlxdodge)
    return _hnt_VOP_mtlxdodge
}
