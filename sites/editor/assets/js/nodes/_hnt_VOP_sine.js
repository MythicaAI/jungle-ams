...
export default function (hou) {
    class _hnt_VOP_sine extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/sine';
        static category = '/VOP';
        static houdiniType = 'sine';
        static title = 'Sine';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_sine.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/sine',_hnt_VOP_sine)
    return _hnt_VOP_sine
}
