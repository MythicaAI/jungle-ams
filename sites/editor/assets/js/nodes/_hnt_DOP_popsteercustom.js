...
export default function (hou) {
    class _hnt_DOP_popsteercustom extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popsteercustom';
        static category = '/DOP';
        static houdiniType = 'popsteercustom';
        static title = 'POP Steer Custom';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popsteercustom.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.LabelParmTemplate({name: "labelparm", label: "labelparm", column_labels: ["Dive inside to build custom force"]});
    ...
    hou.registerType('DOP/POPs/popsteercustom',_hnt_DOP_popsteercustom)
    return _hnt_DOP_popsteercustom
}
