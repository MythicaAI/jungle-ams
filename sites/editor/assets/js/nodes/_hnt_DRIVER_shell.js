...
export default function (hou) {
    class _hnt_DRIVER_shell extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Other/shell';
        static category = '/DRIVER';
        static houdiniType = 'shell';
        static title = 'Shell';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_shell.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.ButtonParmTemplate({name: "execute", label: "Run Command"});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "switcher", label: "Shell", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "command", label: "Shell Command", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "shellexec", label: "Execute in a Shell", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DRIVER/Other/shell',_hnt_DRIVER_shell)
    return _hnt_DRIVER_shell
}
