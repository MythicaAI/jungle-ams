...
export default function (hou) {
    class _hnt_SOP_Sop_rbdmaterialfracture__rbdglassfracture extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Dynamics/Fracture/Sop/rbdmaterialfracture::rbdglassfracture';
        static category = '/SOP';
        static houdiniType = 'Sop/rbdmaterialfracture::rbdglassfracture';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "enable_chipping", label: "Enable Chipping", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"group_type": "simple"});
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "enableconvexdecomposition", label: "Use Convex Decomposition", default_value: false});
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ enableedgenoise == 0 } { enableconvexdecomposition == 0 }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Dynamics/Fracture/Sop/rbdmaterialfracture::rbdglassfracture',_hnt_SOP_Sop_rbdmaterialfracture__rbdglassfracture)
    return _hnt_SOP_Sop_rbdmaterialfracture__rbdglassfracture
}
