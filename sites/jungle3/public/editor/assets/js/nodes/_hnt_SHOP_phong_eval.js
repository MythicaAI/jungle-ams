...
export default function (hou) {
    class _hnt_SHOP_phong_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/phong_eval';
        static category = '/SHOP';
        static houdiniType = 'phong_eval';
        static title = 'phong_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_phong_eval.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/phong_eval',_hnt_SHOP_phong_eval)
    return _hnt_SHOP_phong_eval
}
