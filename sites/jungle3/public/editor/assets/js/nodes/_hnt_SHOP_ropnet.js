...
export default function (hou) {
    class _hnt_SHOP_ropnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'SHOP/Other/ropnet';
        static category = '/SHOP';
        static houdiniType = 'ropnet';
        static title = 'ROP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_ropnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/ropnet',_hnt_SHOP_ropnet)
    return _hnt_SHOP_ropnet
}
