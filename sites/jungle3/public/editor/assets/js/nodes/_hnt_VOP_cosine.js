...
export default function (hou) {
    class _hnt_VOP_cosine extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/cosine';
        static category = '/VOP';
        static houdiniType = 'cosine';
        static title = 'Cosine';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_cosine.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/cosine',_hnt_VOP_cosine)
    return _hnt_VOP_cosine
}
