...
export default function (hou) {
    class _hnt_DOP_rop_dop extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = true;
        static id = 'DOP/Other/rop_dop';
        static category = '/DOP';
        static houdiniType = 'rop_dop';
        static title = 'ROP Output Driver';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_rop_dop.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "doppath", label: "DOP Path", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setTags({"opfilter": "!!DOP!!", "oprelative": "."});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "dopoutput", label: "Output File", num_components: 1, default_value: ["$HIP/sim/$HIPNAME.$OS.$SF.sim"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template.setTags({"filechooser_mode": "write"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "usesimframes", label: "Output Every Sim Frame Using $SF", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "compresssims", label: "Compress .sim Files", menu_items: ["off", "blosc", "on"], menu_labels: ["No Compression", "Blosc", "Gzip"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/rop_dop',_hnt_DOP_rop_dop)
    return _hnt_DOP_rop_dop
}
