...
export default function (hou) {
    class _hnt_DOP_popcollisionignore extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popcollisionignore';
        static category = '/DOP';
        static houdiniType = 'popcollisionignore';
        static title = 'POP Collision Ignore';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popcollisionignore.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.StringParmTemplate({name: "collisionignore", label: "Collision Ignore", num_components: 1, default_value: ["*"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import doppoptoolutils\nreturn doppoptoolutils.buildDopObjectMenu(hou.pwd())", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
    ...
    hou.registerType('DOP/POPs/popcollisionignore',_hnt_DOP_popcollisionignore)
    return _hnt_DOP_popcollisionignore
}
