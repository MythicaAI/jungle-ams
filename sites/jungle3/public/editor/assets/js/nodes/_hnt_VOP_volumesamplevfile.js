...
export default function (hou) {
    class _hnt_VOP_volumesamplevfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumesamplevfile';
        static category = '/VOP';
        static houdiniType = 'volumesamplevfile';
        static title = 'Volume Sample Vector';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/volumesamplevfile',_hnt_VOP_volumesamplevfile)
    return _hnt_VOP_volumesamplevfile
}
