...
export default function (hou) {
    class _hnt_DOP_gasfieldvop extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin, hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasfieldvop';
        static category = '/DOP';
        static houdiniType = 'gasfieldvop';
        static title = 'Gas Field VOP';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_gasfieldvop.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template3 = new hou.StringParmTemplate({name: "binddata#", label: "DOP Data", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ bindinputmenu1 != dopdata }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "bindinputmenu2", label: "Input 2", menu_items: ["none", "sop", "dopdata", "first", "second", "third", "fourth"], menu_labels: ["None", "SOP", "DOP Data", "First Context Geometry", "Second Context Geometry", "Third Context Geometry", "Fourth Context Geometry"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ bindinputmenu2 != dopdata }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "bindinputmenu3", label: "Input 3", menu_items: ["none", "sop", "dopdata", "first", "second", "third", "fourth"], menu_labels: ["None", "SOP", "DOP Data", "First Context Geometry", "Second Context Geometry", "Third Context Geometry", "Fourth Context Geometry"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ bindinputmenu3 != dopdata }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "bindinputmenu4", label: "Input 4", menu_items: ["none", "sop", "dopdata", "first", "second", "third", "fourth"], menu_labels: ["None", "SOP", "DOP Data", "First Context Geometry", "Second Context Geometry", "Third Context Geometry", "Fourth Context Geometry"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('DOP/Other/gasfieldvop',_hnt_DOP_gasfieldvop)
    return _hnt_DOP_gasfieldvop
}
