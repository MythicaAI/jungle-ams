...
export default function (hou) {
    class _hnt_SOP_vellumxformpieces extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Dynamics/Vellum/vellumxformpieces';
        static category = '/SOP';
        static houdiniType = 'vellumxformpieces';
        static title = 'Vellum Transform Pieces';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_vellumxformpieces.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.MenuParmTemplate({name: "output", label: "Output", menu_items: ["points", "geometry"], menu_labels: ["Points with Transforms", "Transformed Geometry"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Dynamics/Vellum/vellumxformpieces',_hnt_SOP_vellumxformpieces)
    return _hnt_SOP_vellumxformpieces
}
