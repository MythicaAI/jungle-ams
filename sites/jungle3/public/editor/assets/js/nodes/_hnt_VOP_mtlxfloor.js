...
export default function (hou) {
    class _hnt_VOP_mtlxfloor extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxfloor';
        static category = '/VOP';
        static houdiniType = 'mtlxfloor';
        static title = 'MtlX Floor';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxfloor.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxfloor',_hnt_VOP_mtlxfloor)
    return _hnt_VOP_mtlxfloor
}
