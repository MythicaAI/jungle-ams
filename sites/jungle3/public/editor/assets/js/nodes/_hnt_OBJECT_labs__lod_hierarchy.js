...
export default function (hou) {
    class _hnt_OBJECT_labs__lod_hierarchy extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Labs/Pipeline/Export/labs::lod_hierarchy';
        static category = '/OBJECT/labs';
        static houdiniType = 'labs::lod_hierarchy';
        static title = 'Labs LOD Hierarchy';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_labs__lod_hierarchy.svg';
        constructor() {
            super();
            this.flags['houdini_type'] = this.__proto__.constructor.houdiniType;
            
            const inputs = ['OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT', 'OBJECT'];
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "fd_generallodsettings", label: "General LOD Settings", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template.setTags({"group_type": "simple"});
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "bBranchLeaf", label: "Extra Parent Group", default_value: false});
			hou_parm_template2.hide(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "sMeshName", label: "Mesh Name", num_components: 1, default_value: ["LODGroup"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "bOverrideNumLODs", label: "Override", default_value: false});
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "iNumLOD", label: "Number LOD Levels", num_components: 1, default_value: [1], min: 2, max: 6, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ bOverrideNumLODs == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setTags({"group_type": "simple"});
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "createsubnetroot", label: "Create Root for Subnet", default_value: true, default_expression: "on", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template2.hide(true);
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "sopoutput", label: "Output File", num_components: 1, default_value: ["$HIP/export/out.fbx"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l ropnet1/filmboxfbx1 sopoutput", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "filechooser_mode": "write"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "sdkversion", label: "FBX SDK Version", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l ropnet1/filmboxfbx1 sdkversion", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.Normal});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('OBJECT/Labs/Pipeline/Export/labs::lod_hierarchy',_hnt_OBJECT_labs__lod_hierarchy)
    return _hnt_OBJECT_labs__lod_hierarchy
}
