...
export default function (hou) {
    class _hnt_SOP_labs__attribute_normalize_vector__1_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Geometry/Attribute/labs::attribute_normalize_vector::1.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::attribute_normalize_vector::1.0';
        static title = 'Labs Attribute Normalize Vector';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__attribute_normalize_vector__1_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.LabelParmTemplate({name: "lb_helpP", label: "lb_helpP", column_labels: ["Warning: Renaming attribute \"P\" is not permitted."]});
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ attrib != P } { rename == 0 }");
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ outputunit == 1 }");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			...
			let hou_parm_template2 = new hou.ToggleParmTemplate({name: "outputunit", label: "Output Unit Vectors", default_value: true});
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "outrange", label: "Output Length Range", num_components: 2, default_value: [0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ outputunit == 1 }");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "useramp", label: "Remap Output Lengths", default_value: false});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ outputunit == 1 }");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.RampParmTemplate({name: "remapramp", label: "Output Lengths over Input Range", ramp_parm_type: hou.rampParmType.Float, default_value: 2, default_basis: null, color_type: null});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ useramp == 0 } { outputunit == 1 }");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			...
			hou_parm_template.setTags({"group_type": "collapsible"});
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "reportlimitvals", label: "Output Original Min/Max Lengths", default_value: false});
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.setConditional(hou.parmCondType.HideWhen, "{ vis == 0 } { outputunit == 1 }");
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/Geometry/Attribute/labs::attribute_normalize_vector::1.0',_hnt_SOP_labs__attribute_normalize_vector__1_0)
    return _hnt_SOP_labs__attribute_normalize_vector__1_0
}
