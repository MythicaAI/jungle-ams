...
export default function (hou) {
    class _hnt_DOP_linktosourceobject extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Data Flow/linktosourceobject';
        static category = '/DOP';
        static houdiniType = 'linktosourceobject';
        static title = 'Link to Source Object';
        static icon = 'None';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "objpath", label: "OBJ Path", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.NodeReference, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('DOP/Data Flow/linktosourceobject',_hnt_DOP_linktosourceobject)
    return _hnt_DOP_linktosourceobject
}
