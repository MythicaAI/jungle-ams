...
export default function (hou) {
    class _hnt_VOP_floattobsdf extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/floattobsdf';
        static category = '/VOP';
        static houdiniType = 'floattobsdf';
        static title = 'Float to BSDF';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/floattobsdf',_hnt_VOP_floattobsdf)
    return _hnt_VOP_floattobsdf
}
