...
export default function (hou) {
    class _hnt_CHOP_fetchchop extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/fetchchop';
        static category = '/CHOP';
        static houdiniType = 'fetchchop';
        static title = 'Fetch Channels';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_fetchchop.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Fetch Channels", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Other/fetchchop',_hnt_CHOP_fetchchop)
    return _hnt_CHOP_fetchchop
}
