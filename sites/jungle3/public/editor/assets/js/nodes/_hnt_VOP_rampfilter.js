...
export default function (hou) {
    class _hnt_VOP_rampfilter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Utility/rampfilter';
        static category = '/VOP';
        static houdiniType = 'rampfilter';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.ToggleParmTemplate({name: "active", label: "Active", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "gammaname", label: "Gamma", num_components: 1, default_value: ["linear"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["linear", "srgb", "custom"], menu_labels: ["Linear", "sRGB", "Custom"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ active == 0 }");
			hou_parm_template.setJoinWithNext(true);
			hou_parm_template.setTags({"autoscope": "0000000000000000"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "gammaval", label: "Gamma Value", num_components: 1, default_value: [2.2], min: 0.0001, max: 4, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ active == 0 } { gammaname != custom }");
			...
			hou_parm_template.hideLabel(true);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "lbt", label: "Extend Left", num_components: 1, default_value: ["hold"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["hold", "cycle", "accum", "mirror", "slope"], menu_labels: ["Hold", "Cycle", "Cycle-Accumulate", "Mirror", "Slope"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ active == 0 }");
			hou_parm_template.setJoinWithNext(true);
			hou_parm_template.setTags({"script_unquoted": ""});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "rbt", label: "Right", num_components: 1, default_value: ["hold"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["hold", "cycle", "accum", "mirror", "slope"], menu_labels: ["Hold", "Cycle", "Cycle-Accumulate", "Mirror", "Slope"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ active == 0 }");
			hou_parm_template.setTags({"script_unquoted": ""});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Utility/rampfilter',_hnt_VOP_rampfilter)
    return _hnt_VOP_rampfilter
}
