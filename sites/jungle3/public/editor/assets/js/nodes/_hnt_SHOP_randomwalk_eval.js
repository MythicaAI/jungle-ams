...
export default function (hou) {
    class _hnt_SHOP_randomwalk_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/randomwalk_eval';
        static category = '/SHOP';
        static houdiniType = 'randomwalk_eval';
        static title = 'randomwalk_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_randomwalk_eval.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.IntParmTemplate({name: "bounces", label: "bounces", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
    ...
    hou.registerType('SHOP/Other/randomwalk_eval',_hnt_SHOP_randomwalk_eval)
    return _hnt_SHOP_randomwalk_eval
}
