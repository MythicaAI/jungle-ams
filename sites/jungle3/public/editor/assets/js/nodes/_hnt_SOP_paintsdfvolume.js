...
export default function (hou) {
    class _hnt_SOP_paintsdfvolume extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Volume/paintsdfvolume';
        static category = '/SOP';
        static houdiniType = 'paintsdfvolume';
        static title = 'Volume Paint SDF';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_paintsdfvolume.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Volume/paintsdfvolume',_hnt_SOP_paintsdfvolume)
    return _hnt_SOP_paintsdfvolume
}
