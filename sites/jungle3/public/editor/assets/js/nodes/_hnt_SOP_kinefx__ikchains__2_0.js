...
export default function (hou) {
    class _hnt_SOP_kinefx__ikchains__2_0 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/kinefx::ikchains::2.0';
        static category = '/SOP/kinefx';
        static houdiniType = 'kinefx::ikchains::2.0';
        static title = 'IK Chains';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_kinefx__ikchains__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.ToggleParmTemplate({name: "multithread", label: "Enable Multithreading", default_value: false});
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "ikchains", label: "IK Chains", folder_type: hou.folderType.TabbedMultiparmBlock, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Other/kinefx::ikchains::2.0',_hnt_SOP_kinefx__ikchains__2_0)
    return _hnt_SOP_kinefx__ikchains__2_0
}
