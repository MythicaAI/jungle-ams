...
export default function (hou) {
    class _hnt_DOP_agentlookatapply extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Crowds/agentlookatapply';
        static category = '/DOP';
        static houdiniType = 'agentlookatapply';
        static title = 'Agent Look At Apply';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_agentlookatapply.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Crowds/agentlookatapply',_hnt_DOP_agentlookatapply)
    return _hnt_DOP_agentlookatapply
}
