...
export default function (hou) {
    class _hnt_VOP_mtlxoverlay extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxoverlay';
        static category = '/VOP';
        static houdiniType = 'mtlxoverlay';
        static title = 'MtlX Overlay';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxoverlay.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxoverlay',_hnt_VOP_mtlxoverlay)
    return _hnt_VOP_mtlxoverlay
}
