...
export default function (hou) {
    class _hnt_TOP_servicestop extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'TOP/Services/servicestop';
        static category = '/TOP';
        static houdiniType = 'servicestop';
        static title = 'Service Stop';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_servicestop.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "servicedata", label: "Service Stop", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('TOP/Services/servicestop',_hnt_TOP_servicestop)
    return _hnt_TOP_servicestop
}
