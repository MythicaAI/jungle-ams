...
export default function (hou) {
    class _hnt_OBJECT_ropnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'OBJECT/Other/ropnet';
        static category = '/OBJECT';
        static houdiniType = 'ropnet';
        static title = 'ROP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_ropnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/ropnet',_hnt_OBJECT_ropnet)
    return _hnt_OBJECT_ropnet
}
