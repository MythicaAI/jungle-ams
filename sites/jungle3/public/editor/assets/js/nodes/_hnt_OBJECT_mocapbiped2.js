...
export default function (hou) {
    class _hnt_OBJECT_mocapbiped2 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/mocapbiped2';
        static category = '/OBJECT';
        static houdiniType = 'mocapbiped2';
        static title = 'Mocap Biped 2';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_mocapbiped2.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "t2", label: "Translate", num_components: 3, default_value: [0, 0, 0], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			...
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "s2", label: "Scale", num_components: 3, default_value: [1, 1, 1], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.SeparatorParmTemplate({name: "sepparm"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "animation", label: "Animation", menu_items: ["jogging", "running", "sitcheer", "sitinteract", "sittostandcheer", "sittostand", "standcheer", "standinteract", "standlook", "standtalk", "standtositclap", "standtowalk", "walkfast", "walknormal", "rest"], menu_labels: ["Jogging", "Running", "Sit Cheer", "Sit Interact", "Sit To Stand Cheer", "Sit To Stand", "Stand Cheer", "Stand Interact", "Stand Look", "Stand Talk", "Stand To Sit Clap", "Stand To Walk", "Walk Fast", "Walk Normal", "Rest"], default_value: 13, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "inplaceanim", label: "Inplace Animation", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "frameoffset", label: "Cycle Frame Offset", num_components: 1, default_value: [0], min: null, max: 30, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.SeparatorParmTemplate({name: "sepparm3"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "texture", label: "Texture", num_components: 1, default_value: [8], min: 1, max: 10, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template2.setScriptCallback("kwargs['node'].hdaModule().toggleForSoup(kwargs)");
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"script_callback": "kwargs['node'].hdaModule().toggleForSoup(kwargs)", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('OBJECT/Other/mocapbiped2',_hnt_OBJECT_mocapbiped2)
    return _hnt_OBJECT_mocapbiped2
}
