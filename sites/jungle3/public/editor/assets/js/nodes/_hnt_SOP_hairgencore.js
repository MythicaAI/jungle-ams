...
export default function (hou) {
    class _hnt_SOP_hairgencore extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/hairgencore';
        static category = '/SOP';
        static houdiniType = 'hairgencore';
        static title = 'Hair Generate Core';
        static icon = 'None';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "uvattrib", label: "UV Attribute", num_components: 1, default_value: ["uv"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "prunethicken", label: "Thicken Remaining Hairs", default_value: false});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ prune == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "useinterpmesh", label: "Use Interpolation Mesh", default_value: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "skininterpguidesattrib", label: "Guides Attribute", num_components: 1, default_value: ["guides"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 0 } { useinterpmesh == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "skininterpweightsattrib", label: "Weights Attribute", num_components: 1, default_value: ["weights"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 } { skininterp == 0 } { useinterpmesh == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "influenceradius", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=2)", "script_action_help": "Paint Influence Radius Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "influencedecay", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=2)", "script_action_help": "Paint Influence Decay Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguidecount", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=2)", "script_action_help": "Paint Maximum Guide Count Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "maxguideangle", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=2)", "script_action_help": "Paint Max Guide Angle Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setTags({"parmoverride_mainparm": "clumpcrossover", "script_action": "import furtoolutils\n\nfurtoolutils.paintTextureMask(\n    kwargs,\n    kwargs['parmtuple'][0].eval(),\n    1.0, skininput=0,\n    skinparmname=None,\n    textureinput=2)", "script_action_help": "Paint Clump Crossover Attrib Texture", "script_action_icon": "SOP_paint"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2 = new hou.FolderParmTemplate({name: "outputattribfolder", label: "Output Attributes", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "simple"});
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "createweightattribs", label: "Guide & Weight Attributes", default_value: false});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ useguides == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "createrestrootattrib", label: "Rest Root Attribute", default_value: true});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder_attribs", label: "Attributes", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "simple"});
			hou_parm_template3 = new hou.StringParmTemplate({name: "clumpidattrib", label: "Clump Id Attribute", num_components: 1, default_value: ["clumpid"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FolderParmTemplate({name: "folder_weightarraypairs", label: "Weight Array Pairs", folder_type: hou.folderType.MultiparmBlock, default_value: 0, ends_tab_group: false});
			hou_parm_template3.setTags({"multistartoffset": "0"});
			let hou_parm_template4 = new hou.StringParmTemplate({name: "guideindexattrib#", label: "Index Attribute", num_components: 1, default_value: ["guides"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('SOP/Other/hairgencore',_hnt_SOP_hairgencore)
    return _hnt_SOP_hairgencore
}
