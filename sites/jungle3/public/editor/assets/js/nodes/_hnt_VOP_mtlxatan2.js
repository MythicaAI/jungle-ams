...
export default function (hou) {
    class _hnt_VOP_mtlxatan2 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxatan2';
        static category = '/VOP';
        static houdiniType = 'mtlxatan2';
        static title = 'MtlX Atan2';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxatan2.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "in1_vector2", label: "Input 1", num_components: 2, default_value: [1, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.setTags({"sidefx::shader_parmname": "in1"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "in1_vector3", label: "Input 1", num_components: 3, default_value: [1, 1, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.setTags({"sidefx::shader_parmname": "in1"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "in1_vector4", label: "Input 1", num_components: 4, default_value: [1, 1, 1, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.setTags({"sidefx::shader_parmname": "in1"});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxatan2',_hnt_VOP_mtlxatan2)
    return _hnt_VOP_mtlxatan2
}
