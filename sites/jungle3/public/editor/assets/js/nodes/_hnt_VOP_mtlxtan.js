...
export default function (hou) {
    class _hnt_VOP_mtlxtan extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxtan';
        static category = '/VOP';
        static houdiniType = 'mtlxtan';
        static title = 'MtlX Tan';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxtan.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxtan',_hnt_VOP_mtlxtan)
    return _hnt_VOP_mtlxtan
}
