...
export default function (hou) {
    class _hnt_SHOP_ri_metal extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/ri_metal';
        static category = '/SHOP';
        static houdiniType = 'ri_metal';
        static title = 'RSL Metal';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_ri_metal.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/ri_metal',_hnt_SHOP_ri_metal)
    return _hnt_SHOP_ri_metal
}
