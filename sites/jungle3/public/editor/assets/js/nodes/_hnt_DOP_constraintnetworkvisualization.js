...
export default function (hou) {
    class _hnt_DOP_constraintnetworkvisualization extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/constraintnetworkvisualization';
        static category = '/DOP';
        static houdiniType = 'constraintnetworkvisualization';
        static title = 'Constraint Network Visualization';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_constraintnetworkvisualization.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/constraintnetworkvisualization',_hnt_DOP_constraintnetworkvisualization)
    return _hnt_DOP_constraintnetworkvisualization
}
