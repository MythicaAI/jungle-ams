...
export default function (hou) {
    class _hnt_VOP_pxrrectlight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrrectlight';
        static category = '/VOP';
        static houdiniType = 'pxrrectlight';
        static title = 'Pxr Rect Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrrectlight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setHelp("lightColorMap: Filename of a texture for light color. If the lightColor parameter is specified, it will tint the color of the map.");
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ enableShadows != 1 } { traceLightPaths != 0 }");
			hou_parm_template2.setHelp("shadowDistance: The maximum distance of the shadow starting from the position of the point being shaded. You may use this control to artificially reduce the distance shadows are cast. This may also increase render speed by not calculating shadows outside this distance.");
			hou_parm_template2.setTags({"script_ritype": "float"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setHelp("fixedSampleCount: Specifies an override of the number of light samples to be taken for this light source. If set to something other than zero, it will override the sampling performed by the integrator and can result in a performance impact. For scenes that have lots of lights, resulting in some lights that are under-sampled, you may want to set it to non-zero.");
			hou_parm_template2.setTags({"script_ritype": "int"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('VOP/Other/pxrrectlight',_hnt_VOP_pxrrectlight)
    return _hnt_VOP_pxrrectlight
}
