...
export default function (hou) {
    class _hnt_VOPNET_cop2gen extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'VOPNET/Other/cop2gen';
        static category = '/VOPNET';
        static houdiniType = 'cop2gen';
        static title = 'COP2 Generator Type';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOPNET_cop2gen.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOPNET/Other/cop2gen',_hnt_VOPNET_cop2gen)
    return _hnt_VOPNET_cop2gen
}
