...
export default function (hou) {
    class _hnt_OBJECT_fuzzyObstacleAvoidance extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Digital Assets/fuzzyObstacleAvoidance';
        static category = '/OBJECT';
        static houdiniType = 'fuzzyObstacleAvoidance';
        static title = 'Fuzzy Logic Obstacle Avoidance';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_fuzzyObstacleAvoidance.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Digital Assets/fuzzyObstacleAvoidance',_hnt_OBJECT_fuzzyObstacleAvoidance)
    return _hnt_OBJECT_fuzzyObstacleAvoidance
}
