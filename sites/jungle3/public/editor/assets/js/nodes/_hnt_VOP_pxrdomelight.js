...
export default function (hou) {
    class _hnt_VOP_pxrdomelight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrdomelight';
        static category = '/VOP';
        static houdiniType = 'pxrdomelight';
        static title = 'Pxr Dome Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrdomelight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setHelp("intensity: Specify the intensity of the light source linearly.");
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "lightColorMap", label: "Color Map", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setHelp("lightColorMap: Filename of the dome texture.");
			...
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ enableShadows != 1 } { traceLightPaths != 0 }");
			hou_parm_template2.setHelp("shadowFalloffGamma: The gamma of the shadow strength in the falloff zone. This requires the use of Shadow Max Distance and Shadow Falloff. The falloff is more obvious as the value decreases.");
			hou_parm_template2.setTags({"script_ritype": "float"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('VOP/Other/pxrdomelight',_hnt_VOP_pxrdomelight)
    return _hnt_VOP_pxrdomelight
}
