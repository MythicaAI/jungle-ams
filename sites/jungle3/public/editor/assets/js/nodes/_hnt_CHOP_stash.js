...
export default function (hou) {
    class _hnt_CHOP_stash extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/stash';
        static category = '/CHOP';
        static houdiniType = 'stash';
        static title = 'Stash';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_stash.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Stash", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.DataParmTemplate({name: "stash", label: "Motion Stash", num_components: 1, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "stashinput", label: "Stash Input"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/stash',_hnt_CHOP_stash)
    return _hnt_CHOP_stash
}
