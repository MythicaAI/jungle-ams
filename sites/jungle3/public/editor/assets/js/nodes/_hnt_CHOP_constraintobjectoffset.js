...
export default function (hou) {
    class _hnt_CHOP_constraintobjectoffset extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintobjectoffset';
        static category = '/CHOP';
        static houdiniType = 'constraintobjectoffset';
        static title = 'Object Offset';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintobjectoffset.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "udpate", label: "Update Offset"});
    ...
    hou.registerType('CHOP/Constraints/constraintobjectoffset',_hnt_CHOP_constraintobjectoffset)
    return _hnt_CHOP_constraintobjectoffset
}
