...
export default function (hou) {
    class _hnt_COP2_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'COP2/Other/objnet';
        static category = '/COP2';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('COP2/Other/objnet',_hnt_COP2_objnet)
    return _hnt_COP2_objnet
}
