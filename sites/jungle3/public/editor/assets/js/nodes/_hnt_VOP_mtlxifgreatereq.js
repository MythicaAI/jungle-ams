...
export default function (hou) {
    class _hnt_VOP_mtlxifgreatereq extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Conditional/mtlxifgreatereq';
        static category = '/VOP';
        static houdiniType = 'mtlxifgreatereq';
        static title = 'MtlX If Greater or Equal';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxifgreatereq.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Conditional/mtlxifgreatereq',_hnt_VOP_mtlxifgreatereq)
    return _hnt_VOP_mtlxifgreatereq
}
