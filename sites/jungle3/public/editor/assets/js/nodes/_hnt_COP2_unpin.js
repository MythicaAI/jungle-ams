...
export default function (hou) {
    class _hnt_COP2_unpin extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/unpin';
        static category = '/COP2';
        static houdiniType = 'unpin';
        static title = 'Unpin';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_unpin.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "UnPin", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/unpin',_hnt_COP2_unpin)
    return _hnt_COP2_unpin
}
