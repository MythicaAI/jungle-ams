...
export default function (hou) {
    class _hnt_SHOP_singlesss_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/singlesss_eval';
        static category = '/SHOP';
        static houdiniType = 'singlesss_eval';
        static title = 'singlesss_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_singlesss_eval.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/singlesss_eval',_hnt_SHOP_singlesss_eval)
    return _hnt_SHOP_singlesss_eval
}
