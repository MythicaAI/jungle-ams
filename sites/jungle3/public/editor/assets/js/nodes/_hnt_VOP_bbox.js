...
export default function (hou) {
    class _hnt_VOP_bbox extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/bbox';
        static category = '/VOP';
        static houdiniType = 'bbox';
        static title = 'Bounding Box';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_bbox.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/bbox',_hnt_VOP_bbox)
    return _hnt_VOP_bbox
}
