...
export default function (hou) {
    class _hnt_CHOP_fan extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/fan';
        static category = '/CHOP';
        static houdiniType = 'fan';
        static title = 'Fan';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_fan.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Fan", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "fanop", label: "Operation", menu_items: ["out", "in"], menu_labels: ["Fan Out", "Fan In"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "channame", label: "Channel Names", num_components: 1, default_value: ["chan[1-8]"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "range", label: "Outside Range", menu_items: ["clamp", "loop", "zero"], menu_labels: ["Clamp Index", "Loop Index", "Set Channels To 0"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "alloff", label: "All Channels Off", menu_items: ["set0", "setneg"], menu_labels: ["Set To 0", "Set To -1"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/fan',_hnt_CHOP_fan)
    return _hnt_CHOP_fan
}
