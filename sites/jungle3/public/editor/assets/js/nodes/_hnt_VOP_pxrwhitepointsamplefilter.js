...
export default function (hou) {
    class _hnt_VOP_pxrwhitepointsamplefilter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrwhitepointsamplefilter';
        static category = '/VOP';
        static houdiniType = 'pxrwhitepointsamplefilter';
        static title = 'Pxr White Point Sample Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrwhitepointsamplefilter.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/pxrwhitepointsamplefilter',_hnt_VOP_pxrwhitepointsamplefilter)
    return _hnt_VOP_pxrwhitepointsamplefilter
}
