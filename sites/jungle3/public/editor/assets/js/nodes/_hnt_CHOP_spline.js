...
export default function (hou) {
    class _hnt_CHOP_spline extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/spline';
        static category = '/CHOP';
        static houdiniType = 'spline';
        static title = 'Spline';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_spline.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Spline", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "type", label: "Type", menu_items: ["bezier", "cubic"], menu_labels: ["Bezier", "Cubic"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "compute", label: "Compute Knots", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "tolerance", label: "Tolerance", num_components: 1, default_value: [0.05], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/spline',_hnt_CHOP_spline)
    return _hnt_CHOP_spline
}
