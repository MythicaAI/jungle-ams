...
export default function (hou) {
    class _hnt_TOP_filerename extends hou._HoudiniBase {
        static is_root = false;
        static id = 'TOP/Files/filerename';
        static category = '/TOP';
        static houdiniType = 'filerename';
        static title = 'File Rename';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_filerename.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.MenuParmTemplate({name: "pdg_cooktype", label: "Rename During", menu_items: ["0", "1", "2"], menu_labels: ["Generate", "Cook (In-Process)", "Cook (Out-of-Process)"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "renameduring", label: "Rename During", menu_items: ["0", "1", "2"], menu_labels: ["Generate", "Cook (In-Process)", "Cook (Out-of-Process)"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "originalpath", label: "File Path", num_components: 1, default_value: ["$HIP/source.txt"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ filesource == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "destination", label: "Destination", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "simple"});
			hou_parm_template3 = new hou.StringParmTemplate({name: "newpath", label: "File Path", num_components: 1, default_value: ["$HIP/dest.txt"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('TOP/Files/filerename',_hnt_TOP_filerename)
    return _hnt_TOP_filerename
}
