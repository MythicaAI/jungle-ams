...
export default function (hou) {
    class _hnt_VOP_mtlxluminance extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Adjustment/mtlxluminance';
        static category = '/VOP';
        static houdiniType = 'mtlxluminance';
        static title = 'MtlX Luminance';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxluminance.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Adjustment/mtlxluminance',_hnt_VOP_mtlxluminance)
    return _hnt_VOP_mtlxluminance
}
