...
export default function (hou) {
    class _hnt_COP2_diff extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/diff';
        static category = '/COP2';
        static houdiniType = 'diff';
        static title = 'Diff';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_diff.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Diff", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/diff',_hnt_COP2_diff)
    return _hnt_COP2_diff
}
