...
export default function (hou) {
    class _hnt_DOP_popsteercohesion extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popsteercohesion';
        static category = '/DOP';
        static houdiniType = 'popsteercohesion';
        static title = 'POP Steer Cohesion';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popsteercohesion.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "forcescale", label: "Force Scale", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "usefov", label: "Use Field of View", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "fov", label: "Field of View", num_components: 1, default_value: [120], min: 0, max: 360, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('DOP/POPs/popsteercohesion',_hnt_DOP_popsteercohesion)
    return _hnt_DOP_popsteercohesion
}
