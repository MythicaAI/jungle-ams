...
export default function (hou) {
    class _hnt_SHOP_principleddiffuse_sample extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/principleddiffuse_sample';
        static category = '/SHOP';
        static houdiniType = 'principleddiffuse_sample';
        static title = 'principleddiffuse_sample';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_principleddiffuse_sample.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "baseColor", label: "baseColor", num_components: 3, default_value: [0.5, 0.5, 0.5], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "sheen", label: "sheen", num_components: 3, default_value: [0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "subsurface", label: "subsurface", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SHOP/Other/principleddiffuse_sample',_hnt_SHOP_principleddiffuse_sample)
    return _hnt_SHOP_principleddiffuse_sample
}
