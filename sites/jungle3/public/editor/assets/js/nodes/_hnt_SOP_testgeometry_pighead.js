...
export default function (hou) {
    class _hnt_SOP_testgeometry_pighead extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Utility/Test Geometry/testgeometry_pighead';
        static category = '/SOP';
        static houdiniType = 'testgeometry_pighead';
        static title = 'Test Geometry: Pig Head';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_testgeometry_pighead.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Utility/Test Geometry/testgeometry_pighead',_hnt_SOP_testgeometry_pighead)
    return _hnt_SOP_testgeometry_pighead
}
