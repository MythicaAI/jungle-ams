...
export default function (hou) {
    class _hnt_VOP_npoints extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/npoints';
        static category = '/VOP';
        static houdiniType = 'npoints';
        static title = 'Point Count';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_npoints.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/npoints',_hnt_VOP_npoints)
    return _hnt_VOP_npoints
}
