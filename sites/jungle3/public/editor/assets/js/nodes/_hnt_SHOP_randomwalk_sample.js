...
export default function (hou) {
    class _hnt_SHOP_randomwalk_sample extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/randomwalk_sample';
        static category = '/SHOP';
        static houdiniType = 'randomwalk_sample';
        static title = 'randomwalk_sample';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_randomwalk_sample.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/randomwalk_sample',_hnt_SHOP_randomwalk_sample)
    return _hnt_SHOP_randomwalk_sample
}
