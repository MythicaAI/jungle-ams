...
export default function (hou) {
    class _hnt_SOP_paintcolorvolume extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Volume/paintcolorvolume';
        static category = '/SOP';
        static houdiniType = 'paintcolorvolume';
        static title = 'Volume Paint Color';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_paintcolorvolume.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "folder0", label: "Volume", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_2", label: "Projection", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_3", label: "Stroke", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Volume/paintcolorvolume',_hnt_SOP_paintcolorvolume)
    return _hnt_SOP_paintcolorvolume
}
