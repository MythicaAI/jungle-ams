...
export default function (hou) {
    class _hnt_COP2_composite extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/composite';
        static category = '/COP2';
        static houdiniType = 'composite';
        static title = 'Composite';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_composite.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation", menu_items: ["over", "under", "atop", "inside", "outside", "screen", "add", "sub", "diff", "mult", "min", "max", "avg", "xor"], menu_labels: ["Over", "Under", "Atop", "Inside", "Outside", "Screen", "Add", "Subtract", "Diff", "Multiply", "Minimum", "Maximum", "Average", "Exclusive Or"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "alphaop", label: "Alpha Operation", menu_items: ["usemain", "over", "under", "atop", "inside", "outside", "screen", "add", "sub", "diff", "mult", "min", "max", "avg", "xor"], menu_labels: ["Same As Above", "Over", "Under", "Atop", "Inside", "Outside", "Screen", "Add", "Subtract", "Diff", "Multiply", "Minimum", "Maximum", "Average", "Exclusive Or"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/composite',_hnt_COP2_composite)
    return _hnt_COP2_composite
}
