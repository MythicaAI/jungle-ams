...
export default function (hou) {
    class _hnt_CHOP_interp extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Other/interp';
        static category = '/CHOP';
        static houdiniType = 'interp';
        static title = 'Interpolate';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_interp.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Interpolate", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "blendfunc", label: "Shape", menu_items: ["lin", "ei", "eo", "cos", "cub", "add"], menu_labels: ["Linear", "Ease in", "Ease out", "Ease in Ease out", "Cubic", "Add"], default_value: 3, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "overlap", label: "Overlap Priority", menu_items: ["avg", "first", "last"], menu_labels: ["Average Overlaps", "First Segment has Priority", "Last Segment has Priority"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/interp',_hnt_CHOP_interp)
    return _hnt_CHOP_interp
}
