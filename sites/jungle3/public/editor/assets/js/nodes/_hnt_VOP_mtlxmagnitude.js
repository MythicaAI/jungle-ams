...
export default function (hou) {
    class _hnt_VOP_mtlxmagnitude extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxmagnitude';
        static category = '/VOP';
        static houdiniType = 'mtlxmagnitude';
        static title = 'MtlX Magnitude';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxmagnitude.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.FloatParmTemplate({name: "in", label: "Input", num_components: 2, default_value: [0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxmagnitude',_hnt_VOP_mtlxmagnitude)
    return _hnt_VOP_mtlxmagnitude
}
