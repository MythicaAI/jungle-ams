...
export default function (hou) {
    class _hnt_SHOP_vm_geo_enginecurvegen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/vm_geo_enginecurvegen';
        static category = '/SHOP';
        static houdiniType = 'vm_geo_enginecurvegen';
        static title = 'Houdini Engine: Curve Generation';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vm_geo_enginecurvegen.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vm_geo_enginecurvegen',_hnt_SHOP_vm_geo_enginecurvegen)
    return _hnt_SHOP_vm_geo_enginecurvegen
}
