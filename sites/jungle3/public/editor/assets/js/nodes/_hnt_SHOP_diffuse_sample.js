...
export default function (hou) {
    class _hnt_SHOP_diffuse_sample extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/diffuse_sample';
        static category = '/SHOP';
        static houdiniType = 'diffuse_sample';
        static title = 'diffuse_sample';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_diffuse_sample.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/diffuse_sample',_hnt_SHOP_diffuse_sample)
    return _hnt_SHOP_diffuse_sample
}
