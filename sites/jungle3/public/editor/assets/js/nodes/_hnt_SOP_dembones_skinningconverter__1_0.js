...
export default function (hou) {
    class _hnt_SOP_dembones_skinningconverter__1_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/File IO/Export/dembones_skinningconverter::1.0';
        static category = '/SOP';
        static houdiniType = 'dembones_skinningconverter::1.0';
        static title = 'Dem Bones Skinning Converter';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_dembones_skinningconverter__1_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setScriptCallback("kwargs['node'].hm().Convert(kwargs)");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"autoscope": "0000000000000000", "script_callback": "kwargs['node'].hm().Convert(kwargs)", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "sOutputFile", label: "Output File", num_components: 1, default_value: ["$HIP/out/${HIPNAME}_Converted.fbx"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l -a rop_dembones_skinningconverter1 sOutputFile", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringReplace});
			hou_parm_template.setTags({"autoscope": "0000000000000000", "filechooser_pattern": "*.fbx"});
			hou_parm_template_group.append(hou_parm_template);
			...
			let hou_parm_template2 = new hou.IntParmTemplate({name: "f", label: "Frame Range", num_components: 2, default_value: [0, 0], default_expression: ["$RFSTART", "$RFEND"], default_expression_language: [hou.scriptLanguage.Hscript, hou.scriptLanguage.Hscript], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "iBindposeFrame", label: "Bind Pose Frame", num_components: 1, default_value: [0], default_expression: ["$RFSTART"], default_expression_language: [hou.scriptLanguage.Hscript], min: 0, max: 200, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template2.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2 = new hou.StringParmTemplate({name: "sAnimatedCache", label: "Animated Cache", num_components: 1, default_value: ["$HOUDINI_TEMP_DIR/${HIPNAME}_${OS}.abc"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l -a rop_dembones_skinningconverter1 sAnimatedCache", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "filechooser_pattern": "*.abc"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "sBindPoseFBX", label: "Bindpose FBX", num_components: 1, default_value: ["$HOUDINI_TEMP_DIR/${HIPNAME}_${OS}.fbx"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Any, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l -a rop_dembones_skinningconverter1 sBindPoseFBX", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "filechooser_pattern": "*.fbx"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/File IO/Export/dembones_skinningconverter::1.0',_hnt_SOP_dembones_skinningconverter__1_0)
    return _hnt_SOP_dembones_skinningconverter__1_0
}
