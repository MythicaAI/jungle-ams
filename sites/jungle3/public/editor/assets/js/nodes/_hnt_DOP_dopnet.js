...
export default function (hou) {
    class _hnt_DOP_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'DOP/Other/dopnet';
        static category = '/DOP';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/dopnet',_hnt_DOP_dopnet)
    return _hnt_DOP_dopnet
}
