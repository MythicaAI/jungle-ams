...
export default function (hou) {
    class _hnt_VOP_uniqueval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/uniqueval';
        static category = '/VOP';
        static houdiniType = 'uniqueval';
        static title = 'Unique Value of Attribute';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/uniqueval',_hnt_VOP_uniqueval)
    return _hnt_VOP_uniqueval
}
