...
export default function (hou) {
    class _hnt_VOP_fromndcgeo extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/fromndcgeo';
        static category = '/VOP';
        static houdiniType = 'fromndcgeo';
    ...
    hou.registerType('VOP/Other/fromndcgeo',_hnt_VOP_fromndcgeo)
    return _hnt_VOP_fromndcgeo
}
