...
export default function (hou) {
    class _hnt_VOP_mtlxlight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Pbr/mtlxlight';
        static category = '/VOP';
        static houdiniType = 'mtlxlight';
        static title = 'MtlX Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxlight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "edf", label: "Edf", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('VOP/MaterialX/Pbr/mtlxlight',_hnt_VOP_mtlxlight)
    return _hnt_VOP_mtlxlight
}
