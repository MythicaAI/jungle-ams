...
export default function (hou) {
    class _hnt_DOP_wirewirecollider extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/wirewirecollider';
        static category = '/DOP';
        static houdiniType = 'wirewirecollider';
        static title = 'Wire/Wire Collider';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_wirewirecollider.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/wirewirecollider',_hnt_DOP_wirewirecollider)
    return _hnt_DOP_wirewirecollider
}
