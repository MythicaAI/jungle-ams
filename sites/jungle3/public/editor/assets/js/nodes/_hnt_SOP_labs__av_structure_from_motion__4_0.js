...
export default function (hou) {
    class _hnt_SOP_labs__av_structure_from_motion__4_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_structure_from_motion::4.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_structure_from_motion::4.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "lock", label: "Lock Scene Previously Reconstructed", default_value: false});
			hou_parm_template2.setHelp("This option is useful for SfM augmentation. Lock previous reconstructed poses and intrinsics.");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "local", label: "Local Bundle Adjustment", default_value: true});
			...
			hou_parm_template2.setHelp("Maximum number of matches per image pair (and per feature type). This can be useful to have a quick reconstruction overview. A value of 0 is no limit.");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "minInput", label: "Min Input Track Length", num_components: 1, default_value: [2], min: 2, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "filterTrackForks", label: "Filter Track Forks", default_value: false});
			hou_parm_template2.setHelp("This option is useful for SfM augmentation. Lock previous reconstructed poses and intrinsics.");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			let hou_parm_template3 = new hou.StringParmTemplate({name: "locl_es", label: "Localizer Estimator", num_components: 1, default_value: ["acransac"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["acransac", "ransac", "lsmeds", "loransac", "maxconsensus"], menu_labels: ["acransac", "ransac", "lsmeds", "loransac", "maxconsensus"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "fileExt", label: "Inter File Extension", num_components: 1, default_value: [".abc"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [".abc", ".ply"], menu_labels: [".abc", ".ply"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_1", label: "Prepare Dense Scene", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: true});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder3", label: "Environment", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_structure_from_motion::4.0',_hnt_SOP_labs__av_structure_from_motion__4_0)
    return _hnt_SOP_labs__av_structure_from_motion__4_0
}
