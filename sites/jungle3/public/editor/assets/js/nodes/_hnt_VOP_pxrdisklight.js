...
export default function (hou) {
    class _hnt_VOP_pxrdisklight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrdisklight';
        static category = '/VOP';
        static houdiniType = 'pxrdisklight';
        static title = 'Pxr Disk Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrdisklight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setTags({"script_ritype": "float"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "coneSoftness", label: "Cone Softness", num_components: 1, default_value: [0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('VOP/Other/pxrdisklight',_hnt_VOP_pxrdisklight)
    return _hnt_VOP_pxrdisklight
}
