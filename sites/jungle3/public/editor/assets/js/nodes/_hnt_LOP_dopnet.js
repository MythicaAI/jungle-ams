...
export default function (hou) {
    class _hnt_LOP_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'LOP/Other/dopnet';
        static category = '/LOP';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('LOP/Other/dopnet',_hnt_LOP_dopnet)
    return _hnt_LOP_dopnet
}
