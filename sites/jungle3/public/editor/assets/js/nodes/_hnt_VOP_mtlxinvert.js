...
export default function (hou) {
    class _hnt_VOP_mtlxinvert extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxinvert';
        static category = '/VOP';
        static houdiniType = 'mtlxinvert';
        static title = 'MtlX Invert';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxinvert.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxinvert',_hnt_VOP_mtlxinvert)
    return _hnt_VOP_mtlxinvert
}
