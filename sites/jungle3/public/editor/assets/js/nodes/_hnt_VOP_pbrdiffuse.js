...
export default function (hou) {
    class _hnt_VOP_pbrdiffuse extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Shading/pbrdiffuse';
        static category = '/VOP';
        static houdiniType = 'pbrdiffuse';
        static title = 'Physically Based Diffuse';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pbrdiffuse.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Shading/pbrdiffuse',_hnt_VOP_pbrdiffuse)
    return _hnt_VOP_pbrdiffuse
}
