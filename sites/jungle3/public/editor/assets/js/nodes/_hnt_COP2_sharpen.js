...
export default function (hou) {
    class _hnt_COP2_sharpen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/sharpen';
        static category = '/COP2';
        static houdiniType = 'sharpen';
        static title = 'Sharpen';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_sharpen.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Sharpen", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "ssize", label: "Size", num_components: 2, default_value: [3, 3], min: 0, max: 10, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "effect", label: "Effect", num_components: 1, default_value: [1], min: 0, max: 2, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "noisesuppress", label: "Noise Suppress", default_value: true});
			hou_parm_template2.hideLabel(true);
			hou_parm_template2.setJoinWithNext(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "threshold", label: "Noise Suppress Below", num_components: 1, default_value: [0.02], min: 0, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "suppressfunc", label: "Suppress Function", menu_items: ["sharp", "linear", "easein", "easeout", "halfcos", "gaussian"], menu_labels: ["Sharp Cutoff", "Linear", "Ease In", "Ease Out", "Ease In Ease Out", "Gaussian"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "suppressblend", label: "Suppress Blend", num_components: 1, default_value: [0.02], min: 0, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "edgesonly", label: "Show Edges Only", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/sharpen',_hnt_COP2_sharpen)
    return _hnt_COP2_sharpen
}
