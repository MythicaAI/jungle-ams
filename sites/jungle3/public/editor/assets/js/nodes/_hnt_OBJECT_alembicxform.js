...
export default function (hou) {
    class _hnt_OBJECT_alembicxform extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/File IO/Import/alembicxform';
        static category = '/OBJECT';
        static houdiniType = 'alembicxform';
        static title = 'Alembic Xform';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_alembicxform.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "objectPath", label: "Object Path", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "__import__('_alembic_hom_extensions').alembicGetObjectPathListForMenu(hou.pwd().hdaModule().GetFileName(hou.pwd()))", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "frame", label: "Frame", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "abcConstant", label: "Constant Alembic Transform", default_value: false});
			hou_parm_template.hide(true);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "fetchworldxform", label: "Fetch World Transform", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('OBJECT/File IO/Import/alembicxform',_hnt_OBJECT_alembicxform)
    return _hnt_OBJECT_alembicxform
}
