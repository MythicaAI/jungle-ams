...
export default function (hou) {
    class _hnt_SOP_attribvop extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Other/attribvop';
        static category = '/SOP';
        static houdiniType = 'attribvop';
        static title = 'Attribute VOP';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_attribvop.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/attribvop',_hnt_SOP_attribvop)
    return _hnt_SOP_attribvop
}
