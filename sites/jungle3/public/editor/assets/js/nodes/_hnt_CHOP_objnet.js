...
export default function (hou) {
    class _hnt_CHOP_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'CHOP/Other/objnet';
        static category = '/CHOP';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Other/objnet',_hnt_CHOP_objnet)
    return _hnt_CHOP_objnet
}
