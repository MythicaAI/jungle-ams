...
export default function (hou) {
    class _hnt_SOP_labs__av_texturing__4_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_texturing::4.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_texturing::4.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0", label: "Texturing", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: true});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "flipN", label: "Flip Normals", default_value: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder2", label: "Environment", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_texturing::4.0',_hnt_SOP_labs__av_texturing__4_0)
    return _hnt_SOP_labs__av_texturing__4_0
}
