...
export default function (hou) {
    class _hnt_VOP_mtlxUsdUVTexture extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Texture2D/mtlxUsdUVTexture';
        static category = '/VOP';
        static houdiniType = 'mtlxUsdUVTexture';
        static title = 'MtlX USD UV Texture';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxUsdUVTexture.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Texture2D/mtlxUsdUVTexture',_hnt_VOP_mtlxUsdUVTexture)
    return _hnt_VOP_mtlxUsdUVTexture
}
