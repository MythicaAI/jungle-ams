...
export default function (hou) {
    class _hnt_SOP_dopimportfield extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Dynamics/Data Import/dopimportfield';
        static category = '/SOP';
        static houdiniType = 'dopimportfield';
        static title = 'Dop Import Fields';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_dopimportfield.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Dynamics/Data Import/dopimportfield',_hnt_SOP_dopimportfield)
    return _hnt_SOP_dopimportfield
}
