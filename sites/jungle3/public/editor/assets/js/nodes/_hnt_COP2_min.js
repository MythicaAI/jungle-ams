...
export default function (hou) {
    class _hnt_COP2_min extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/min';
        static category = '/COP2';
        static houdiniType = 'min';
        static title = 'Min';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_min.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Min", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/min',_hnt_COP2_min)
    return _hnt_COP2_min
}
