...
export default function (hou) {
    class _hnt_SHOP_approxsss_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/approxsss_eval';
        static category = '/SHOP';
        static houdiniType = 'approxsss_eval';
        static title = 'approxsss_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_approxsss_eval.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/approxsss_eval',_hnt_SHOP_approxsss_eval)
    return _hnt_SHOP_approxsss_eval
}
