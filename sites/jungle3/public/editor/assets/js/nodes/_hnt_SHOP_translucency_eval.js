...
export default function (hou) {
    class _hnt_SHOP_translucency_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/translucency_eval';
        static category = '/SHOP';
        static houdiniType = 'translucency_eval';
        static title = 'translucency_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_translucency_eval.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/translucency_eval',_hnt_SHOP_translucency_eval)
    return _hnt_SHOP_translucency_eval
}
