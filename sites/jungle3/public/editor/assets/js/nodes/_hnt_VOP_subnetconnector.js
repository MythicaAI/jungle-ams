...
export default function (hou) {
    class _hnt_VOP_subnetconnector extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/subnetconnector';
        static category = '/VOP';
        static houdiniType = 'subnetconnector';
        static title = 'Subnet Input Connector';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_subnetconnector.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.MenuParmTemplate({name: "connectorkind", label: "Connector Kind", menu_items: ["input", "output", "inputoutput"], menu_labels: ["Input", "Output", "Input and Output"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "parmname", label: "Name", num_components: 1, default_value: ["parm"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/subnetconnector',_hnt_VOP_subnetconnector)
    return _hnt_VOP_subnetconnector
}
