...
export default function (hou) {
    class _hnt_CHOP_channel extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/channel';
        static category = '/CHOP';
        static houdiniType = 'channel';
        static title = 'Channel';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_channel.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Data", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.ToggleParmTemplate({name: "showall", label: "Show All Parameters", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "copytoexport", label: "Copy to Exports"});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "copyfromexport", label: "Copy from Exports"});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "updatealiases", label: "Channel Names from Exports"});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "sort", label: "Sort Channels"});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ButtonParmTemplate({name: "resetall", label: "Reset All Channels"});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "keypersample", label: "One Key Per Sample", default_value: false});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "adddeps", label: "Add Node Name Dependencies", default_value: true});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "numchannels", label: "Number of Channels", folder_type: hou.folderType.MultiparmBlock, default_value: 1, ends_tab_group: false});
			...
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "name#", label: "Name", num_components: 1, default_value: ["chan1"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "type#", label: "Type", menu_items: ["float", "euler"], menu_labels: ["Float", "Euler Rotation"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.hideLabel(true);
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.IntParmTemplate({name: "size#", label: "Size", num_components: 1, default_value: [1], min: 1, max: 4, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ showall == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "value#", label: "%s", num_components: 4, default_value: [0, 0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template3.setTags({"autoscope": "1111111111111111111111111111111"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2 = new hou.MenuParmTemplate({name: "range", label: "Channel Range", menu_items: ["full", "frame", "user", "value"], menu_labels: ["Use Full Animation Range", "Use Current Frame", "Use Start/End", "Use Value Animation"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "exacttime", label: "Ignore Sampling Rate", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/channel',_hnt_CHOP_channel)
    return _hnt_CHOP_channel
}
