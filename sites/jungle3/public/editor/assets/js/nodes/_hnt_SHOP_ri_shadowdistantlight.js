...
export default function (hou) {
    class _hnt_SHOP_ri_shadowdistantlight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/ri_shadowdistantlight';
        static category = '/SHOP';
        static houdiniType = 'ri_shadowdistantlight';
        static title = 'RSL Shadow Distant';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_ri_shadowdistantlight.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/ri_shadowdistantlight',_hnt_SHOP_ri_shadowdistantlight)
    return _hnt_SHOP_ri_shadowdistantlight
}
