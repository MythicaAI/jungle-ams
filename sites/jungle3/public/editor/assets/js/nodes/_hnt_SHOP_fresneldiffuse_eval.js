...
export default function (hou) {
    class _hnt_SHOP_fresneldiffuse_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/fresneldiffuse_eval';
        static category = '/SHOP';
        static houdiniType = 'fresneldiffuse_eval';
        static title = 'fresneldiffuse_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_fresneldiffuse_eval.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/fresneldiffuse_eval',_hnt_SHOP_fresneldiffuse_eval)
    return _hnt_SHOP_fresneldiffuse_eval
}
