...
export default function (hou) {
    class _hnt_SHOP_henyeygreenstein_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/henyeygreenstein_eval';
        static category = '/SHOP';
        static houdiniType = 'henyeygreenstein_eval';
        static title = 'henyeygreenstein_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_henyeygreenstein_eval.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/henyeygreenstein_eval',_hnt_SHOP_henyeygreenstein_eval)
    return _hnt_SHOP_henyeygreenstein_eval
}
