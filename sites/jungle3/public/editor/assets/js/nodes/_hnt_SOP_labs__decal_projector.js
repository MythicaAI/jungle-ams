...
export default function (hou) {
    class _hnt_SOP_labs__decal_projector extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Geometry/Mesh: Project/labs::decal_projector';
        static category = '/SOP/labs';
        static houdiniType = 'labs::decal_projector';
        static title = 'Labs Decal Projector';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__decal_projector.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Labs/Geometry/Mesh: Project/labs::decal_projector',_hnt_SOP_labs__decal_projector)
    return _hnt_SOP_labs__decal_projector
}
