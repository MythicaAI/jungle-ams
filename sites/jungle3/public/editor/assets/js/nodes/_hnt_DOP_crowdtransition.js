...
export default function (hou) {
    class _hnt_DOP_crowdtransition extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Crowds/crowdtransition';
        static category = '/DOP';
        static houdiniType = 'crowdtransition';
        static title = 'Crowd Transition';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_crowdtransition.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Crowds/crowdtransition',_hnt_DOP_crowdtransition)
    return _hnt_DOP_crowdtransition
}
