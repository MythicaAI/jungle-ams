...
export default function (hou) {
    class _hnt_COP2_median extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/median';
        static category = '/COP2';
        static houdiniType = 'median';
        static title = 'Median';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_median.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Median", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "fsize", label: "Filter Size", menu_items: ["3", "5"], menu_labels: ["3 x 3", "5 x 5"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
    ...
    hou.registerType('COP2/Other/median',_hnt_COP2_median)
    return _hnt_COP2_median
}
