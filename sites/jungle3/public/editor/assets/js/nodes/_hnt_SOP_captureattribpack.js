...
export default function (hou) {
    class _hnt_SOP_captureattribpack extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/captureattribpack';
        static category = '/SOP';
        static houdiniType = 'captureattribpack';
        static title = 'Capture Attribute Pack';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_captureattribpack.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "packproperties", label: "Pack Properties", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "packdata", label: "Pack Data", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "deletecapture", label: "Delete Array Attributes", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/captureattribpack',_hnt_SOP_captureattribpack)
    return _hnt_SOP_captureattribpack
}
