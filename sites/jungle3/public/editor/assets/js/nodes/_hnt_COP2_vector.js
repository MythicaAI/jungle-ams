...
export default function (hou) {
    class _hnt_COP2_vector extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/vector';
        static category = '/COP2';
        static houdiniType = 'vector';
        static title = 'Vector';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_vector.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Vector", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation", menu_items: ["normalize", "transform", "orient"], menu_labels: ["Normalize Vectors", "Transform Points", "Orient Vectors"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
    ...
    hou.registerType('COP2/Other/vector',_hnt_COP2_vector)
    return _hnt_COP2_vector
}
