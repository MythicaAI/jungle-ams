...
export default function (hou) {
    class _hnt_VOP_mtlxplus extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Compositing/mtlxplus';
        static category = '/VOP';
        static houdiniType = 'mtlxplus';
        static title = 'MtlX Plus';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxplus.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Compositing/mtlxplus',_hnt_VOP_mtlxplus)
    return _hnt_VOP_mtlxplus
}
