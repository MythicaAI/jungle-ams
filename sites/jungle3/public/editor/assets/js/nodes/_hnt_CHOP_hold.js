...
export default function (hou) {
    class _hnt_CHOP_hold extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/hold';
        static category = '/CHOP';
        static houdiniType = 'hold';
        static title = 'Hold';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_hold.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Common", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "scope", label: "Scope", num_components: 1, default_value: ["*"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
    ...
    hou.registerType('CHOP/Other/hold',_hnt_CHOP_hold)
    return _hnt_CHOP_hold
}
