...
export default function (hou) {
    class _hnt_DOP_anchortarget extends hou._HoudiniBase {
        static is_root = false;
        static id = 'DOP/Other/anchortarget';
        static category = '/DOP';
        static houdiniType = 'anchortarget';
        static title = 'Anchor: Target';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_anchortarget.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/anchortarget',_hnt_DOP_anchortarget)
    return _hnt_DOP_anchortarget
}
