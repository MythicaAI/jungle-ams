...
export default function (hou) {
    class _hnt_COP2_cornerramp extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/cornerramp';
        static category = '/COP2';
        static houdiniType = 'cornerramp';
        static title = 'Corner Ramp';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_cornerramp.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "CornerRamp", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "distance", label: "Point Distance", menu_items: ["radial", "block"], menu_labels: ["Radial", "Block"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "keepaspect", label: "Correct for Aspect Ratio", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "points", label: "Ramp Points", folder_type: hou.folderType.TabbedMultiparmBlock, default_value: 4, ends_tab_group: false});
			let hou_parm_template3 = new hou.FloatParmTemplate({name: "p#pos", label: "Point #", num_components: 2, default_value: [0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.UVW});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.FloatParmTemplate({name: "p#weight", label: "Weight", num_components: 1, default_value: [1], min: 0, max: 4, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/cornerramp',_hnt_COP2_cornerramp)
    return _hnt_COP2_cornerramp
}
