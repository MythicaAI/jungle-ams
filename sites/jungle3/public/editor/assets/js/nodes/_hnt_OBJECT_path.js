...
export default function (hou) {
    class _hnt_OBJECT_path extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/path';
        static category = '/OBJECT';
        static houdiniType = 'path';
        static title = 'Path';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_path.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/path',_hnt_OBJECT_path)
    return _hnt_OBJECT_path
}
