...
export default function (hou) {
    class _hnt_SOP_labs__av_analyze_images__4_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Integration/AliceVision/labs::av_analyze_images::4.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_analyze_images::4.0';
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template3 = new hou.ToggleParmTemplate({name: "cpu", label: "Force CPU Extraction", default_value: true});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.IntParmTemplate({name: "max_desc", label: "Max Descriptors", num_components: 1, default_value: [500], min: 0, max: 10000, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template3.setHelp("Limit the number of descriptors loaded per image. Zero means no limit.");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.IntParmTemplate({name: "nMatch", label: "Number of Matches", num_components: 1, default_value: [50], min: 0, max: 1000, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder0_2", label: "Feature Matching", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: true});
			hou_parm_template2 = new hou.StringParmTemplate({name: "dsc_type2", label: "Describer Types", num_components: 1, default_value: ["sift"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["sift", "sift_float", "sift_upright", "akaze", "akaze_liop", "akaze_midb", "cctag3", "cctag4", "sift_ocv", "akaze_ocv"], menu_labels: ["sift", "sift_float", "sift_upright", "akaze", "akaze_liop", "akaze_midb", "cctag3", "cctag4", "sift_ocv", "akaze_ocv"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle});
			hou_parm_template2.setHelp("Describer types used to describe an image.");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "guide", label: "Guided Matching", default_value: false});
			...
			hou_parm_template2.setTags({"group_type": "collapsible"});
			hou_parm_template3 = new hou.StringParmTemplate({name: "photo", label: "Photometric Matching Method", num_components: 1, default_value: ["ANN_L2"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["BRUTE_FORCE_L2", "ANN_L2", "CASCADE_HASHING_L2", "FAST_CASCADE_HASHING_L2", "BRUTE_FORCE_HAMMING"], menu_labels: ["BRUTE_FORCE_L2", "ANN_L2", "CASCADE_HASHING_L2", "FAST_CASCADE_HASHING_L2", "BRUTE_FORCE_HAMMING"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder4", label: "Environment", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('SOP/Labs/Integration/AliceVision/labs::av_analyze_images::4.0',_hnt_SOP_labs__av_analyze_images__4_0)
    return _hnt_SOP_labs__av_analyze_images__4_0
}
