...
export default function (hou) {
    class _hnt_COP2_vexgenerate extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/vexgenerate';
        static category = '/COP2';
        static houdiniType = 'vexgenerate';
        static title = 'VEX Generator';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_vexgenerate.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "VEX Generate", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "function", label: "VEX Function", num_components: 1, default_value: ["constant value 1 0 0 0"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('COP2/Other/vexgenerate',_hnt_COP2_vexgenerate)
    return _hnt_COP2_vexgenerate
}
