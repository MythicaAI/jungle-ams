...
export default function (hou) {
    class _hnt_VOP_mtlxLamaTranslucent extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Lama/mtlxLamaTranslucent';
        static category = '/VOP';
        static houdiniType = 'mtlxLamaTranslucent';
        static title = 'MtlX Lama Translucent';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxLamaTranslucent.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Lama/mtlxLamaTranslucent',_hnt_VOP_mtlxLamaTranslucent)
    return _hnt_VOP_mtlxLamaTranslucent
}
