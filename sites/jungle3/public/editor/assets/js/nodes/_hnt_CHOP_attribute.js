...
export default function (hou) {
    class _hnt_CHOP_attribute extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/attribute';
        static category = '/CHOP';
        static houdiniType = 'attribute';
        static title = 'Attribute';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_attribute.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Quaternion", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "slerp", label: "Function", menu_items: ["pass", "replace", "append", "remove"], menu_labels: ["Pass Through", "Replace", "Append", "Remove"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
    ...
    hou.registerType('CHOP/Other/attribute',_hnt_CHOP_attribute)
    return _hnt_CHOP_attribute
}
