...
export default function (hou) {
    class _hnt_CHOP_timeshift extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/timeshift';
        static category = '/CHOP';
        static houdiniType = 'timeshift';
        static title = 'Time Shift';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_timeshift.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Time Shift", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "relative", label: "Unit Values", menu_items: ["abs", "rel"], menu_labels: ["Absolute", "Relative to Current Frame"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "timeshift", label: "Time Shift", num_components: 1, default_value: [0], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "recomputeinput", label: "Recompute Input", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/timeshift',_hnt_CHOP_timeshift)
    return _hnt_CHOP_timeshift
}
