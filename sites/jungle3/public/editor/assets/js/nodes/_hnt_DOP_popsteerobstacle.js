...
export default function (hou) {
    class _hnt_DOP_popsteerobstacle extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popsteerobstacle';
        static category = '/DOP';
        static houdiniType = 'popsteerobstacle';
        static title = 'POP Steer Obstacle';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popsteerobstacle.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "avoidanceforcescale", label: "Avoidance Force", num_components: 1, default_value: [20], min: 0, max: 100, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "brakingforcescale", label: "Braking Force", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "forceseparation", label: "Force Separation", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('DOP/POPs/popsteerobstacle',_hnt_DOP_popsteerobstacle)
    return _hnt_DOP_popsteerobstacle
}
