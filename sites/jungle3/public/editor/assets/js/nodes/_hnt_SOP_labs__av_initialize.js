...
export default function (hou) {
    class _hnt_SOP_labs__av_initialize extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_initialize';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_initialize';
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_initialize',_hnt_SOP_labs__av_initialize)
    return _hnt_SOP_labs__av_initialize
}
