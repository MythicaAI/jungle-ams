...
export default function (hou) {
    class _hnt_VOP_kinefx__getpointtransform extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/KineFX/kinefx::getpointtransform';
        static category = '/VOP/kinefx';
        static houdiniType = 'kinefx::getpointtransform';
        static title = 'Get Point Transform';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kinefx__getpointtransform.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ signature == n }");
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "_srcstr", label: "Source String", num_components: 1, default_value: ["hou.phm().buildSourceString(hou.pwd())"], default_expression: ["hou.phm().buildSourceString(hou.pwd())"], default_expression_language: [hou.scriptLanguage.Python], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('VOP/KineFX/kinefx::getpointtransform',_hnt_VOP_kinefx__getpointtransform)
    return _hnt_VOP_kinefx__getpointtransform
}
