...
export default function (hou) {
    class _hnt_LOP_capsule extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Primitive/capsule';
        static category = '/LOP';
        static houdiniType = 'capsule';
        static title = 'Capsule';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_capsule.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "primtype", label: "Primitive Type", num_components: 1, default_value: ["UsdGeomCapsule"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createSchemaTypesMenu(True)", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
    ...
    hou.registerType('LOP/Primitive/capsule',_hnt_LOP_capsule)
    return _hnt_LOP_capsule
}
