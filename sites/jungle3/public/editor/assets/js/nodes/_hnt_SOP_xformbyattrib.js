...
export default function (hou) {
    class _hnt_SOP_xformbyattrib extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/xformbyattrib';
        static category = '/SOP';
        static houdiniType = 'xformbyattrib';
        static title = 'Transform by Attribute';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_xformbyattrib.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "deletexform", label: "Delete Transform Attribute", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/xformbyattrib',_hnt_SOP_xformbyattrib)
    return _hnt_SOP_xformbyattrib
}
