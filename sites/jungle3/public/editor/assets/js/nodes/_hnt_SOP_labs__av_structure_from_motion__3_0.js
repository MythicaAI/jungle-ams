...
export default function (hou) {
    class _hnt_SOP_labs__av_structure_from_motion__3_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_structure_from_motion::3.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_structure_from_motion::3.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "evCorrection", label: "Correct images exposure", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_structure_from_motion::3.0',_hnt_SOP_labs__av_structure_from_motion__3_0)
    return _hnt_SOP_labs__av_structure_from_motion__3_0
}
