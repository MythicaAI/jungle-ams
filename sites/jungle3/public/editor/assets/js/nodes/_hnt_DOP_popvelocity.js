...
export default function (hou) {
    class _hnt_DOP_popvelocity extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popvelocity';
        static category = '/DOP';
        static houdiniType = 'popvelocity';
        static title = 'POP Velocity';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popvelocity.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "v", label: "Velocity", num_components: 3, default_value: [0, 0, 0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Vector, naming_scheme: hou.parmNamingScheme.XYZW});
    ...
    hou.registerType('DOP/POPs/popvelocity',_hnt_DOP_popvelocity)
    return _hnt_DOP_popvelocity
}
