...
export default function (hou) {
    class _hnt_VOP_pxrcopyaovdisplayfilter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrcopyaovdisplayfilter';
        static category = '/VOP';
        static houdiniType = 'pxrcopyaovdisplayfilter';
        static title = 'Pxr Copy AOV Display Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrcopyaovdisplayfilter.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/pxrcopyaovdisplayfilter',_hnt_VOP_pxrcopyaovdisplayfilter)
    return _hnt_VOP_pxrcopyaovdisplayfilter
}
