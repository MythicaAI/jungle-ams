...
export default function (hou) {
    class _hnt_VOP_mtlxpower extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxpower';
        static category = '/VOP';
        static houdiniType = 'mtlxpower';
        static title = 'MtlX Power';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxpower.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxpower',_hnt_VOP_mtlxpower)
    return _hnt_VOP_mtlxpower
}
