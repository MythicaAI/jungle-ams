...
export default function (hou) {
    class _hnt_VOP_pxrgeometricaovs extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/pxrgeometricaovs';
        static category = '/VOP';
        static houdiniType = 'pxrgeometricaovs';
        static title = 'Pxr Geometric AOVs';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pxrgeometricaovs.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.IntParmTemplate({name: "inputAOV", label: "Input AOV", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template2.setHelp("This input can only be used to daisy-chain other nodes that don't produce any output");
			...
			hou_parm_template2.setHelp("Controls MatteID AOV output");
			hou_parm_template2.setTags({"script_ritype": "int"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('VOP/Other/pxrgeometricaovs',_hnt_VOP_pxrgeometricaovs)
    return _hnt_VOP_pxrgeometricaovs
}
