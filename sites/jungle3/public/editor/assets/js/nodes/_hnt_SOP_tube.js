...
export default function (hou) {
    class _hnt_SOP_tube extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/tube';
        static category = '/SOP';
        static houdiniType = 'tube';
        static title = 'Tube';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_tube.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.MenuParmTemplate({name: "type", label: "Primitive Type", menu_items: ["prim", "poly", "mesh", "nurbs", "bezier", "polysoup"], menu_labels: ["Primitive", "Polygon", "Mesh", "NURBS", "Bezier", "Polygon Soup"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ type == prim }");
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "cap", label: "End Caps", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ cap == 0 } { type != poly type != polysoup }");
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ hasinput(0) != 0 }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "rad", label: "Radius", num_components: 2, default_value: [1, 1], min: 0, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ hasinput(0) != 0 }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "radscale", label: "Radius Scale", num_components: 1, default_value: [1], min: 0, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ hasinput(0) != 0 }");
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ hasinput(0) != 0 }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "rows", label: "Rows", num_components: 1, default_value: [2], min: 2, max: 50, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ type == prim }");
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "cols", label: "Columns", num_components: 1, default_value: [12], min: 3, max: 50, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ type == prim } { type == bezier imperfect == 0 } { type == nurbs imperfect == 0 }");
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/tube',_hnt_SOP_tube)
    return _hnt_SOP_tube
}
