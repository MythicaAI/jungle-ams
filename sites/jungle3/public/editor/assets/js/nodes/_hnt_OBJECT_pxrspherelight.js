...
export default function (hou) {
    class _hnt_OBJECT_pxrspherelight extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Render/pxrspherelight';
        static category = '/OBJECT';
        static houdiniType = 'pxrspherelight';
        static title = 'Pxr Sphere Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_pxrspherelight.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.StringParmTemplate({name: "ri_lighttype", label: "Light Type", num_components: 1, default_value: ["sphere"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.hide(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('OBJECT/Render/pxrspherelight',_hnt_OBJECT_pxrspherelight)
    return _hnt_OBJECT_pxrspherelight
}
