...
export default function (hou) {
    class _hnt_COP2_degrain extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/degrain';
        static category = '/COP2';
        static houdiniType = 'degrain';
        static title = 'Degrain';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_degrain.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Degrain", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.IntParmTemplate({name: "level", label: "Degrain Level", num_components: 1, default_value: [1], min: 0, max: 9, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
    ...
    hou.registerType('COP2/Other/degrain',_hnt_COP2_degrain)
    return _hnt_COP2_degrain
}
