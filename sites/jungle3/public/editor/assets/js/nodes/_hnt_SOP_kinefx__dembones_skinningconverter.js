...
export default function (hou) {
    class _hnt_SOP_kinefx__dembones_skinningconverter extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/kinefx::dembones_skinningconverter';
        static category = '/SOP/kinefx';
        static houdiniType = 'kinefx::dembones_skinningconverter';
        static title = 'Dem Bones Skinning Converter';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_kinefx__dembones_skinningconverter.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "folder2", label: "Conversion Settings", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.hide(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "createroot", label: "Create Root", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			hou_parm_template2.hide(true);
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Other/kinefx::dembones_skinningconverter',_hnt_SOP_kinefx__dembones_skinningconverter)
    return _hnt_SOP_kinefx__dembones_skinningconverter
}
