...
export default function (hou) {
    class _hnt_DOP_rbdobject extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Objects/rbdobject';
        static category = '/DOP';
        static houdiniType = 'rbdobject';
        static title = 'RBD Object';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_rbdobject.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "bullet_showguide", label: "Show Guide Geometry", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ autofit == 1 } { objType >= 4 } { enableode == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ autofit == 1 } { objType != 0 } { enableode == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ autofit == 1 } { objType == 0 } { objType >= 4 } { enableode == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ autofit == 1 } { objType <= 1 } { objType >= 4 } { enableode == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Objects/rbdobject',_hnt_DOP_rbdobject)
    return _hnt_DOP_rbdobject
}
