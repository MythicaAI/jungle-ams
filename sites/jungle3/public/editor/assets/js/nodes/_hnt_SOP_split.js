...
export default function (hou) {
    class _hnt_SOP_split extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Geometry/split';
        static category = '/SOP';
        static houdiniType = 'split';
        static title = 'Split';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_split.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"autoscope": "0000000000000000", "script_callback": ""});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "removegrp", label: "Delete Unused Groups", default_value: false, default_expression: "off", default_expression_language: hou.scriptLanguage.Hscript});
    ...
    hou.registerType('SOP/Geometry/split',_hnt_SOP_split)
    return _hnt_SOP_split
}
