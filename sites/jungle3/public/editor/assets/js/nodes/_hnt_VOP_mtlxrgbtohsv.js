...
export default function (hou) {
    class _hnt_VOP_mtlxrgbtohsv extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Adjustment/mtlxrgbtohsv';
        static category = '/VOP';
        static houdiniType = 'mtlxrgbtohsv';
        static title = 'MtlX RGB to HSV';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxrgbtohsv.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Adjustment/mtlxrgbtohsv',_hnt_VOP_mtlxrgbtohsv)
    return _hnt_VOP_mtlxrgbtohsv
}
