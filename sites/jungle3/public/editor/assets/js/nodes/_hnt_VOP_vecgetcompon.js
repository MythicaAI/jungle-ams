...
export default function (hou) {
    class _hnt_VOP_vecgetcompon extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/vecgetcompon';
        static category = '/VOP';
        static houdiniType = 'vecgetcompon';
        static title = 'Get Vector Component';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_vecgetcompon.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "vec_c", label: "Input", num_components: 3, default_value: [0, 0, 0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "vec_v4", label: "Input", num_components: 4, default_value: [0, 0, 0, 0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "vec_uc", label: "Input", num_components: 3, default_value: [0, 0, 0], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/vecgetcompon',_hnt_VOP_vecgetcompon)
    return _hnt_VOP_vecgetcompon
}
