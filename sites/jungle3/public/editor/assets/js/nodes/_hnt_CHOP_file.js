...
export default function (hou) {
    class _hnt_CHOP_file extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/file';
        static category = '/CHOP';
        static houdiniType = 'file';
        static title = 'File';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_file.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "File", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.StringParmTemplate({name: "file", label: "Channel File", num_components: 1, default_value: ["untitled.bclip"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Clip, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "nameoption", label: "Name Options", menu_items: ["infile", "new", "filename"], menu_labels: ["Use Names In File", "Use New Names", "Use Filename"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "name", label: "Name", num_components: 1, default_value: ["chan0"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/file',_hnt_CHOP_file)
    return _hnt_CHOP_file
}
