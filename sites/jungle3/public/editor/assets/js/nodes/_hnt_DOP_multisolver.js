...
export default function (hou) {
    class _hnt_DOP_multisolver extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/multisolver';
        static category = '/DOP';
        static houdiniType = 'multisolver';
        static title = 'Multiple Solver';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_multisolver.svg';
        constructor() {
            super();
    ...
    hou.registerType('DOP/Other/multisolver',_hnt_DOP_multisolver)
    return _hnt_DOP_multisolver
}
