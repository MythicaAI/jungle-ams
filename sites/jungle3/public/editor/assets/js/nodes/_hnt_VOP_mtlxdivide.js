...
export default function (hou) {
    class _hnt_VOP_mtlxdivide extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxdivide';
        static category = '/VOP';
        static houdiniType = 'mtlxdivide';
        static title = 'MtlX Divide';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxdivide.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxdivide',_hnt_VOP_mtlxdivide)
    return _hnt_VOP_mtlxdivide
}
