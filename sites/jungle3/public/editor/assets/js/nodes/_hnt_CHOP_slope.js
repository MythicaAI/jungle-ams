...
export default function (hou) {
    class _hnt_CHOP_slope extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/slope';
        static category = '/CHOP';
        static houdiniType = 'slope';
        static title = 'Slope';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_slope.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Slope", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "type", label: "Type", menu_items: ["slope", "accel", "slacc"], menu_labels: ["Slope", "Acceleration", "Acceleration Of Slope"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "method", label: "Method", menu_items: ["pc", "cn", "pn"], menu_labels: ["Use Previous And Current Sample", "Use Current And Next Sample", "Use Previous And Next Sample"], default_value: 1, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/slope',_hnt_CHOP_slope)
    return _hnt_CHOP_slope
}
