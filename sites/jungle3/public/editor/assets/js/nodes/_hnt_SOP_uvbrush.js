...
export default function (hou) {
    class _hnt_SOP_uvbrush extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/uvbrush';
        static category = '/SOP';
        static houdiniType = 'uvbrush';
        static title = 'UV Brush';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_uvbrush.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "foreback", label: "", menu_items: ["off", "on"], menu_labels: ["off", "on"], default_value: 1, default_expression: "Foreground Scale", default_expression_language: hou.scriptLanguage.Hscript, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "fs", label: "FS", num_components: 1, default_value: [1.05], min: 0.9, max: 1.1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "bs", label: "BS", num_components: 1, default_value: [0.95], min: 0.9, max: 1.1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2 = new hou.MenuParmTemplate({name: "op", label: "Operation for All", menu_items: ["dragpoints", "scale", "smoothattrib", "erase"], menu_labels: ["Drag", "Dilate/Contract", "Smooth", "Erase Changes"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "symaxis", label: "Axis", num_components: 3, default_value: [0, 0, 1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Vector, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('SOP/Other/uvbrush',_hnt_SOP_uvbrush)
    return _hnt_SOP_uvbrush
}
