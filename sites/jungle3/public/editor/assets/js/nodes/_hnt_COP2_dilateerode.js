...
export default function (hou) {
    class _hnt_COP2_dilateerode extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/dilateerode';
        static category = '/COP2';
        static houdiniType = 'dilateerode';
        static title = 'DilateErode';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_dilateerode.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Dilate/Erode", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.IntParmTemplate({name: "size", label: "Size", num_components: 1, default_value: [3], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "sizey", label: "Y Size", num_components: 1, default_value: [3], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/dilateerode',_hnt_COP2_dilateerode)
    return _hnt_COP2_dilateerode
}
