...
export default function (hou) {
    class _hnt_VOP_kma_roundededge extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Shading (Utilities)/kma_roundededge';
        static category = '/VOP';
        static houdiniType = 'kma_roundededge';
        static title = 'Karma Rounded Edge';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kma_roundededge.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Shading (Utilities)/kma_roundededge',_hnt_VOP_kma_roundededge)
    return _hnt_VOP_kma_roundededge
}
