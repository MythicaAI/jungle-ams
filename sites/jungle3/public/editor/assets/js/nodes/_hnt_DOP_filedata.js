...
export default function (hou) {
    class _hnt_DOP_filedata extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/filedata';
        static category = '/DOP';
        static houdiniType = 'filedata';
        static title = 'File Data';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_filedata.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.IntParmTemplate({name: "mode", label: "Operation Mode", num_components: 1, default_value: [3], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: ["auto", "read", "write", "none"], menu_labels: ["Automatic", "Read Files", "Write Files", "No Operation"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "file", label: "File", num_components: 1, default_value: ["./baked$SF4.$OBJID.`strreplace(chs(\"dataname\"), \"/\", \"_\")`.simdata"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.SimData, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "newdataonly", label: "Load or Save New Data Only", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/filedata',_hnt_DOP_filedata)
    return _hnt_DOP_filedata
}
