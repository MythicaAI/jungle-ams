...
export default function (hou) {
    class _hnt_VOP_transpose extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/transpose';
        static category = '/VOP';
        static houdiniType = 'transpose';
    ...
    hou.registerType('VOP/Other/transpose',_hnt_VOP_transpose)
    return _hnt_VOP_transpose
}
