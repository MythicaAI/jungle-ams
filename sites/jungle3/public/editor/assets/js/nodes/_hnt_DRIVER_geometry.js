...
export default function (hou) {
    class _hnt_DRIVER_geometry extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DRIVER/Other/geometry';
        static category = '/DRIVER';
        static houdiniType = 'geometry';
        static title = 'Geometry';
        static icon = '/editor/assets/imgs/nodes/_hnt_DRIVER_geometry.svg';
        constructor() {
            super();
    ...
    hou.registerType('DRIVER/Other/geometry',_hnt_DRIVER_geometry)
    return _hnt_DRIVER_geometry
}
