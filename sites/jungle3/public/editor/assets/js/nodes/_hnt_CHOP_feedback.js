...
export default function (hou) {
    class _hnt_CHOP_feedback extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/feedback';
        static category = '/CHOP';
        static houdiniType = 'feedback';
        static title = 'Feedback';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_feedback.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Feedback", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "output", label: "Output", menu_items: ["previous", "shift", "sample"], menu_labels: ["Previous Channels at Previous Time", "Previous Channels at Current Time", "Last Sample at Current Time"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "delta", label: "Delta Time", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/feedback',_hnt_CHOP_feedback)
    return _hnt_CHOP_feedback
}
