...
export default function (hou) {
    class _hnt_SHOP_diffuse_eval extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/diffuse_eval';
        static category = '/SHOP';
        static houdiniType = 'diffuse_eval';
        static title = 'diffuse_eval';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_diffuse_eval.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "sigma", label: "sigma", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "translucent", label: "translucent", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SHOP/Other/diffuse_eval',_hnt_SHOP_diffuse_eval)
    return _hnt_SHOP_diffuse_eval
}
