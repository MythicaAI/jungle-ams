...
export default function (hou) {
    class _hnt_VOP_ch extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/ch';
        static category = '/VOP';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "parm", label: "Parameter", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/ch',_hnt_VOP_ch)
    return _hnt_VOP_ch
}
