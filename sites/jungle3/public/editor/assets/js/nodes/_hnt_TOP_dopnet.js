...
export default function (hou) {
    class _hnt_TOP_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'TOP/Other/dopnet';
        static category = '/TOP';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_TOP_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('TOP/Other/dopnet',_hnt_TOP_dopnet)
    return _hnt_TOP_dopnet
}
