...
export default function (hou) {
    class _hnt_COP2_quantize extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/quantize';
        static category = '/COP2';
        static houdiniType = 'quantize';
        static title = 'Quantize';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_quantize.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Quantize", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "step", label: "Pixel Step", num_components: 1, default_value: [0.1], min: 0.0001, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Logarithmic, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "offset", label: "Pixel Offset", num_components: 1, default_value: [0.5], min: 0, max: 1, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/quantize',_hnt_COP2_quantize)
    return _hnt_COP2_quantize
}
