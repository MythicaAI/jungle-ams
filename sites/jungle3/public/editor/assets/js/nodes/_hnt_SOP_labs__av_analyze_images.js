...
export default function (hou) {
    class _hnt_SOP_labs__av_analyze_images extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Pipeline/Integration/AliceVision/labs::av_analyze_images';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_analyze_images';
    ...
    hou.registerType('SOP/Labs/Pipeline/Integration/AliceVision/labs::av_analyze_images',_hnt_SOP_labs__av_analyze_images)
    return _hnt_SOP_labs__av_analyze_images
}
