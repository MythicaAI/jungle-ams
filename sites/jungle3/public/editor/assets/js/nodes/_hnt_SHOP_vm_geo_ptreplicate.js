...
export default function (hou) {
    class _hnt_SHOP_vm_geo_ptreplicate extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/vm_geo_ptreplicate';
        static category = '/SHOP';
        static houdiniType = 'vm_geo_ptreplicate';
        static title = 'Point Replicate Procedural';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vm_geo_ptreplicate.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "unpack", label: "Unpack Iterations", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SHOP/Other/vm_geo_ptreplicate',_hnt_SHOP_vm_geo_ptreplicate)
    return _hnt_SHOP_vm_geo_ptreplicate
}
