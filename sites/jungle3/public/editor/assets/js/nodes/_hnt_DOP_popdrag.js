...
export default function (hou) {
    class _hnt_DOP_popdrag extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popdrag';
        static category = '/DOP';
        static houdiniType = 'popdrag';
        static title = 'POP Drag';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popdrag.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "windvelocity", label: "Wind Velocity", num_components: 3, default_value: [0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('DOP/POPs/popdrag',_hnt_DOP_popdrag)
    return _hnt_DOP_popdrag
}
