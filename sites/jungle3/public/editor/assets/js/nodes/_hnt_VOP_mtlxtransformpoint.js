...
export default function (hou) {
    class _hnt_VOP_mtlxtransformpoint extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxtransformpoint';
        static category = '/VOP';
        static houdiniType = 'mtlxtransformpoint';
        static title = 'MtlX Transform Point';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxtransformpoint.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxtransformpoint',_hnt_VOP_mtlxtransformpoint)
    return _hnt_VOP_mtlxtransformpoint
}
