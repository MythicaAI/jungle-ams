...
export default function (hou) {
    class _hnt_COP2_max extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/max';
        static category = '/COP2';
        static houdiniType = 'max';
        static title = 'Max';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_max.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Max", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/max',_hnt_COP2_max)
    return _hnt_COP2_max
}
