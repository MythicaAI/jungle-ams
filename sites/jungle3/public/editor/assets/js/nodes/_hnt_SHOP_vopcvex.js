...
export default function (hou) {
    class _hnt_SHOP_vopcvex extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/vopcvex';
        static category = '/SHOP';
        static houdiniType = 'vopcvex';
        static title = 'CVEX Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vopcvex.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vopcvex',_hnt_SHOP_vopcvex)
    return _hnt_SHOP_vopcvex
}
