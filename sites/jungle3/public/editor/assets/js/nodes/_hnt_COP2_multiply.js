...
export default function (hou) {
    class _hnt_COP2_multiply extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/multiply';
        static category = '/COP2';
        static houdiniType = 'multiply';
        static title = 'Multiply';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_multiply.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Multiply", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/multiply',_hnt_COP2_multiply)
    return _hnt_COP2_multiply
}
