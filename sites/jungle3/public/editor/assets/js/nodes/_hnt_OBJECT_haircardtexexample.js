...
export default function (hou) {
    class _hnt_OBJECT_haircardtexexample extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/haircardtexexample';
        static category = '/OBJECT';
        static houdiniType = 'haircardtexexample';
        static title = 'Hair Card Texture Example';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_haircardtexexample.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/haircardtexexample',_hnt_OBJECT_haircardtexexample)
    return _hnt_OBJECT_haircardtexexample
}
