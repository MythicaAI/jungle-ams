...
export default function (hou) {
    class _hnt_CHOP_ropnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'CHOP/Other/ropnet';
        static category = '/CHOP';
        static houdiniType = 'ropnet';
        static title = 'ROP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_ropnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('CHOP/Other/ropnet',_hnt_CHOP_ropnet)
    return _hnt_CHOP_ropnet
}
