...
export default function (hou) {
    class _hnt_CHOP_constraintsequence extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintsequence';
        static category = '/CHOP';
        static houdiniType = 'constraintsequence';
        static title = 'Sequence';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintsequence.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Constraint Sequence", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "blend", label: "Blend", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setTags({"autoscope": "1000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "rotblend", label: "Rotation Blending", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: ["0", "1", "3"], menu_labels: ["Euler", "Shortest Path", "Euler (Raw Angles)"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Constraints/constraintsequence',_hnt_CHOP_constraintsequence)
    return _hnt_CHOP_constraintsequence
}
