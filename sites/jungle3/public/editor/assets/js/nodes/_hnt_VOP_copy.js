...
export default function (hou) {
    class _hnt_VOP_copy extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/copy';
        static category = '/VOP';
        static houdiniType = 'copy';
        static title = 'Copy';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_copy.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/copy',_hnt_VOP_copy)
    return _hnt_VOP_copy
}
