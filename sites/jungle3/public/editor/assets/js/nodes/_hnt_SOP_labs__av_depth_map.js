...
export default function (hou) {
    class _hnt_SOP_labs__av_depth_map extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/AliceVision/labs::av_depth_map';
        static category = '/SOP/labs';
        static houdiniType = 'labs::av_depth_map';
    ...
    hou.registerType('SOP/Labs/AliceVision/labs::av_depth_map',_hnt_SOP_labs__av_depth_map)
    return _hnt_SOP_labs__av_depth_map
}
