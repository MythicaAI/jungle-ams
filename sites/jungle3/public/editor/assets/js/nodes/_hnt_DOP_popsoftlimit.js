...
export default function (hou) {
    class _hnt_DOP_popsoftlimit extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/POPs/popsoftlimit';
        static category = '/DOP';
        static houdiniType = 'popsoftlimit';
        static title = 'POP Soft Limit';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_popsoftlimit.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "type", label: "Type", menu_items: ["box", "sphere"], menu_labels: ["Box", "Sphere"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "force", label: "Force", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "vscale", label: "Dampening", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('DOP/POPs/popsoftlimit',_hnt_DOP_popsoftlimit)
    return _hnt_DOP_popsoftlimit
}
