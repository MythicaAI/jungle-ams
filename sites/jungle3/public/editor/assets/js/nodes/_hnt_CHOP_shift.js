...
export default function (hou) {
    class _hnt_CHOP_shift extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/shift';
        static category = '/CHOP';
        static houdiniType = 'shift';
        static title = 'Shift';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_shift.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "reference", label: "Reference", menu_items: ["refstart", "refend"], menu_labels: ["Start Position", "End Position"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "scroll", label: "Scroll Offset", num_components: 1, default_value: [0], min: null, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/shift',_hnt_CHOP_shift)
    return _hnt_CHOP_shift
}
