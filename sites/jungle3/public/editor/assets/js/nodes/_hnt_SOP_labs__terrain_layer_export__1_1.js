...
export default function (hou) {
    class _hnt_SOP_labs__terrain_layer_export__1_1 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Game Engine/labs::terrain_layer_export::1.1';
        static category = '/SOP/labs';
        static houdiniType = 'labs::terrain_layer_export::1.1';
        static title = 'Labs Terrain Layer Export';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__terrain_layer_export__1_1.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "fd_export", label: "Export", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "output", label: "Export Folder", num_components: 1, default_value: ["$HIP/export/"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Directory, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "filechooser_mode": "read"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.LabelParmTemplate({name: "labelparm", label: "Voxel Size", column_labels: ["`detail(\"./detailwrangle1\", \"__voxeldiameter\", 0)`"]});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "fd_layers", label: "Layers", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template.setTags({"group_type": "simple"});
    ...
    hou.registerType('SOP/Labs/Game Engine/labs::terrain_layer_export::1.1',_hnt_SOP_labs__terrain_layer_export__1_1)
    return _hnt_SOP_labs__terrain_layer_export__1_1
}
