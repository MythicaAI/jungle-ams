...
export default function (hou) {
    class _hnt_COP2_mask extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/mask';
        static category = '/COP2';
        static houdiniType = 'mask';
        static title = 'Mask';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_mask.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Mask", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.FloatParmTemplate({name: "effectamount", label: "Effect Amount", num_components: 1, default_value: [1], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('COP2/Other/mask',_hnt_COP2_mask)
    return _hnt_COP2_mask
}
