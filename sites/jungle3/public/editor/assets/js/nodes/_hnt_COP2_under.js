...
export default function (hou) {
    class _hnt_COP2_under extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/under';
        static category = '/COP2';
        static houdiniType = 'under';
        static title = 'Under';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_under.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Under", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/under',_hnt_COP2_under)
    return _hnt_COP2_under
}
