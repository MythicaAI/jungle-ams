...
export default function (hou) {
    class _hnt_CHOP_extend extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Other/extend';
        static category = '/CHOP';
        static houdiniType = 'extend';
        static title = 'Extend';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_extend.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Extend", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.MenuParmTemplate({name: "left", label: "Left Behavior", menu_items: ["asis", "hold", "slope", "cycle", "mirror", "default", "cyclestep"], menu_labels: ["No Change", "Hold", "Slope", "Cycle", "Mirror", "Default Value", "Cycle with Offset"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "right", label: "Right Behavior", menu_items: ["asis", "hold", "slope", "cycle", "mirror", "default", "cyclestep"], menu_labels: ["No Change", "Hold", "Slope", "Cycle", "Mirror", "Default Value", "Cycle with Offset"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/extend',_hnt_CHOP_extend)
    return _hnt_CHOP_extend
}
