...
export default function (hou) {
    class _hnt_VOP_mtlxsubtract extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxsubtract';
        static category = '/VOP';
        static houdiniType = 'mtlxsubtract';
        static title = 'MtlX Subtract';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxsubtract.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxsubtract',_hnt_VOP_mtlxsubtract)
    return _hnt_VOP_mtlxsubtract
}
