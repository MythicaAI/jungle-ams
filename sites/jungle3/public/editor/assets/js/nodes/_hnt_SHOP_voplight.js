...
export default function (hou) {
    class _hnt_SHOP_voplight extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SHOP/Other/voplight';
        static category = '/SHOP';
        static houdiniType = 'voplight';
        static title = 'Light Shader Builder';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_voplight.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/voplight',_hnt_SHOP_voplight)
    return _hnt_SHOP_voplight
}
