...
export default function (hou) {
    class _hnt_VOP_kinefx__getpointparent extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/KineFX/kinefx::getpointparent';
        static category = '/VOP/kinefx';
        static houdiniType = 'kinefx::getpointparent';
        static title = 'Get Parent';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_kinefx__getpointparent.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/KineFX/kinefx::getpointparent',_hnt_VOP_kinefx__getpointparent)
    return _hnt_VOP_kinefx__getpointparent
}
