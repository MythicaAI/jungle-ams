...
export default function (hou) {
    class _hnt_DOP_gasadvectcl__2_0 extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'DOP/Other/gasadvectcl::2.0';
        static category = '/DOP';
        static houdiniType = 'gasadvectcl::2.0';
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "maxbatchsize", label: "Max Batch Size", num_components: 1, default_value: [1], min: 1, max: 3, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('DOP/Other/gasadvectcl::2.0',_hnt_DOP_gasadvectcl__2_0)
    return _hnt_DOP_gasadvectcl__2_0
}
