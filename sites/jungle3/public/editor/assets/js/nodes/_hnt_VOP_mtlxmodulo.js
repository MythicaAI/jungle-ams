...
export default function (hou) {
    class _hnt_VOP_mtlxmodulo extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxmodulo';
        static category = '/VOP';
        static houdiniType = 'mtlxmodulo';
        static title = 'MtlX Modulo';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxmodulo.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxmodulo',_hnt_VOP_mtlxmodulo)
    return _hnt_VOP_mtlxmodulo
}
