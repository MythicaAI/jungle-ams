...
export default function (hou) {
    class _hnt_LOP_pointsconstraint extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'LOP/Constraints/pointsconstraint';
        static category = '/LOP';
        static houdiniType = 'pointsconstraint';
        static title = 'Points Constraint';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_pointsconstraint.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder3", label: "Points", folder_type: hou.folderType.Simple, default_value: 0, ends_tab_group: false});
			hou_parm_template.setTags({"group_type": "simple"});
			...
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "mode", label: "Mode", menu_items: ["0", "1"], menu_labels: ["Point Group", "Primitive Group"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "group", label: "Group", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "opmenu -l sopnet/constraints/points group", item_generator_script_language: hou.scriptLanguage.Hscript, menu_type: hou.menuType.StringToggle});
			hou_parm_template2.setTags({"autoscope": "0000000000000000", "script_action": "import objecttoolutils\nnode = kwargs[\'node\'].node(\"sopnet/selection\")\nobjecttoolutils.constraintpointsSelect(node)\n", "script_action_icon": "BUTTONS_reselect"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "weights", label: "Weights", num_components: 3, default_value: [1, 1, 1], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "0000000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "useweightssnippet", label: "Use Snippet", default_value: false});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ mode == 2 } { mode == 3 }");
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "weightssnippet", label: "Snippet", num_components: 1, default_value: ["// Vary weights and group per source.\n// weights = ...\n// group = ..."], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import vexpressionmenu\n\nreturn vexpressionmenu.buildSnippetMenu('Lop/pointsconstraint/weightssnippet')", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template2.setConditional(hou.parmCondType.HideWhen, "{ useweightssnippet == 0 } { mode == 2 } { mode == 3 }");
			...
			hou_parm_template3 = new hou.IntParmTemplate({name: "lookatmode", label: "Look At Mode", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: ["0", "1", "2", "3", "4"], menu_labels: ["None", "Direction Attribute from Points", "Direction Vector from P0 to P1", "Normal Vector of P0,P1,P2 Plane", "From Primitive"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.IntParmTemplate({name: "lookupmode", label: "Look Up Mode", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: ["0", "1", "2", "3", "4", "5", "6", "7"], menu_labels: ["Up Vector Attribute from Points", "Direction Vector from P0 to P1", "Normal Vector of P0,P1,P2 Plane", "X Axis", "Y Axis", "Z Axis", "From Primitive", "Custom"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template3.setConditional(hou.parmCondType.HideWhen, "{ lookupmode != 6 } { lookatmode == 0 }");
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('LOP/Constraints/pointsconstraint',_hnt_LOP_pointsconstraint)
    return _hnt_LOP_pointsconstraint
}
