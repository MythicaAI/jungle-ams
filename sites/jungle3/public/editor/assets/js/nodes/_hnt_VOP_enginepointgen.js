...
export default function (hou) {
    class _hnt_VOP_enginepointgen extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/enginepointgen';
        static category = '/VOP';
        static houdiniType = 'enginepointgen';
        static title = 'Houdini Engine Procedural: Point Generate';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/enginepointgen',_hnt_VOP_enginepointgen)
    return _hnt_VOP_enginepointgen
}
