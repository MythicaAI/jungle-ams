...
export default function (hou) {
    class _hnt_OBJECT_auto_rig_biped_arm extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/auto_rig_biped_arm';
        static category = '/OBJECT';
        static houdiniType = 'auto_rig_biped_arm';
        static title = 'Auto Rig Biped Arm';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_auto_rig_biped_arm.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_ctrl_collarbone_t", label: "Collarbone Translate", num_components: 3, default_value: [2.6, null, 7.9], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_ctrl_shoulderblade_t", label: "Shoulderblade Translate", num_components: 3, default_value: [6.1, null, null], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_ctrl_shoulder_t", label: "Shoulder Translate", num_components: 3, default_value: [10, null, 0.6], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_ctrl_elbow_t", label: "Elbow Translate", num_components: 3, default_value: [34.9, null, null], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_ctrl_wrist_t", label: "Wrist Translate", num_components: 3, default_value: [60.8, null, 1], min: null, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_ctrl_wrist_r", label: "Wrist Rotate", num_components: 3, default_value: [0, 0, 0], min: 0, max: 360, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_hand_direction_tx", label: "Hand Direction Translate", num_components: 1, default_value: [15], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "rig_hand_up_ty", label: "Hand Up Translate", num_components: 1, default_value: [7], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template2.setTags({"export_disable": "1"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.LabelParmTemplate({name: "shoulder_label", label: "Shoulder", column_labels: [""]});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.LabelParmTemplate({name: "elbow_label", label: "Elbow", column_labels: [""]});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.LabelParmTemplate({name: "wrist_label", label: "Wrist", column_labels: [""]});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "wrist_cut_control_r", label: "Rotate", num_components: 3, default_value: [0, 0, 0], min: 0, max: 360, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.XYZW});
			hou_parm_template2.setTags({"autoscope": "1110000000000000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('OBJECT/Other/auto_rig_biped_arm',_hnt_OBJECT_auto_rig_biped_arm)
    return _hnt_OBJECT_auto_rig_biped_arm
}
