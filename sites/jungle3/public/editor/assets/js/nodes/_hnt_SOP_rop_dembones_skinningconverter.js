...
export default function (hou) {
    class _hnt_SOP_rop_dembones_skinningconverter extends hou._HoudiniBase {
        static is_root = true;
        static id = 'SOP/Other/rop_dembones_skinningconverter';
        static category = '/SOP';
        static houdiniType = 'rop_dembones_skinningconverter';
        static title = 'Dem Bones Skinning Converter';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_rop_dembones_skinningconverter.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/rop_dembones_skinningconverter',_hnt_SOP_rop_dembones_skinningconverter)
    return _hnt_SOP_rop_dembones_skinningconverter
}
