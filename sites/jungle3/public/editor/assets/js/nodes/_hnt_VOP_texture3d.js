...
export default function (hou) {
    class _hnt_VOP_texture3d extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/texture3d';
        static category = '/VOP';
        static houdiniType = 'texture3d';
        static title = 'Texture 3D';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_texture3d.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/texture3d',_hnt_VOP_texture3d)
    return _hnt_VOP_texture3d
}
