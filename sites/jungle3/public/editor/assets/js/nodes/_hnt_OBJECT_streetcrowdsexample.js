...
export default function (hou) {
    class _hnt_OBJECT_streetcrowdsexample extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/streetcrowdsexample';
        static category = '/OBJECT';
        static houdiniType = 'streetcrowdsexample';
        static title = 'Street Example';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_streetcrowdsexample.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/streetcrowdsexample',_hnt_OBJECT_streetcrowdsexample)
    return _hnt_OBJECT_streetcrowdsexample
}
