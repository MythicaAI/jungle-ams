...
export default function (hou) {
    class _hnt_CHOP_constraintblend extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintblend';
        static category = '/CHOP';
        static houdiniType = 'constraintblend';
        static title = 'Blend';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintblend.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Constraint Blend", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "rotblend", label: "Rotation Blending", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: ["0", "1", "2", "3"], menu_labels: ["Euler", "Shortest Path (Linear)", "Shortest Path (Fast Linear)", "Euler (Raw Angles)"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "writemask", label: "Mask", menu_items: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], menu_labels: ["TX", "TY", "TZ", "RX", "RY", "RZ", "SX", "SY", "SZ"], default_value: 8, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringToggle, menu_use_token: false, is_button_strip: true, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "numblends", label: "Blends", folder_type: hou.folderType.MultiparmBlock, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"multistartoffset": "0"});
			let hou_parm_template3 = new hou.FloatParmTemplate({name: "blend#", label: "blend#", num_components: 1, default_value: [1], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
    ...
    hou.registerType('CHOP/Constraints/constraintblend',_hnt_CHOP_constraintblend)
    return _hnt_CHOP_constraintblend
}
