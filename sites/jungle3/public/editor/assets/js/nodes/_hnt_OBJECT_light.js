...
export default function (hou) {
    class _hnt_OBJECT_light extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Other/light';
        static category = '/OBJECT';
        static houdiniType = 'light';
        static title = 'Light Template';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_light.svg';
        constructor() {
            super();
    ...
    hou.registerType('OBJECT/Other/light',_hnt_OBJECT_light)
    return _hnt_OBJECT_light
}
