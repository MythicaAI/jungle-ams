...
export default function (hou) {
    class _hnt_SHOP_objnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'SHOP/Other/objnet';
        static category = '/SHOP';
        static houdiniType = 'objnet';
        static title = 'Object Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_objnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/objnet',_hnt_SHOP_objnet)
    return _hnt_SHOP_objnet
}
