...
export default function (hou) {
    class _hnt_SOP_labs__filecache__2_0 extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Labs/Pipeline/Cache/labs::filecache::2.0';
        static category = '/SOP/labs';
        static houdiniType = 'labs::filecache::2.0';
        static title = 'Labs File Cache';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_labs__filecache__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ButtonParmTemplate({name: "createlopfilecache", label: "Create LOP Import"});
			hou_parm_template.hideLabel(true);
			hou_parm_template.setJoinWithNext(true);
			hou_parm_template.setScriptCallback("hou.phm().createLopImport(kwargs)");
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"button_icon": "NETWORKS_lop", "script_callback": "hou.phm().createLopImport(kwargs)", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template.setTags({"script_callback": "hou.phm().generateStatic(kwargs)", "script_callback_language": "python"});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder15", label: "Overwrite Existing Cache", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ButtonParmTemplate({name: "cookoutputnode", label: "Save in Background"});
			hou_parm_template3.setJoinWithNext(true);
			...
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"export_disable": "1", "script_callback": "hou.phm().generateStatic(kwargs)", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setScriptCallback("hou.phm().generateStatic(kwargs)");
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"script_callback": "hou.phm().generateStatic(kwargs)", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setScriptCallback("hou.phm().generateStatic(kwargs)");
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_action": "node = kwargs['node']\n\nnode.hdaModule().getUpstreamWedgeCount(kwargs)", "script_action_help": "Sets the parameter value based on the number of upstream wedges.", "script_action_icon": "TOP_wedge", "script_callback": "hou.phm().generateStatic(kwargs)", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template4.setTags({"group_default": "0", "group_type": "collapsible", "sidefx::header_parm": "attrib#"});
			...
			hou_parm_template5 = new hou.MenuParmTemplate({name: "wedgetype#", label: "Wedge Type", menu_items: ["auto", "range", "rand", "batch", "periodic", "list", "attrib"], menu_labels: ["Automatic", "Custom Range", "Random Sample", "Batched Sequence", "Periodic Sequence", "Specfic Values", "Attribute Values"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "mergeframes", label: "Frames to Merge", menu_items: ["all", "range", "specific"], menu_labels: ["All Frames", "Custom Range", "Specific Frames"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template3.setTags({"script_callback": "hou.phm().generateStatic(kwargs)", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.MenuParmTemplate({name: "mergewedges", label: "Wedges to Merge", menu_items: ["all", "range", "specific"], menu_labels: ["All Wedges", "Custom Range", "Specific Wedges"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "local", label: "Local", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_default": "1", "group_type": "collapsible"});
			...
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.LabelParmTemplate({name: "corecount", label: "Message", column_labels: ["`ifs(ch(\"maxprocsmenu\")==6,\"\",\" =   \" + chs(\"numlogicalcores\"))`"]});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "folder1_2", label: "Geometry", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "folder0", label: "Create Load Attributes", folder_type: hou.folderType.Collapsible, default_value: 0, ends_tab_group: false});
			hou_parm_template2.setTags({"group_type": "collapsible"});
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "setfilename", label: "Set Filename", default_value: false});
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "filenameattrib", label: "File Name Attribute", num_components: 1, default_value: ["name"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ setfilename != 1 }");
			...
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "setfilepath", label: "Set File Path", default_value: false});
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "filepathattrib", label: "File Path Attribute", num_components: 1, default_value: ["path"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ setfilepath != 1 }");
			hou_parm_template3.setTags({"script_action": "import soputils\n\nsoputils.actionToggleVisualizer(kwargs, viz_defaults=soputils.getRandomColorVisualizerDefaults())", "script_action_help": "Toggle visualization Ctrl-LMB: Open the visualization editor", "script_action_icon": "VIEW_visualization"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.ToggleParmTemplate({name: "setfileindex", label: "Set File Index", default_value: false});
			hou_parm_template3.hideLabel(true);
			hou_parm_template3.setJoinWithNext(true);
			hou_parm_template3.setScriptCallbackLanguage(hou.scriptLanguage.Python);
			hou_parm_template3.setTags({"script_callback_language": "python"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template3 = new hou.StringParmTemplate({name: "fileindexattrib", label: "File Index Attribute", num_components: 1, default_value: ["fileidx"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ setfileindex != 1 }");
			hou_parm_template3.setTags({"script_action": "import soputils\n\nsoputils.actionToggleVisualizer(kwargs, viz_defaults=soputils.getRandomColorVisualizerDefaults())", "script_action_help": "Toggle visualization Ctrl-LMB: Open the visualization editor", "script_action_icon": "VIEW_visualization"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Labs/Pipeline/Cache/labs::filecache::2.0',_hnt_SOP_labs__filecache__2_0)
    return _hnt_SOP_labs__filecache__2_0
}
