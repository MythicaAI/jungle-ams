...
export default function (hou) {
    class _hnt_SOP_testgeometry_rubbertoy extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'SOP/Utility/Test Geometry/testgeometry_rubbertoy';
        static category = '/SOP';
        static houdiniType = 'testgeometry_rubbertoy';
        static title = 'Test Geometry: Rubber Toy';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_testgeometry_rubbertoy.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Utility/Test Geometry/testgeometry_rubbertoy',_hnt_SOP_testgeometry_rubbertoy)
    return _hnt_SOP_testgeometry_rubbertoy
}
