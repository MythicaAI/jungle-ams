...
export default function (hou) {
    class _hnt_VOP_volumeindexvfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumeindexvfile';
        static category = '/VOP';
        static houdiniType = 'volumeindexvfile';
        static title = 'Volume Index Vector';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/volumeindexvfile',_hnt_VOP_volumeindexvfile)
    return _hnt_VOP_volumeindexvfile
}
