...
export default function (hou) {
    class _hnt_COP2_over extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/over';
        static category = '/COP2';
        static houdiniType = 'over';
        static title = 'Over';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_over.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Over", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/over',_hnt_COP2_over)
    return _hnt_COP2_over
}
