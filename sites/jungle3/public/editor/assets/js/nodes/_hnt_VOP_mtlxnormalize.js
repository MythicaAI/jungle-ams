...
export default function (hou) {
    class _hnt_VOP_mtlxnormalize extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxnormalize';
        static category = '/VOP';
        static houdiniType = 'mtlxnormalize';
        static title = 'MtlX Normalize';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxnormalize.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxnormalize',_hnt_VOP_mtlxnormalize)
    return _hnt_VOP_mtlxnormalize
}
