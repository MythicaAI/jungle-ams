...
export default function (hou) {
    class _hnt_SHOP_vm_geo_engine extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/vm_geo_engine';
        static category = '/SHOP';
        static houdiniType = 'vm_geo_engine';
        static title = 'Houdini Engine Procedural';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_vm_geo_engine.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/vm_geo_engine',_hnt_SHOP_vm_geo_engine)
    return _hnt_SHOP_vm_geo_engine
}
