...
export default function (hou) {
    class _hnt_VOP_fuzzyinput extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'VOP/Other/fuzzyinput';
        static category = '/VOP';
        static houdiniType = 'fuzzyinput';
        static title = 'Fuzzy Input';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_fuzzyinput.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.StringParmTemplate({name: "setname", label: "Fuzzy Set Name", num_components: 1, default_value: ["fuzzyval"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.RampParmTemplate({name: "importance", label: "Sample Importance", ramp_parm_type: hou.rampParmType.Float, default_value: 2, default_basis: null, color_type: null});
			hou_parm_template.setTags({"code_generation": "0", "cook_dependent": "0", "rampshowcontrolsdefault": "0"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.RampParmTemplate({name: "importancemirror", label: "Sample Importance Mirrored", ramp_parm_type: hou.rampParmType.Float, default_value: 2, default_basis: null, color_type: null});
			hou_parm_template.setTags({"code_generation": "0", "cook_dependent": "0", "rampshowcontrolsdefault": "0"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.RampParmTemplate({name: "importancecomb", label: "Sample Importance Combined", ramp_parm_type: hou.rampParmType.Float, default_value: 2, default_basis: null, color_type: null});
			hou_parm_template.setTags({"code_generation": "0", "cook_dependent": "0", "rampshowcontrolsdefault": "0"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "mirror_imp", label: "Mirrored", default_value: false});
			hou_parm_template.setJoinWithNext(true);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "combmirror_imp", label: "Combine Mirror", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/fuzzyinput',_hnt_VOP_fuzzyinput)
    return _hnt_VOP_fuzzyinput
}
