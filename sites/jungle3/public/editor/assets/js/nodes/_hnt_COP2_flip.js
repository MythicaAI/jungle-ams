...
export default function (hou) {
    class _hnt_COP2_flip extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/flip';
        static category = '/COP2';
        static houdiniType = 'flip';
        static title = 'Flip';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_flip.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Flip", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.ToggleParmTemplate({name: "xflip", label: "Flip Horizontally", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "yflip", label: "Flip Vertically", default_value: true});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.ToggleParmTemplate({name: "flop", label: "Flop 90 Degrees", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('COP2/Other/flip',_hnt_COP2_flip)
    return _hnt_COP2_flip
}
