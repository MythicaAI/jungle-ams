...
export default function (hou) {
    class _hnt_DOP_rbdfracturedobject extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'DOP/Objects/rbdfracturedobject';
        static category = '/DOP';
        static houdiniType = 'rbdfracturedobject';
        static title = 'RBD Fractured Object';
        static icon = '/editor/assets/imgs/nodes/_hnt_DOP_rbdfracturedobject.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template2.setTags({"autoscope": "0000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FloatParmTemplate({name: "glueimpulsehalflife", label: "Glue Impulse HalfLife", num_components: 1, default_value: [0.1], min: 0, max: 1, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template2.setTags({"autoscope": "0000"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template4 = new hou.FloatParmTemplate({name: "guidecolor", label: "Collision Guide", num_components: 3, default_value: [0, 0, 1], min: 0, max: 1, min_is_strict: true, max_is_strict: true, look: hou.parmLook.ColorSquare, naming_scheme: hou.parmNamingScheme.RGBA});
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ bullet_autofit == 1 } { bullet_georep == compound } { bullet_georep == as-is }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setConditional(hou.parmCondType.DisableWhen, "{ bullet_autofit == 1 } { bullet_georep == as-is } { bullet_georep == compound } { bullet_georep == box } { bullet_georep == plane }");
			hou_parm_template3.setTags({"autoscope": "0000000000000000"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
    ...
    hou.registerType('DOP/Objects/rbdfracturedobject',_hnt_DOP_rbdfracturedobject)
    return _hnt_DOP_rbdfracturedobject
}
