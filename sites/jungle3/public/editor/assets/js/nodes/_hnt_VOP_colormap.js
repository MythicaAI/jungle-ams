...
export default function (hou) {
    class _hnt_VOP_colormap extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/colormap';
        static category = '/VOP';
        static houdiniType = 'colormap';
        static title = 'Color Map';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_colormap.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.StringParmTemplate({name: "cmap", label: "Color Map", num_components: 1, default_value: ["$HH/pic/Mandril.pic"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.FileReference, file_type: hou.fileType.Image, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.StringReplace});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "u", label: "U", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "v", label: "V", num_components: 1, default_value: [1], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template.setConditional(hou.parmCondType.DisableWhen, "{ wrap != decal }");
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/colormap',_hnt_VOP_colormap)
    return _hnt_VOP_colormap
}
