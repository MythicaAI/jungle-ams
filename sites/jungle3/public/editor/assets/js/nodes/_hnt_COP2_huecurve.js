...
export default function (hou) {
    class _hnt_COP2_huecurve extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/huecurve';
        static category = '/COP2';
        static houdiniType = 'huecurve';
        static title = 'HueCurve';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_huecurve.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "HueCurve", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
			let hou_parm_template2 = new hou.ButtonParmTemplate({name: "edit", label: "Edit Hue Curves"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.MenuParmTemplate({name: "huemode", label: "Hue Operation", menu_items: ["sat", "lum"], menu_labels: ["Adjust Saturation", "Adjust Luminance"], default_value: 0, icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false, is_button_strip: false, strip_uses_icons: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "curve", label: "Hue Curve", folder_type: hou.folderType.MultiparmBlock, default_value: 1, ends_tab_group: false});
			let hou_parm_template3 = new hou.FloatParmTemplate({name: "curvepnt#", label: "Point #", num_components: 3, default_value: [180, 1, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.UVW});
    ...
    hou.registerType('COP2/Other/huecurve',_hnt_COP2_huecurve)
    return _hnt_COP2_huecurve
}
