...
export default function (hou) {
    class _hnt_SHOP_ri_spotlight extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/ri_spotlight';
        static category = '/SHOP';
        static houdiniType = 'ri_spotlight';
        static title = 'RSL Spotlight';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_ri_spotlight.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/ri_spotlight',_hnt_SHOP_ri_spotlight)
    return _hnt_SHOP_ri_spotlight
}
