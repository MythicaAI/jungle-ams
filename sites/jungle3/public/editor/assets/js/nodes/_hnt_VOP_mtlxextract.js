...
export default function (hou) {
    class _hnt_VOP_mtlxextract extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Channel/mtlxextract';
        static category = '/VOP';
        static houdiniType = 'mtlxextract';
        static title = 'MtlX Extract';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxextract.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.setTags({"sidefx::shader_parmname": "in"});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.IntParmTemplate({name: "index", label: "Index", num_components: 1, default_value: [0], min: 0, max: 2, min_is_strict: true, max_is_strict: true, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
    ...
    hou.registerType('VOP/MaterialX/Channel/mtlxextract',_hnt_VOP_mtlxextract)
    return _hnt_VOP_mtlxextract
}
