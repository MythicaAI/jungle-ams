...
export default function (hou) {
    class _hnt_VOP_pbrdiffuse__3_0 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Shading (BSDFs)/pbrdiffuse::3.0';
        static category = '/VOP';
        static houdiniType = 'pbrdiffuse::3.0';
        static title = 'PBR Diffuse';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_pbrdiffuse__3_0.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Shading (BSDFs)/pbrdiffuse::3.0',_hnt_VOP_pbrdiffuse__3_0)
    return _hnt_VOP_pbrdiffuse__3_0
}
