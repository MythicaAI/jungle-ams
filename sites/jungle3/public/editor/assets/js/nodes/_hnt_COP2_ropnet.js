...
export default function (hou) {
    class _hnt_COP2_ropnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'COP2/Other/ropnet';
        static category = '/COP2';
        static houdiniType = 'ropnet';
        static title = 'ROP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_ropnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('COP2/Other/ropnet',_hnt_COP2_ropnet)
    return _hnt_COP2_ropnet
}
