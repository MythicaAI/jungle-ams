...
export default function (hou) {
    class _hnt_CHOP_multiply extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Constraints/multiply';
        static category = '/CHOP';
        static houdiniType = 'multiply';
        static title = 'Multiply';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_multiply.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.IntParmTemplate({name: "__iterate_over_channels__", label: "__iterate_over_channels__", num_components: 1, default_value: [9], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4_1_1", label: "Common", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Constraints/multiply',_hnt_CHOP_multiply)
    return _hnt_CHOP_multiply
}
