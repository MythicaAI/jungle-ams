...
export default function (hou) {
    class _hnt_COP2_add extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/add';
        static category = '/COP2';
        static houdiniType = 'add';
        static title = 'Add';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_add.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Add", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/add',_hnt_COP2_add)
    return _hnt_COP2_add
}
