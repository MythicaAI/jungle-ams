...
export default function (hou) {
    class _hnt_LOP_domelight__2_0 extends hou._HoudiniBase {
        static is_root = false;
        static id = 'LOP/Lights/domelight::2.0';
        static category = '/LOP';
        static houdiniType = 'domelight::2.0';
        static title = 'Dome Light';
        static icon = '/editor/assets/imgs/nodes/_hnt_LOP_domelight__2_0.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "xn__inputstextureformat_control_1kbh", label: "Format", num_components: 1, default_value: ["set"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "import loputils\nreturn loputils.createEditPropertiesControlMenu(kwargs, 'token')", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.ControlNextParameter});
			hou_parm_template2.setTags({"sidefx::look": "icon"});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.StringParmTemplate({name: "xn__inputstextureformat_06ah", label: "Format", num_components: 1, default_value: ["automatic"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["automatic", "latlong", "mirroredBall", "angular", "cubeMapVerticalCross"], menu_labels: ["Automatic", "Lat-Long", "Mirrored Ball", "Angular", "Cube Map (Vertical Cross)"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template2.setConditional(hou.parmCondType.DisableWhen, "{ xn__inputstextureformat_control_1kbh == block } { xn__inputstextureformat_control_1kbh == none }");
    ...
    hou.registerType('LOP/Lights/domelight::2.0',_hnt_LOP_domelight__2_0)
    return _hnt_LOP_domelight__2_0
}
