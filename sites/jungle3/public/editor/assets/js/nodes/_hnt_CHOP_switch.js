...
export default function (hou) {
    class _hnt_CHOP_switch extends hou.extend(hou._HoudiniBase).with(hou._MultiInputMixin) {
        static is_root = false;
        static id = 'CHOP/Other/switch';
        static category = '/CHOP';
        static houdiniType = 'switch';
        static title = 'Switch';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_switch.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template2 = new hou.ToggleParmTemplate({name: "indexfirst", label: "First Input is Index", default_value: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.IntParmTemplate({name: "index", label: "Index", num_components: 1, default_value: [0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template.addParmTemplate(hou_parm_template2);
    ...
    hou.registerType('CHOP/Other/switch',_hnt_CHOP_switch)
    return _hnt_CHOP_switch
}
