...
export default function (hou) {
    class _hnt_OBJECT_pxrblockerlightfilter extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'OBJECT/Render/pxrblockerlightfilter';
        static category = '/OBJECT';
        static houdiniType = 'pxrblockerlightfilter';
        static title = 'Pxr Blocker Light Filter';
        static icon = '/editor/assets/imgs/nodes/_hnt_OBJECT_pxrblockerlightfilter.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template3.setHelp("width: Width of inner region of the rod (x axis).");
			...
			hou_parm_template3.setHelp("height: Height of inner region of the rod (y axis).");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setHelp("depth: Depth of inner region of the rod (z axis).");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setHelp("radius: Radius of corners of inner rod box.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			...
			hou_parm_template3.setHelp("edge: Thickness of edge region.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "script_ritype": "float"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			...
			hou_parm_template3 = new hou.RampParmTemplate({name: "falloff", label: "Falloff", ramp_parm_type: hou.rampParmType.Float, default_value: 6, default_basis: null, color_type: null});
			hou_parm_template3.setHelp("falloff: Controls the transition from the core to the edge.");
			hou_parm_template3.setTags({"autoscope": "0000000000000000", "rampbasis_var": "falloff_Interpolation", "rampbasisdefault": "bspline", "rampcolortype": "rgb", "rampfloatdefault": "1pos ( 0 ) 1value ( 0 ) 1interp ( bspline ) 2pos ( 0.20000000000000001 ) 2value ( 0.20000000000000001 ) 2interp ( bspline ) 3pos ( 0.40000000000000002 ) 3value ( 0.40000000000000002 ) 3interp ( bspline ) 4pos ( 0.59999999999999998 ) 4value ( 0.59999999999999998 ) 4interp ( bspline ) 5pos ( 0.80000000000000004 ) 5value ( 0.80000000000000004 ) 5interp ( bspline ) 6pos ( 1 ) 6value ( 1 ) 6interp ( bspline )", "rampkeys_var": "falloff_Knots", "rampvalues_var": "falloff_Floats"});
			hou_parm_template2.addParmTemplate(hou_parm_template3);
			hou_parm_template.addParmTemplate(hou_parm_template2);
			hou_parm_template2 = new hou.FolderParmTemplate({name: "rod_shape_3", label: "Color Ramp", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('OBJECT/Render/pxrblockerlightfilter',_hnt_OBJECT_pxrblockerlightfilter)
    return _hnt_OBJECT_pxrblockerlightfilter
}
