...
export default function (hou) {
    class _hnt_SHOP_translucency_sample extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SHOP/Other/translucency_sample';
        static category = '/SHOP';
        static houdiniType = 'translucency_sample';
        static title = 'translucency_sample';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_translucency_sample.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/translucency_sample',_hnt_SHOP_translucency_sample)
    return _hnt_SHOP_translucency_sample
}
