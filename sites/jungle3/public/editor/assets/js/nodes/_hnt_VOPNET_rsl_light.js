...
export default function (hou) {
    class _hnt_VOPNET_rsl_light extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = false;
        static id = 'VOPNET/Other/rsl_light';
        static category = '/VOPNET';
        static houdiniType = 'rsl_light';
        static title = 'RSL Light SHOP Type';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOPNET_rsl_light.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOPNET/Other/rsl_light',_hnt_VOPNET_rsl_light)
    return _hnt_VOPNET_rsl_light
}
