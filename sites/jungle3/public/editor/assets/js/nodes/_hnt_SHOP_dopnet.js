...
export default function (hou) {
    class _hnt_SHOP_dopnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'SHOP/Other/dopnet';
        static category = '/SHOP';
        static houdiniType = 'dopnet';
        static title = 'DOP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_SHOP_dopnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('SHOP/Other/dopnet',_hnt_SHOP_dopnet)
    return _hnt_SHOP_dopnet
}
