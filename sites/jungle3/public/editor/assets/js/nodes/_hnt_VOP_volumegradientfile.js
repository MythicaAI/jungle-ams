...
export default function (hou) {
    class _hnt_VOP_volumegradientfile extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/volumegradientfile';
        static category = '/VOP';
        static houdiniType = 'volumegradientfile';
        static title = 'Volume Gradient';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_volumegradientfile.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "primnum_s", label: "Primitive Name", num_components: 1, default_value: [""], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.FloatParmTemplate({name: "samplepos", label: "Sample Position", num_components: 3, default_value: [0, 0, 0], min: 0, max: 10, min_is_strict: false, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('VOP/Other/volumegradientfile',_hnt_VOP_volumegradientfile)
    return _hnt_VOP_volumegradientfile
}
