...
export default function (hou) {
    class _hnt_SOP_vdbreshapesdf extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/vdbreshapesdf';
        static category = '/SOP';
        static houdiniType = 'vdbreshapesdf';
        static title = 'VDB Reshape SDF';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_vdbreshapesdf.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "operation", label: "Operation", num_components: 1, default_value: ["dilate"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: ["dilate", "erode", "open", "close"], menu_labels: ["Dilate", "Erode", "Open", "Close"], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/vdbreshapesdf',_hnt_SOP_vdbreshapesdf)
    return _hnt_SOP_vdbreshapesdf
}
