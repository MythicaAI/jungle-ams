...
export default function (hou) {
    class _hnt_VOP_outerproduct extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/Other/outerproduct';
        static category = '/VOP';
        static houdiniType = 'outerproduct';
        static title = 'Outer Product';
        static icon = 'None';
        constructor() {
            super();
    ...
    hou.registerType('VOP/Other/outerproduct',_hnt_VOP_outerproduct)
    return _hnt_VOP_outerproduct
}
