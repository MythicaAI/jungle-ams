...
export default function (hou) {
    class _hnt_SOP_ropnet extends hou.extend(hou._HoudiniBase).with(hou._SubgraphMixin) {
        static is_root = true;
        static id = 'SOP/Other/ropnet';
        static category = '/SOP';
        static houdiniType = 'ropnet';
        static title = 'ROP Network';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_ropnet.svg';
        constructor() {
            super();
    ...
    hou.registerType('SOP/Other/ropnet',_hnt_SOP_ropnet)
    return _hnt_SOP_ropnet
}
