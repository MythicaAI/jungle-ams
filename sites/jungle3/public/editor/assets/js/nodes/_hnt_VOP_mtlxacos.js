...
export default function (hou) {
    class _hnt_VOP_mtlxacos extends hou._HoudiniBase {
        static is_root = false;
        static id = 'VOP/MaterialX/Math/mtlxacos';
        static category = '/VOP';
        static houdiniType = 'mtlxacos';
        static title = 'MtlX Acos';
        static icon = '/editor/assets/imgs/nodes/_hnt_VOP_mtlxacos.svg';
        constructor() {
            super();
    ...
    hou.registerType('VOP/MaterialX/Math/mtlxacos',_hnt_VOP_mtlxacos)
    return _hnt_VOP_mtlxacos
}
