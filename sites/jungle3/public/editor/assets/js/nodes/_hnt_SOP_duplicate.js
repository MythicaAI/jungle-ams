...
export default function (hou) {
    class _hnt_SOP_duplicate extends hou._HoudiniBase {
        static is_root = false;
        static id = 'SOP/Other/duplicate';
        static category = '/SOP';
        static houdiniType = 'duplicate';
        static title = 'Duplicate';
        static icon = '/editor/assets/imgs/nodes/_hnt_SOP_duplicate.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			hou_parm_template = new hou.IntParmTemplate({name: "ncy", label: "Number of Copies", num_components: 1, default_value: [1], min: 0, max: 20, min_is_strict: true, max_is_strict: false, look: hou.parmLook.Regular, naming_scheme: hou.parmNamingScheme.Base1, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal, menu_use_token: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "cum", label: "Transform Cumulative", default_value: true});
			hou_parm_template_group.append(hou_parm_template);
			...
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.ToggleParmTemplate({name: "preservegroups", label: "Preserve Groups", default_value: false});
			hou_parm_template_group.append(hou_parm_template);
			hou_parm_template = new hou.StringParmTemplate({name: "copyg", label: "Copy Groups", num_components: 1, default_value: ["copyGroup$CY"], naming_scheme: hou.parmNamingScheme.Base1, string_type: hou.stringParmType.Regular, menu_items: [], menu_labels: [], icon_names: [], item_generator_script: "", item_generator_script_language: hou.scriptLanguage.Python, menu_type: hou.menuType.Normal});
			hou_parm_template_group.append(hou_parm_template);
    ...
    hou.registerType('SOP/Other/duplicate',_hnt_SOP_duplicate)
    return _hnt_SOP_duplicate
}
