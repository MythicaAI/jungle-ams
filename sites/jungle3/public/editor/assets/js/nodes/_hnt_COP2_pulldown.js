...
export default function (hou) {
    class _hnt_COP2_pulldown extends hou._HoudiniBase {
        static is_root = false;
        static id = 'COP2/Other/pulldown';
        static category = '/COP2';
        static houdiniType = 'pulldown';
        static title = 'Pulldown';
        static icon = '/editor/assets/imgs/nodes/_hnt_COP2_pulldown.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher", label: "Pulldown", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('COP2/Other/pulldown',_hnt_COP2_pulldown)
    return _hnt_COP2_pulldown
}
