...
export default function (hou) {
    class _hnt_CHOP_constraintparent extends hou._HoudiniBase {
        static is_root = false;
        static id = 'CHOP/Constraints/constraintparent';
        static category = '/CHOP';
        static houdiniType = 'constraintparent';
        static title = 'Parent';
        static icon = '/editor/assets/imgs/nodes/_hnt_CHOP_constraintparent.svg';
        constructor() {
            super();
        ...
        parmTemplatesInit() {
			...
			let hou_parm_template = new hou.FolderParmTemplate({name: "stdswitcher4", label: "Constraint Parent", folder_type: hou.folderType.Tabs, default_value: 0, ends_tab_group: false});
    ...
    hou.registerType('CHOP/Constraints/constraintparent',_hnt_CHOP_constraintparent)
    return _hnt_CHOP_constraintparent
}
