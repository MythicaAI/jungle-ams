...
import { useSceneStore, ParameterSlider } from "@store/sceneStoreEmbedded";
...
const SceneControlsEmbedded: FC<Props> = ({ width, isAssetPage }) => {
...
export default SceneControlsEmbedded;
