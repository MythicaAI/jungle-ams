        ...
        <div>
            ...
            >
                <ModalDialog>
                    ...
                    <Stack direction={"row"} spacing={2} alignItems="center" sx={{ flexGrow: 1, display: 'flex', alignItems: 'center' }}>
                        <IconButton onClick={handleClose} color="primary">
                            <LucideX />
                            Cancel
                        </IconButton>
                        <IconButton onClick={handleConfirmDelete} color="primary" autoFocus>
                            <LucideCheck />
                            Confirm
                        </IconButton>
                    </Stack>
