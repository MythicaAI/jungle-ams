...
interface SceneState {
  ...
  setJobDefinition: (jobDef: JobDefinition) => void;

  inputFiles: { [key: string]:ApiFile };
  setInputFiles: (filesByInput: { [key: string]:ApiFile }) => void;
  setInputFile: (key: string, file: ApiFile) => void;
...
export const useSceneStore = create<SceneState>((set, get) => ({
  ...
  setJobDefinition: (jobDef) => set({ jobDefinition: jobDef }),
