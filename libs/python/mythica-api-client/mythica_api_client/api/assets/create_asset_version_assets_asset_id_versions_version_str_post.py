...
from ...models.asset_create_version_request import AssetCreateVersionRequest
...
def _get_kwargs(
    ...
    version_str: str,
    *,
    body: AssetCreateVersionRequest,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        version_str (str):
        authorization (Union[None, str]):
        body (AssetCreateVersionRequest): Create a new version of an asset with its contents
