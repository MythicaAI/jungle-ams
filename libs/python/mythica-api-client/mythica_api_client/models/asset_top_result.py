...
if TYPE_CHECKING:
    from ..models.asset_top_result_contents import AssetTopResultContents


T = TypeVar("T", bound="AssetTopResult")


@_attrs_define
class AssetTopResult:
    ...
    when no version has been created. In this case the
        ...
        Attributes:
            ...
            contents (Union[Unset, AssetTopResultContents]):
            downloads (Union[Unset, int]):  Default: 0.
            versions (Union[Unset, List[List[int]]]):
    """
    ...
    contents: Union[Unset, "AssetTopResultContents"] = UNSET
    downloads: Union[Unset, int] = 0
    versions: Union[Unset, List[List[int]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_contents, Unset):
            ...
            contents = AssetTopResultContents.from_dict(_contents)
        ...
        for versions_item_data in _versions or []:
            versions_item = cast(List[int], versions_item_data)

            versions.append(versions_item)

        asset_top_result = cls(
            asset_id=asset_id,
            owner_id=owner_id,
            owner_name=owner_name,
            org_id=org_id,
        ...
        asset_top_result.additional_properties = d
        return asset_top_result
