...
T = TypeVar("T", bound="AssetTopResultContents")


@_attrs_define
class AssetTopResultContents:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        asset_top_result_contents.additional_properties = additional_properties
        return asset_top_result_contents
