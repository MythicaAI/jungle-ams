...
T = TypeVar("T", bound="AssetVersionResultContents")


@_attrs_define
class AssetVersionResultContents:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        asset_version_result_contents = cls()
        ...
        asset_version_result_contents.additional_properties = additional_properties
        return asset_version_result_contents
